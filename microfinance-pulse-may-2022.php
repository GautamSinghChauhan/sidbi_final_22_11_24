...
<head>
    ...
    <title>Microfinance Pulse May - 2022</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <section class="about-us-banner" data-aos="fade-down"
            ...
            <div class="container">
                <div class="inner">
                    <h1>Microfinance Pulse May - 2022</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="careers">Microfinance Pulse May - 2022</a></li>
                    </ul>
                </div>
            </div>
        </section>

        <section class="cms READMICROFINANCEPULSEMAY2022INTHELANGUAGEOFYOURCHOICE">
            <div class="container language-main-inner-page">
                <div class="over-cont psme-sec">
                    <h2>Read Microfinance Pulse May 2022 in the language of your choice</h2>
                    <div class="row">
                        <div class="col-md-3 col-sm-12"><img src="<?= SEOURL; ?>assets/front/images/sidbi-X-january-2022.png"
                                alt="MAY 2022" width="150" height="200" title="MAY 2022"></div>
                        <div class="col-md-9 col-sm-12">
                            <div class="rt-viewse view-all-button-s "><a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-12th-Edition---Final-Draft.pdf" target="_blank"
                                    title="View">English</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI%20Pulse%2012th%20Edition-Tamil%20-Final.pdf"
                                    target="_blank" title="View">Tamil</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI%20Pulse%2012th%20Edition-Hindi.pdf" target="_blank"
                                    title="View">Hindi</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI%20Pulse%2012th%20Edition%20-%20Marathi-Final.pdf"
                                    target="_blank" title="View">Marathi</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI%20Pulse%2012th%20Edition%20-%20Telugu.pdf" target="_blank"
                                    title="View">Telugu</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-12th-Edition-Bengali.pdf"
                                    target="_blank" title="View">Bengali</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI Pulse 12th Edition-Kannada.pdf"
                                    target="_blank" title="View">Kannada</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-Report-12th Edition - Malayalam.pdf"
                                    target="_blank" title="View">Malayalam</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-12th-Edition-Assamese.pdf"
                                    target="_blank" title="View">Assamese</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI Pulse 12th Edition - Manipuri.pdf"
                                    target="_blank" title="View">Manipuri</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-12th-Edition-Gujarati.pdf"
                                    target="_blank" title="View">Gujarati</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI Pulse 12th Edition - Bodo.pdf"
                                    target="_blank" title="View">Bodo</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI Pulse 12th Edition - Odia.pdf"
                                    target="_blank" title="View">Odia</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI Pulse 12th Edition-Punjabi.pdf"
                                    target="_blank" title="View">Punjabi</a></div>
                        </div>
                    </div>
                    <div class="blockh-section">
                        <p><sup>* </sup>In case of any ambiguity/discrepancy in the translated contents in
                            vernacular/Hindi editions (vis a vis English edition), the respective content/context in
