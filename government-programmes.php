...
<div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
    ...
    <section class="breadcrumb-inner" data-aos="fade-up">
        <div class="container">
            <div class="inner">
                <ul>
                    <li><a href="index"><?php  if($get_configured_lang == 'HI'): 
                                                 echo   'सरकारी कार्यक्रम';
                                                else:
                                                 echo   'Government Programmes';
                                                endif; ?></a></li>
    ...
    <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `government_ID`, `government_title`, `government_title_hindi`, `government_content`, `government_content_hindi`, `status` FROM `government` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $government_content = html_entity_decode($row["government_content"]);
                                        $government_content_hindi = html_entity_decode($row["government_content_hindi"]);
                                    ?>
                        
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo    $government_content_hindi;
                                                else:
                                                 echo    $government_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
<script>
        ...
        <div class="logoSlider">
            <div class="swiper logoSliderInner">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="ImgWrap"><a href="https://udyamimitra.in/" target="_blank" title="Udyami Mitra"><img
                                    src="<?= SEOURL; ?>assets/front/images/logo4.png" class="img-fluid w-100"></a>
                        </div>
                    </div>
                    <div class="swiper-slide">
