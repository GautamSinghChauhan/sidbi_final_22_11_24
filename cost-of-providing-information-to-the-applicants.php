...
<head>
    ...
    <title>Cost of Providing information to the applicants - Small Industries Development Bank of India</title>
...
?>
        ...
        <div class="cms CostofProvidinginformationtotheapplicants">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `informationcost_ID`, `informationcost_title`, `informationcost_title_hindi`, `informationcost_content`, `informationcost_content_hindi`, `status` FROM `informationcost` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $informationcost_content = html_entity_decode($row["informationcost_content"]);
                                        $informationcost_content_hindi = html_entity_decode($row["informationcost_content_hindi"]);
                                    ?>
                        <h3 data-translate="informationcost"><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $informationcost_title_hindi;
                                                else:
                                                 echo  $informationcost_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $informationcost_content_hindi;
                                                else:
                                                 echo  $informationcost_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698781158.1697" value="zwbPJ0RDnZlFiFAFjGG3PTNqi9s+pSmx2gjjju85SpsZr34CZG+DbPa3Mr9xy7bt7CRPN1opP2ABh2PUIR7L/g==" /></div>
                            <div class="row">
