...
<head>
    ...
    <title>Ms. Mamta Kohli - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Senior Social Development Advisor, Foreign Commonwealth and Development Office</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Ms. Mamta Kohli</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/mkohli.png" alt="Ms. Mamta Kohli">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Ms. Mamta Kohli</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Ms Mamta Kohli is the Senior Social Development Adviser with Foreign, Commonwealth &
                                            Development Office and leads its work on gender and inclusion. She relies on evidence and
                                            community insights to design interventions and has led implementation of several transformational
                                            programmes on economic inclusion and financial services for women.
                                            Her cross sectoral experience allows her to break silos and connect people, ideas, solutions and
                                            resources for inclusive development, tech solutions that work for everyone and to challenge
                                            institutional norms and biases.</p>
                                    </div>
