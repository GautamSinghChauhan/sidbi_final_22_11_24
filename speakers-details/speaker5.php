...
<head>
    ...
    <title>Ms. Latha Venkatesh - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Executive Editor, CNBC TV18</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Ms. Latha Venkatesh</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/lvenkatesh.jpg" alt="Ms. Latha Venkatesh">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Ms. Latha Venkatesh</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>
                                        <p>Ms Latha Venkatesh started her career in CNBC-TV18 as chief of the Mumbai News Bureau.</p>
                                        <p>Over the years, she has been recognized as one of the keenest watchers of the Reserve Bank of India and a respected commentator on banking sector issues, money markets and macroeconomic trends.</p>
                                        <p>As a business journalist for years, she specializes in covering across markets - stocks, currency debt and commodities. Previously, she has worked across some major streams of media namely Economic Times and Dow Jones newswires for a period of five years each. </p>
                                        <p>Ms Latha Venkatesh graduated in Economics and Politics and holds a doctoral degree in Political Science.</p>
                                        </p>
                                    </div>
