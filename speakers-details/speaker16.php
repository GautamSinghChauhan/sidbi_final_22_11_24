...
<head>
    ...
    <title>Shri Sivakumar B.S. - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>President & Business Head, Agri Finance, Kotak Mahindra Bank</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Shri Sivakumar B.S.</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/ssivakumar.png" alt="Shri Sivakumar B.S.">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Shri Sivakumar B.S.</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Shri Sivakumar B. S. has over 30 years of rich experience in setting up and managing profit centers,
                                            business development and multi-regional operations within the financial services and exposure to the
                                            entire range of asset lending. His functional expertise include product, business, credit aspects with
                                            first-hand experience on recoveries for various asset classes. He is seasoned in setting up
                                            & developing financing products for the Retail & SME businesses.
                                            He setup and developed the Agri Business Group for Kotak Mahindra Bank since its inception in 2003.
                                            Under his leadership, this division contributes to the largest portfolio of PSL advances for the Bank.
                                            Shri Sivakumar B.S. pursued his Master’s in Management Studies from S P Jain Institute of
                                            Management and Research, B.Sc. in (Chemical and Microbiology) from Bombay University. He also
                                            holds a Diploma in Import and Export Management from Institute of Materials Management, Mumbai.</p>
                                    </div>
