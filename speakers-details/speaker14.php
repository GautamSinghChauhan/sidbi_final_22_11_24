...
<head>
    ...
    <title>Shri Udaya Kumar Hebbar - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Managing Director & Chief Executive Officer, CreditAccess Grameen Ltd.</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Shri Udaya Kumar Hebbar</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/UHebbar.png" alt="Shri Udaya Kumar Hebbar">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Shri Udaya Kumar Hebbar</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Shri Udaya Kumar Hebbar is a seasoned banker with over 35 years of experience within the financial
                                            services sector. He has been the architect behind the transformational journey of building
                                            CreditAccess Grameen as the leading microfinance institution in India. Under his exemplary
                                            leadership, the institution has achieved numerous feats such as listing in stock exchanges, raising
                                            funds through Qualified Institutional Placement (QIP) followed by Initial Public Offering (IPO), and
                                            becoming the pioneer to undertake the inorganic growth route in the NBFC-MFI space resulting in
                                            over 18% market share.
                                            Prior to joining CA Grameen, Shri Udaya Kumar Hebbar held various leadership positions as Head of
                                            Commercial Banking and Payment Operations at Barclays Bank Plc and had successful stints of over a
                                            decade each in Corporation Bank and ICICI Bank. He serves as a Director on the Board of
                                            Microfinance Institutions Network (MFIN), Madura Micro Finance Ltd, and Alpha Micro Finance
                                            Consultants Private Ltd.
                                            Shri Udaya Kumar Hebbar holds a Master’s degree in Commerce, a certified associate from the Indian
                                            Institute of Bankers and a graduate in Banking Operations and Technology from BAI, USA.</p>
                                    </div>
