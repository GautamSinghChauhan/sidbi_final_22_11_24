...
<head>
    ...
    <title>Dr P. Satish - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Executive Director, Sa-Dhan</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Dr P. Satish</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/psatish.png" alt="Dr P. Satish">
                            </div>
                        </div>
                            ...
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Dr. P. Satish is the Executive Director of Sa-Dhan since March 2015. He was the Chief General Manager
                                            at NABARD heading the Micro Credit Innovations Department. Previously, he had also worked as a
                                            Faculty Member at Bankers’ Institute of Rural Development (BIRD).
                                            He is a member of RBI’s Financial Inclusion Advisory Committee and a member of Governing Council
                                            of Bankers’ Institute of Rural Development (BIRD), Lucknow. He is on the SHG-Bank Linkage
                                            Programme Strategic Advisory Board of NABARD and the Steering Committee of PM SVANidhi
                                            Scheme of Government of India. He has served as a Board Member of MUDRA, India Post Payments
                                            Bank, IRDAI’s Insurance Advisory Council and Multi Commodity Exchange.
                                            Dr P Satish holds a PhD in Economics from Punjab University and has pursued MBA in Finance from
                                            Osmania University and Master’s in Economics from University of Illinois at Urbana-Champaign, USA.
                                            He has been trained in Project Appraisal and Risk Analysis at Harvard University, Management of
                                            Human Resources at Queensland University of Technology, Brisbane and in Strategic Leadership in
                                            Financial Inclusion at Harvard Business School. He has published more than eighty research papers
                                            and articles in national and international journals and authored/co-authored six books/working
                                            papers and chapters in eight books in the fields of agricultural, rural finance and microfinance.</p>
                                    </div>
