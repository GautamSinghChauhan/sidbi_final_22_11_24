...
<head>
    ...
    <title>Smt Nirmala Sitharaman - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Hon'ble Union Finance Minister, Government of India</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Smt Nirmala Sitharaman</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/nirmala-sitharaman.jpg" alt="Smt Nirmala Sitharaman">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Smt Nirmala Sitharaman</h2>
