...
<head>
    ...
    <title>Ms. Anna Roy - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Senior Adviser, NITI Aayog</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Ms. Anna Roy</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/aroy.png" alt="Ms. Anna Roy">
                            </div>
                        </div>
                            ...
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Ms. Anna Roy is a 1992-batch officer of the Indian Economic Service and has served in the Ministry of
                                            Finance and Ministry of Civil Aviation. Prior joining the IES, she was a lecturer at Delhi University and
                                            worked at The Energy and Resources Institute (TERI).
                                            At NITI Aayog, she heads the vertical dealing with data management and frontier technologies. In this
                                            role, she has led teams that have published major reports such as National Strategy on Artificial
                                            Intelligence, Blockchain- the India Strategy, Approach Paper on AIRAWAT, Responsible AI- Principles &
                                            Enforcement Mechanism, the Data Empowerment & Protection Architecture (DEPA) etc. She also
                                            heads the Women Entrepreneurship Platform, a NITI flagship that works towards developing the
                                            entrepreneurial ecosystem for women.
                                            Ms Anna Roy pursued her education from Shri Ram College of Commerce, Delhi University, and Delhi
