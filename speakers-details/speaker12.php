...
<head>
    ...
    <title>Shri Balamurugan D - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1> IAS, Chief Executive Officer cum State Mission Director, Bihar Rural Livelihoods Promotion Society,</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Shri Balamurugan D</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/dBalamurugam.png" alt="Shri Balamurugan D">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Shri Balamurugan D</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Shri. Balamurugan D. is an Indian Administrative Officer with over a decade of experience in the civil
                                            services of Indian National Government. He brings rich experience in Governance and Administration
                                            with his stints as District Magistrate in districts of Jehanabad, Gopalganj, Darbhanga, Gaya and Siwan.
                                            In his previous roles, he has contributed immensely to the field of digitizing the Social Pension
                                            Programs and community led sanitation systems. He is also the Commissioner, Self-Employment,
                                            Government of Bihar and leads the agenda of skill development in rural areas for gainful
                                            self-employment in rural Bihar. He has also helmed the successful implementation of the SBM and
                                            Lohiya Swachch Bihar Abhiyan program in the state, aimed at achieving 100 percent self-declaration
                                            sanitation facilities by households in Bihar.
                                            Shri Balamurugan D is a graduate in Agriculture Science and Agri- Management from Tamil Nadu
                                            Agriculture University, Coimbatore.</p>
                                    </div>
