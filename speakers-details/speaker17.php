...
<head>
    ...
    <title>Prof M S Sriram - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Visiting Faculty, Public Policy & Chairperson, Centre for Public Policy, llM-Bangalore</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Prof M S Sriram</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/msriram.png" alt="Prof M S Sriram">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Prof M S Sriram</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Professor M S Sriram is currently Visiting Faculty and Chairperson at the Centre for Public Policy, Indian
                                            Institute of Management, Bangalore. Previously, he was the ICICI Bank Lalita D Gupte Chair Professor
                                            of Microfinance at the Indian Institute of Management, Ahmedabad, Vice President (Finance) at BASIX
                                            and on the faculty of Institute of Rural Management Anand.
                                            Professor Sriram has served on several committees set up by Government of India, RBI and NABARD.
                                            He has been actively involved within the policy space, Chairing the Expert Committee on Kerala
                                            Co-operative Bank, External Advisory Committee of RBI to license Small Finance Banks, member on
                                            the Financial Inclusion Advisory Committee of the RBI, Vaidyanathan Committee on co-operative
                                            reforms and the RBI Expert Committee on Primary (Urban) Cooperative Banks.
                                            He pursued his graduation from Institute of Rural Management Anand and is a Fellow of Indian
                                            Institute of Management, Bangalore.</p>
                                    </div>
