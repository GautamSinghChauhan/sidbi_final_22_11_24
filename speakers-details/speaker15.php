...
<head>
    ...
    <title>Shri Navin Chandani - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Managing Director & Chief Executive Officer, CRIF High Mark Credit Information Services</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Shri Navin Chandani</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/nchandani.png" alt="Shri Navin Chandani">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Shri Navin Chandani</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Shri Navin Chandani has over 23 years of valuable experience as an eminent business developer and
                                            brings with him ample knowledge and insights on the credit sector. His domain expertise across
                                            conceptualizing digital strategies in financial services aims to position CRIF as the market leader. Prior
                                            to joining CRIF, he had worked with noteworthy institutions in the BFSI segment that includes
                                            BankBazaar India, American Express, Visa, Experian and Dun and Bradstreet etc.
                                            Shri Navin Chandani holds a Master’s degree in International Business from Symbiosis International
                                            University and specializes in enterprise management.</p>
                                    </div>
