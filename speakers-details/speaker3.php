...
<head>
    ...
    <title>Shri Sanjay Malhotra - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>IAS, Secretary, Department of Financial Services, Ministry of Finance, Government of India</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Shri Sanjay Malhotra</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/smalhotra.png" alt="Shri Sanjay Malhotra">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Shri Sanjay Malhotra</h2>
...
<!-- Mirrored from SIDBInew.php-staging.com/speakers-details/63 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 08:18:56 GMT -->
