...
<head>
    ...
    <title>Shri Devesh Sachdev - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Managing Director & Chief Executive Officer, Fusion Micro Finance Ltd.</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Shri Devesh Sachdev</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/dsachdev.png" alt="Shri Devesh Sachdev">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Shri Devesh Sachdev</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Shri Devesh Sachdev with an experience of over 19 years in varied sectors of Banking, Logistics and
                                            Microfinance co-founded Fusion Micro Finance in 2010. Under his leadership, Fusion has grown into
                                            one of the leading microfinance institutions and continues to expand its operations. His long-term
                                            vision and executing strategy are validated by the marquee PE firm Warbug Pincus’s decision to
                                            choose Fusion to make its first investment in the Indian Microfinance arena in 2018.
                                            He is currently the Chairperson of the Governing Board of Microfinance Institutions Network (MFIN)
                                            and has represented the sector in diverse forums and platforms to create a healthy and positive
                                            outlook. He got awarded as the ‘50 Fastest Growing CEOs of India’ by ‘The CEO Magazine’ in 2018.
                                            He is a strong advocate of agile transformation and digital innovation for employee centric seamless
                                            operations which made Fusion the “Best Workplaces in MFI” in its debut year of GPTW certification
                                            with 66th position in top 100 workplaces in India.
                                            Shri Devesh Sachdev has graduated from Xavier School of Management and has successfully
                                            completed Strategic Leadership program from Harvard Business School.</p>
                                    </div>
