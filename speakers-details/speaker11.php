...
<head>
    ...
    <title>Shri Tamai Bandyopadhyay - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Consulting Editor, Business Standard</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Shri Tamai Bandyopadhyay</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/tBandyopadhyay.png" alt="Shri Tamai Bandyopadhyay">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Shri Tamai Bandyopadhyay</h2>
                            <div class="center-block-sec content profile-block-content mCustomScrollbar _mCS_2 mCS_no_scrollbar" style="height:250px;">
                                <div id="mCSB_2" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
                                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                                        <p>Shri Tamal Bandyopadhyay is an award-winning author and columnist, and a keen student of the
                                            Indian banking sector for over two and a half decades. His weekly column `Banker's Trust' is widely
                                            read for its incisive analysis and informed opinion. Currently he is a Consulting Editor with Business
                                            Standard and Senior Adviser to Jana Small Finance Bank Ltd. He was one of the key members that
                                            setup the financial daily – Mint and was an adviser at Bandhan Bank Ltd.
                                            His last publication “ Pandemonium: The Great Indian Banking Tragedy “ bagged the Tata Literature
                                            Live Best Business Book Award, KLF Best Business Book Award and Skoch Literature Award. His other
                                            nonfiction bestsellers are ‘HDFC Bank 2.0: From Dawn to Digital, A Bank for The Buck, Sahara: The
                                            Untold Story', Bandhan: The Making of a Bank and From Lehman to Demonetization: A Decade of
                                            Disruptions, Reforms and Misadventures.’ He is one of the contributors to the Oxford Handbook on
                                            Indian Economy, edited by Kaushik Basu, and Making of New India: Transformation Under Modi
                                            Government, edited by Bibek Debroy.
                                            In 2017, he won the Ramnath Goenka Award for Excellence in Journalism (commentary and
                                            interpretative writing). The global professional network LinkedIn had nominated him as one of the
                                            most influential voices in India in 2019, 2018 and 2017 and one of the top 10 writers in finance
                                            globally for 2016 and 2015.</p>
                                    </div>
