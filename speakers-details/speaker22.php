...
<head>
    ...
    <title>Shri Rajesh Aggarwal - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>IAS Secretary, Ministry of Skill Development and Entrepreneurship, Government of India</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Shri Rajesh Aggarwal</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="speakers-image text-center userp" data-aos="fade-right" style="display: block;">
                            <div class="borad-profile-user">
                                <img src="<?= SEOURL; ?>assets/front/images/speakers/raggarwal.png" alt="Shri Rajesh Aggarwal">
                            </div>
                        </div>
                        <div class="speakers-info" data-aos="fade-left">
                            <h2>Shri Rajesh Aggarwal</h2>
