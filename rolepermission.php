        ...
        $('#rolepermissionLIST').DataTable({
		  ...
		  },
		  {
				...
				"render": function ( data, type, full, meta ) {
					return '<a title="Click to edit" href="rolepermission.php?route=edit&id='+data+'" class="btn btn-light btn-icon"><i class="fa fa-edit"></i></a> <a href="javascript:void(0);" onClick ="deleteITEM('+data+');" title="Click to delete" class="btn btn-dark btn-icon"><i class="fa fa-trash"></i></a>';
 				}
			 } 
		  ],
		buttons: [
