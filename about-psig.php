...
<head>
    ...
    <title>About PSIG - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <div class="cms KeyOutputs/Activities">
            <div class="container">
                <?php
                $list_transaction = sqlQUERY_LABEL("SELECT `aboutpsig_ID`, `aboutpsig_content`, `aboutpsig_content_hindi`, `status` FROM `aboutpsig` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                    $aboutpsig_ID = $row["aboutpsig_ID"];
                    $aboutpsig_content = html_entity_decode($row["aboutpsig_content"]);
                    $aboutpsig_content_hindi = html_entity_decode($row["aboutpsig_content_hindi"]);
                ?>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="over-cont lisme-sec svt">
                                            <?php if ($get_configured_lang == 'HI') :
                                                echo   $aboutpsig_content_hindi;
                                            else :
                                                echo   $aboutpsig_content;
                                            endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698736141.7968" value="ijUG1qdLkMub0owJcnbZMrCOIl8kkfdX4KSflly9hSe6MUlDcyOQWzwzBQEbDy1uROQFBX15KGfxI8v8L78a4A==" /></div>
                            <div class="row">
