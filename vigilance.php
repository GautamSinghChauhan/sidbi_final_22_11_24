...
<head>
    ...
    <title>VIGILANCE VERTICAL - Small Industries Development Bank of India</title>
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
            ...
            <div class="container">
                <div class="inner">
                    <h1><?php  if($get_configured_lang == 'HI'): 
                                                 echo  'सतर्कता कार्यक्षेत्र';
                                                else:
                                                 echo  'VIGILANCE VERTICAL';
                                                endif; ?></h1>
                </div>
            </div>
        </section>
        <section class="breadcrumb-inner">
            <div class="container">
                <div class="inner">
                    <ul>
                        <li><a href="index.php"><?php  if($get_configured_lang == 'HI'): 
                                                 echo  'मुख्य पृष्ठ';
                                                else:
                                                 echo  'Home';
                                                endif; ?></a></li>
        ...
        <div class="cms HyperlinkingPolicy">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `vigilance_ID`, `vigilance_title`, `vigilance_title_hindi`, `vigilance_content`, `vigilance_content_hindi`, `status` FROM `vigilance` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $vigilance_content = html_entity_decode($row["vigilance_content"]);
                                        $vigilance_content_hindi = html_entity_decode($row["vigilance_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $vigilance_title_hindi;
                                                else:
                                                 echo  $vigilance_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $vigilance_content_hindi;
                                                else:
                                                 echo  $vigilance_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698735500.3571" value="5QVVHTFoSFD9y1Dzjmay4X/sVNCWuM2MH3q5pAZQ1LvVARqI5QBIwFoq2fvnH0a9i4Zzis9QErwO/e3OdVJLfA==" /></div>
                            <div class="row">
