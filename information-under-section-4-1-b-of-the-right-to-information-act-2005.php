...
<head>
    ...
    <title>Information under section 4 (1)(b) of the Right to Information Act, 2005 - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        ?> <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png')  no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Information under section 4 (1)(b) of the Right to Information Act, 2005</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Information under section 4 (1)(b) of the Right to Information Act, 2005</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <div class="cms Informationundersection4(1)(b)oftheRighttoInformationAct,2005">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont">
                            <h2>Information under section 4 (1)(b) of the Right to Information Act, 2005</h2>
                            <p> </p>
                            <figure class="table">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="text-center" width="80px"><strong>Item No.</strong></th>
                                    ...
                                    <tbody>
                                    <?php
                                        $list_transaction = sqlQUERY_LABEL("SELECT `informationunder_id`, `informationunder_provision`, `informationunder_provision_hindi`, `informationunder_detail`, `informationunder_detail_hindi`,  `informationunder_sno`,  `status` FROM `informationunder` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                        while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                            ...
                                            $informationunder_sno =$row["informationunder_sno"];
                                        ?>
                                            <tr>
                                                <td><?= $informationunder_sno ?></td>
                                                <td><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $informationunder_provision_hindi;
                                                else:
                                                 echo   $informationunder_provision;
                                                endif; ?></td>
                                                <td>
                                                    <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $informationunder_detail_hindi;
                                                else:
                                                 echo   $informationunder_detail;
                                                endif; ?></p>
                                                </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698781157.0999" value="k/sGP5dd+TiD1lkwajWrHRHhpHNIQmuU7fgyX0GUdXVFUrcat3HnzTDpO4qXn6rNzq9gnyzOfUU2d7IFj7P0EA==" /></div>
                            <div class="row">
