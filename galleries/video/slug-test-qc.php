...
<!-- Mirrored from SIDBInew.php-staging.com/galleries/video/slug-test-qc by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:50 GMT -->
    ...
    <div class="container">
        <div class="inner">
            <ul>
                ...
                <li><a class="active" href="../../index">Qc_title </a></li>
            </ul>
        </div>
    </div>
</section>
        ...
        <div class="row">
                        ...
                        <div class="list">
                            <div class="list-image">
                                <a class="playvideo" data-fancybox href="https://www.youtube.com/watch?v=-BsZ89dD9qo" target="_blank" title="for video click here">
                                    <img class="img-responsive" src="../../uploads/microfinance_media/168242866610animated-flower-image-0023.gif">
                                </a>
                            </div>
                        </div>
                    </div>
