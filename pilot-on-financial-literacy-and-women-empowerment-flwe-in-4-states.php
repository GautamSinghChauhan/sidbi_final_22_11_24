...
<head>
    ...
    <title>Pilot on Financial Literacy and Women Empowerment (FLWE) in 4 states - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Pilot on Financial Literacy and Women Empowerment (FLWE) in 4 states</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Pilot on Financial Literacy and Women Empowerment (FLWE) in 4 states</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <div class="cms PilotonFinancialLiteracyandWomenEmpowerment(FLWE)in4states">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `pilotfinance_ID`, `pilotfinance_title`, `pilotfinance_title_hindi`, `pilotfinance_content`, `pilotfinance_content_hindi`, `status` FROM `pilotfinance` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $pilotfinance_content = html_entity_decode($row["pilotfinance_content"]);
                                        $pilotfinance_content_hindi = html_entity_decode($row["pilotfinance_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $pilotfinance_title_hindi;
                                                else:
                                                 echo  $pilotfinance_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $pilotfinance_content_hindi;
                                                else:
                                                 echo  $pilotfinance_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698748397.2086" value="PJVCI3KpE+g1gDYv8mMpQvI+3JD6xg5jfe26RFy45T3GY8fiEunSzpJxvI0BJjX87j3qVMjOXDbbGN8OZGWsTg==" /></div>
                            <div class="row">
