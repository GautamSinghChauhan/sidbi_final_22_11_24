...
<head>
    ...
    <title>Disclaimer - Small Industries Development Bank of India</title>
    ...
    <?php
        ...
        if ($count_show_innerpages_datas > 0) :
            while ($row = sqlFETCHARRAY_LABEL($show_innerpages_datas)) :
                ...
                $innerpage_title = htmlspecialchars_decode($row["innerpage_title"]);
                $innerpage_title_hindi = htmlspecialchars_decode($row["innerpage_title_hindi"]);
                $innerpage_content =  htmlspecialchars_decode($row["innerpage_content"]);
                $innerpage_content_hindi =   htmlspecialchars_decode($row["innerpage_content_hindi"]);
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1704082579.5523" value="TmLmNO3JV9foU6PvGx7mt9sPfcvTEHnX2zrV76Rk9mPG/a7mSJvvNxUWpYdM0x2VwbUtEcpuTCWhcL2fiQzbjA==" /></div>
                            <div class="row">
        ...
        <div class="modal fade msme-cluster-development-popup default-form" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698735504.0601" value="F6oprO8SqLyS6V1Mo3eajHdNo3UT0C0833SNayanrmQnrmY5O3qoLDUI1ETKDm7QgyeEL0o48gzO89kBVaUxow==" /></div>
                            <div class="row">
                                <div class="col-md-6" id="userdownloads_fullname_field">
                                    <div class="form-group">
                                        <div class="col-md-12" id="div-full_name">
        ...
        <script>
            function switchLanguage(selectedValue) {
                ...
                var englishTITLE = <?php echo json_encode($innerpage_title); ?>;
