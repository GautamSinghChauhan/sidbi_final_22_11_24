...
<!-- Mirrored from SIDBInew.php-staging.com/press-release-details/158 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 08:17:58 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI and Monsha’at of Saudi Arabia join hands for MSME Co-operation - Small Industries Development Bank of India</title>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2> DLAI Signs MoU with SIDBI to Boost India’s Fintech Sector</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont">
                            ...
                            <div class="box-2">
                                ...
                                <span>
                                    <a href="<?= SEOURL; ?>uploads/pressrelease/PR_SIDBI-DLAI-COC-MOU-.pdf" target="_blank" class="btn btn-info" title="Download"><i class="fa fa-file-pdf-o"></i> Document1</a>
                                </span>
                            </div>
                        </div>
                    </div>
