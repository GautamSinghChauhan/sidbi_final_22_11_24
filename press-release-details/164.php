...
<!-- Mirrored from SIDBInew.php-staging.com/press-release-details/164 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 08:17:57 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI enters Co-lending Space for Unsecured Loans to MSMEs Strategic co-lending partnership with Ambit Finvest - Small Industries Development Bank of India</title>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>SIDBI joins hands with TDB to support MSMEs</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont">
                            ...
                            <div class="box-2">
                                ...
                                <span>
                                    <a href="<?= SEOURL; ?>uploads/pressrelease/2023-11-17-151052-wlo63-Press-Release_TDB-Final.pdf" target="_blank" class="btn btn-info" title="Download"><i class="fa fa-file-pdf-o"></i> Document1</a>
                                </span>
                            </div>
                        </div>
                    </div>
