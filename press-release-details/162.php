...
<!-- Mirrored from SIDBInew.php-staging.com/press-release-details/162 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 08:17:57 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Global Alliance for Mass Entrepreneurship (G.A.M.E) Launch of the First ever Cohort for smaller NBFCs accelerate & Grow, The NGAP aimed to increase Access to Finance for micro enterprises - Small Industries Development Bank of India</title>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>Global Alliance for Mass Entrepreneurship (G.A.M.E) Launch of the First ever Cohort for smaller NBFCs accelerate & Grow, The NGAP aimed to increase Access to Finance for micro enterprises</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont">
                            <h2>Global Alliance for Mass Entrepreneurship (G.A.M.E) Launch of the First ever Cohort for smaller NBFCs accelerate & Grow, The NGAP aimed to increase Access to Finance for micro enterprises</h2>
                            <div class="box-2">
                                Global Alliance for Mass Entrepreneurship (G.A.M.E) Launch of the First ever Cohort for smaller NBFCs accelerate & Grow, The NGAP aimed to increase Access to Finance for micro enterprises
                                <span>
                                    <a href="<?= SEOURL; ?>uploads/pressrelease/Press-Release---GAME-SIDBI-Partnership-LAUNCH-THE-FIRST-EVER-COHORT-FOR-SMALLER-NBFCs-ACCELERATE-&-GROWTH.pdf" target="_blank" class="btn btn-info" title="Download"><i class="fa fa-file-pdf-o"></i> Document1</a>
                                </span>
                            </div>
                        </div>
                    </div>
