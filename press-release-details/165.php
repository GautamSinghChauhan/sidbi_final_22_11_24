...
<!-- Mirrored from SIDBInew.php-staging.com/press-release-details/165 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 08:17:57 GMT -->
<!-- Added by HTTrack -->
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>Jocata launches “Sumpoorn” India’s first MSME Economic Activity Index in association with SIDBI</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont">
                            <h2>Jocata launches “Sumpoorn” India’s first MSME Economic Activity Index in association with SIDBI</h2>
                            <div class="box-2">
                                Jocata launches “Sumpoorn” India’s first MSME Economic Activity Index in association with SIDBI
                                <span>
                                    <a href="<?= SEOURL; ?>uploads/pressrelease/Sumpoorn-Launch_PressRelease_10th-November.pdf" target="_blank" class="btn btn-info" title="Download"><i class="fa fa-file-pdf-o"></i> Document1</a>
                                </span>
                            </div>
                        </div>
                    </div>
