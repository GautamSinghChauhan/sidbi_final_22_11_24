...
<!-- Mirrored from SIDBInew.php-staging.com/press-release-details/159 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 08:17:57 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI – Start Up Outreach Program -2022 - Small Industries Development Bank of India</title>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>SIDBI Takes A Proactive Approach On Swachhata Pakhwada 2023 By Organizing Cleanliness Campaigns.</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont">
                            <h2>SIDBI Takes A Proactive Approach On Swachhata Pakhwada 2023 By Organizing Cleanliness Campaigns.</h2>
                            <div class="box-2">
                                SIDBI Takes A Proactive Approach On Swachhata Pakhwada 2023 By Organizing Cleanliness Campaigns.
                                <span>
                                    <a href="<?= SEOURL; ?>uploads/pressrelease/Press-Release-I-SIDBI-takes-a-Proactive-approach-on-Swachhata-Pakhwada-2023-.pdf" target="_blank" class="btn btn-info" title="Download"><i class="fa fa-file-pdf-o"></i> Document1</a>
                                </span>
                            </div>
                        </div>
                    </div>
