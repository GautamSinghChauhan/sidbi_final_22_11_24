...
<!-- Mirrored from SIDBInew.php-staging.com/press-release-details/166 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 08:17:57 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI – Inauguration of Branch Office at Ambattur, Chennai - Small Industries Development Bank of India</title>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>SIDBI and Finance Department UT of J&K entered into Agreement for availing of SIDBI Cluster Development Fund to accelerate MSME Cluster infrastructure development in UT</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont">
                            <h2>SIDBI and Finance Department UT of J&K entered into Agreement for availing of SIDBI Cluster Development Fund to accelerate MSME Cluster infrastructure development in UT</h2>
                            <div class="box-2">
                                <p>SIDBI and Finance Department UT of J&K entered into Agreement for availing of SIDBI Cluster Development Fund to accelerate MSME Cluster infrastructure development in UT</p>
                                <span>
                                    <a href="<?= SEOURL; ?>uploads/pressrelease/2023-11-17-145530-w1y8p-Press-Release_Master-Agreement_UT-of-JK-Final.pdf" target="_blank" class="btn btn-info" title="Download"><i class="fa fa-file-pdf-o"></i> Document1</a>
                                </span>
                            </div>
                        </div>
                    </div>
