...
<!-- Mirrored from SIDBInew.php-staging.com/press-release-details/161 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 08:17:57 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI AND IPPB ENTER INTO MOU FOR DEVELOPMENT OF INFORMAL MICRO ENTERPRISES - Small Industries Development Bank of India</title>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>SIDBI and IPPB enter into MoU for development of informal micro enterprises</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont">
                            ...
                            <div class="box-2">
                                ...
                                <span>
                                    <a href="<?= SEOURL; ?>uploads/pressrelease/India-Post-Payments-Bank--SIDBI----Press-Release-Final-Oct-11.pdf" target="_blank" class="btn btn-info" title="Download"><i class="fa fa-file-pdf-o"></i> Document1</a>
                                    <a href="<?= SEOURL; ?>uploads/pressrelease/Hindi_Translation_Press_Release_SIDBI_IPPB_MoU-Final-Oct-11.pdf" target="_blank" class="btn btn-info" title="Download"><i class="fa fa-file-pdf-o"></i> Document2</a>
                                </span>
                            </div>
                        </div>
                    </div>
