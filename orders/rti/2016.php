                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/Appeal-1-Shri-Horilal-Sharma-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-1-Shri-Horilal-Sharma-Order.pdf</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/Appeal-2-Shri-Manoj-Kaknani-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-2-Shri-Manoj-Kaknani-Order.pdf</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/Appeal-03-M-J-Khan-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-03-M-J-Khan-Order.pdf</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/Appeal-4-R-Raghava-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-4-R-Raghava-Order.pdf</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/Appeal-5Shri-Munna-Modi-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-5Shri-Munna-Modi-Order.pdf</a>
                                    </li>
