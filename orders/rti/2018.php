                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/articlefiles/Appeal-no-01-Pushkar-Kumar-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-no-01-Pushkar-Kumar-Order.pdf</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/articlefiles/Appeal-no-02-Vijay-Wamanrao-Bodke-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-no-02-Vijay-Wamanrao-Bodke-Order.pdf</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/articlefilesAppeal-no-02-Vijay-Wamanrao-Bodke-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-no-02-Vijay-Wamanrao-Bodke-Order.pdf</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/articlefiles/Appeal-No-04-Ajay-Kumar-Yadav-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-No-04-Ajay-Kumar-Yadav-Order.pdf</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/articlefiles/Appeal-no-05-Sanjay-Gupta-Order.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Appeal-no-05-Sanjay-Gupta-Order.pdf</a>
                                    </li>
