            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">RTI</a></li>
                    </ul>
                </div>
            </div>
        </section>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/1_A22_Rahul_Dhuper_January_02_2013.doc"><i
                                                class="fa fa-file-pdf-o"></i>
                                                1_A22_Rahul_Dhuper_January_02_2013.do</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/13_A23_Lochan_Makhija_30_October_2013.docx"><i
                                                class="fa fa-file-pdf-o"></i>
                                                13_A23_Lochan_Makhija_30_October_2013.docx</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/2019-02-08-202147-eb927-14_A24_Lochan_Makhija_30_October_2013.docx"><i
                                                class="fa fa-file-pdf-o"></i>
                                                2019-02-08-202147-eb927-14_A24_Lochan_Makhija_30_October_2013.docx</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/15_A19_Lochan_Makhija_30_October_2013.docx"><i
                                                class="fa fa-file-pdf-o"></i>
                                                15_A19_Lochan_Makhija_30_October_2013.docx"</a>
                                    </li>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/article/articlefiles/16_A20_Lochan_Makhija_01_November_2013.docx"><i
                                                class="fa fa-file-pdf-o"></i>
                                                16_A20_Lochan_Makhija_01_November_2013.docx</a>
                                    </li>
