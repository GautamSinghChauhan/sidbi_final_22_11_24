...
<head>
    ...
    <title>PRSF Project - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <div class="cms PRSFProject">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `psrf_ID`, `psrf_title`, `psrf_title_hindi`, `psrf_content`, `psrf_content_hindi`, `status` FROM `psrf` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        $psrf_ID = $row["psrf_ID"];
                                        $psrf_title = $row["psrf_title"];
                                        $psrf_title_hindi = $row["psrf_title_hindi"];
                                        $psrf_content = html_entity_decode($row["psrf_content"]);
                                        $psrf_content_hindi = html_entity_decode($row["psrf_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $psrf_title_hindi;
                                                else:
                                                 echo  $psrf_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $psrf_content_hindi;
                                                else:
                                                 echo  $psrf_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780692.6684" value="1vsFQyOpSvMo3lZDtUfbdxbn2q5Oh52cmE4eekHuSjYAUrRmA4VUBpvhNPlI7dqnyakeQioLi01DwZ4gj8nLUw==" /></div>
                            <div class="row">
