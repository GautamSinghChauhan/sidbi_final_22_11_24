...
<head>
    ...
    <title>Other Initiatives - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <div class="cms OtherInitiatives">
            <div class="container">
                <?php 
            $list_transaction = sqlQUERY_LABEL("SELECT `psigother_ID`, `psigother_title`, `psigother_title_hindi`, `psigother_content`, `psigother_content_hindi`, `status` FROM `psigother` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $psigother_content = html_entity_decode($row["psigother_content"]);
                                        $psigother_content_hindi = html_entity_decode($row["psigother_content_hindi"]);
                                    ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                            <h2><?php  if($get_configured_lang == 'HI'): 
                                                 echo $psigother_title_hindi;
                                                else:
                                                 echo $psigother_title;
                                                endif; ?></h2>
                            <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $psigother_content_hindi;
                                                else:
                                                 echo  $psigother_content;
                                                endif; ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698736171.8515" value="6kZl+fir3fSwDgkUkOf0UwCZFqoshPEh50fhKB+p+F/aQipsLMPdZBfvgBz5ngAP9PMx8HVsLhH2wLVCbKtnmA==" /></div>
                            <div class="row">
