...
<head>
    ...
    <title data-translate="joinUsCCCSTITLE">Join Us As CCCs - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png')  no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1 data-translate="joinUsCCCSHead"><?php  if($get_configured_lang == 'HI'): 
                                                 echo 'सीसीसी के रूप में हमसे जुड़ें';
                                                else:
                                                 echo 'Join Us As CCCs';
                                                endif; ?></h1>
                </div>
            </div>
        </section>
        <section class="breadcrumb-inner">
            <div class="container">
                <div class="inner">
                    <ul>
                        <li><a href="index" data-translate="homeHEADING"><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                                 मुख्य पृष्ठ';
                                                else:
                                                 echo 'Home';
                                                endif; ?></a></li>
                        <li><a class="active" href="#" data-translate="joinUsCCCSHead"><?php  if($get_configured_lang == 'HI'): 
                                                 echo 'सीसीसी के रूप में हमसे जुड़ें';
                                                else:
                                                 echo 'Join Us As CCCs';
                                                endif; ?></a></li>
        ...
        <div class="cms JoinUsAsCCCs">
            <section class="joinUs">
                <div class="container">
                    <div class="row">
                        <?php
                        $list_transaction = sqlQUERY_LABEL("SELECT `joinus_id`, `joinus_content`, `joinus_content_hindi`, `joinus_image`, `status` FROM `joinus` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                        ...
                        ?>
                            <div class="col-md-6" data-aos="fade-right">
                                <div class="joinusInner">
                                    <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo $joinus_content_hindi;
                                                else:
                                                 echo $joinus_content;
                                                endif; ?></p>
                                    <p><a class="cccsBTN" href="<?= SEOURL; ?>assets/front/pdf/Hanbook-of-CCC-15-02-2018.pdf" target="_blank" data-translate="joinUsCCCSButton">E-HANDBOOK FOR CCCS</a></p>
                                </div>
                            </div>
                            <div class="col-md-6" data-aos="fade-left">
                                <div class="joinusImg"><img src="assets/front/home/<?= $joinus_attachement ?>"></div>
                            </div>
                        <?php endwhile; ?>
                    </div>
                </div>
            </section>
            <section class="SIDBIJoinusWrap">
                <div class="container">
                    <div class="row">
                        <?php
                        $list_transaction = sqlQUERY_LABEL("SELECT `joincccs_id`, `joincccs_title`, `joincccs_title_hindi`, `joincccs_link`, `joincccs_image`, `status` FROM `joincccs` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                        while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                        ...
                        ?>
                            <div class="col-md-3 d-none">
                                <div class="SIDBIJoinus">
                                    <div class="SIDBIJoinus-main-ul">
                                        <div>
                                            <p><a href="<?= $joincccs_link ?>" target="_blank">no-anchor</a>
                                            </p>
                                            <div class="SIDBIJoinbox">
                                                <p><img src="assets/front/home/<?= $joincccs_image ?>" alt="icon"></p>
                                                <p><?= $joincccs_title ?></p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <a href="<?= $joincccs_link ?>" target="_blank">
                                    <div class="card h-100">
                                        <div class="card-body h-100 d-flex flex-column">
                                            <div class="w-100 text-center">
                                                <div class="SIDBIJoinbox d-flex flex-column align-items-center justify-content-center">
                                                    <p><img src="assets/front/home/<?= $joincccs_image ?>" alt="icon"></p>
                                                    <p> <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo $joincccs_title_hindi;
                                                else:
                                                 echo $joincccs_title;
                                                endif; ?></p></p>
                                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698734989.7391" value="mRR8APMg84egyjuLDbt3Jp82HJVwtSQqs26BSwKR+LGpEDOVJ0jzFwcrsoNkwoN6a1w7zyld+xqi6dUhcZNndg==" />
                            </div>
                            <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="captcha">
                                                    ...
                                                    <div class="captchRefresh" onclick="refreshcaptcha();"><img src="<?= SEOURL; ?>assets/front/images/refresh-icon.png">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
