...
<meta charset="utf-8" />
  ...
  <title>Reservation Roster - Small Industries Development Bank of India</title>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="/">Home</a></li>
                        <li><a class="active" href="#">Reservation Roster</a></li>

                    </ul>
                </div>
            </div>
        </section>
        <div class="cms ReservationRoster">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont wow fadeInDown" style="animation-name:fadeInDown;visibility:visible;">
                            <h2>Reservation Roster</h2>
                            <h5><strong>Reservation Roster / Registers updated as on 31/12/2022</strong></h5>
                            <div class="row">
                            <div class="col-md-12">
                                <table class="table table-bordered" id="reservation_rosterLIST">
                                    <thead>
                                        <tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1706190893.0686" value="hxJfDCR/SpjntIrZpe0fVD392LXDF4gAHTrj7VKWi/PtqURRg0lyA3axieDQzRtsmII684vSNiNPVTQjZ8OtmA==" /></div>
                            <div class="row">
                                ...
                                <div class="col-md-12" id="userdownloads_captcha_field">
                                    <div class="form-group reSetPass">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="captcha">
                                                    <div class="captchaImg"><img id="captcha" src="/admin/ajax/generateCaptcha" /></div>
                                                    <div class="captchRefresh" onclick="refreshcaptcha();"><img src="Default/assets/front/images/refresh-icon.png"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
var dataTable = $('#reservation_rosterLIST').DataTable({
                //responsive: true,
                'ajax': '<?= BASEPATH; ?>engine/json/JSONreservation_roster.php?show=frontend&language=' + localStorage.getItem('selectedLanguage'),
                "lengthChange": true,
                ...
                "columnDefs": [{
                    ...
                    "searchable": false,
                    "render": function(data, type, row) {
                        return '<a href="<?= SEOURL; ?>/uploads/reservation_roster_document/' + data + '" title="Download" target="_blank"><img class="download-icon-blue" src="<?= SEOURL; ?>assets/front/images/cloud-download-blue.png" alt="Icon" /></a>';
                    }
                }],
                language: {
            ...
            async function reservation_rosterDataTable(lang) {
                $.ajax({
                    url: '<?= BASEPATH; ?>engine/json/JSONreservation_roster.php?show=frontend&language=' + lang, // Replace with your actual PHP file/function
