...
<head>
    ...
    <title>Aggregator Platforms - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
            ...
            <div class="container">
                <div class="inner">
                    <h1><?php  if($get_configured_lang == 'HI'): 
                                                 echo  'एग्रीगेटर प्लेटफार्म';
                                                else:
                                                 echo   'Aggregator Platforms';
                                                endif; ?></h1>
                </div>
            </div>
        </section>
        ...
        <div class="cms AggregatorPlatforms">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `aggregatorplatform_ID`, `aggregatorplatform_title`, `aggregatorplatform_title_hindi`, `aggregatorplatform_content`, `aggregatorplatform_content_hindi`, `status` FROM `aggregatorplatform` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $aggregatorplatform_content = html_entity_decode($row["aggregatorplatform_content"]);
                                        $aggregatorplatform_content_hindi = html_entity_decode($row["aggregatorplatform_content_hindi"]);
                                    ?>
                        <h3><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo   $aggregatorplatform_title_hindi;
                                                else:
                                                 echo   $aggregatorplatform_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo   $aggregatorplatform_content_hindi;
                                                else:
                                                 echo   $aggregatorplatform_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698735418.204" value="AG1Jk6f6EFGdhtso21n3Nu0mrwRLwngzvbjWynVccn0waQYGc5IQwTpnUiCyIANqGUyIXhIqpwOsP4KgBl7tug==" /></div>
                            <div class="row">
