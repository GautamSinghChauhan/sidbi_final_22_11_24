...
<head>
    ...
    <title>SIDBI INVITES APPLICATIONS FOR ENGAGEMENT OF BUSINESS ANALYSTS ON CONTRACTUAL BASIS (FULL TIME) -2023
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont wow fadeInDown">
                            <h2>SIDBI INVITES APPLICATIONS FOR ENGAGEMENT OF BUSINESS ANALYSTS ON CONTRACTUAL BASIS (FULL TIME) -2023
</h2>
                ...
                <div class="inner">
                    <div class="">
                        <div class="title-content bold-title with-underline green">
                            ...
                            <p>Engagement of Business Analysts on Contractual Basis (Full Time) -2023 (Download Documents)</p>
                    ...
                    <div class="col-md-12">
                        <div class="over-cont complaint-inner">
                            ...
                            <div class="box-2 features-ul">
                                <ul>
                                    <h3>Detailed Advertisement - 
</h3>
                                    <h3>Application Form-
</h3>
                                    <h3>Format of disability certificate
</h3>
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/tenders/Detailed-Advertisement.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Detailed-Advertisement.pdf</a>
                                    </li>
                                  
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/tenders/Application-Form_pdf.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                Application-Form_pdf.pdf</a>
                                    </li>
                                  
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/tenders/Application-Form_doc.docx"><i
                                                class="fa fa-file-pdf-o"></i>
                                                 Application-Form_doc.docx</a>
                                    </li>
                                  
                                    <li>
                                        <a title="Download" target="_blank"
                                            href="<?= SEOURL; ?>uploads/tenders/2023-11-15-121106-8d5mz-PwBD_Certificate_Fomat.pdf"><i
                                                class="fa fa-file-pdf-o"></i>
                                                2023-11-15-121106-8d5mz-PwBD_Certificate_Fomat.pdf</a>
                                    </li>
