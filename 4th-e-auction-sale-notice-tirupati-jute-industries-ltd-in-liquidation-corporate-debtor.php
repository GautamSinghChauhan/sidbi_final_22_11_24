...
<head>
    ...
    <title>4TH E-AUCTION SALE NOTICE - TIRUPATI JUTE INDUSTRIES LTD. – IN LIQUIDATION [CORPORATE DEBTOR] - Small
        Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" data-aos="fade-down"
            ...
            <div class="container">
                <div class="inner">
                    <h1>4TH E-AUCTION SALE NOTICE - TIRUPATI JUTE INDUSTRIES LTD. – IN LIQUIDATION [CORPORATE DEBTOR]</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">4TH E-AUCTION SALE NOTICE - TIRUPATI JUTE INDUSTRIES LTD. – IN LIQUIDATION [CORPORATE DEBTOR]</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>4TH E-AUCTION SALE NOTICE - TIRUPATI JUTE INDUSTRIES LTD. – IN LIQUIDATION [CORPORATE
                                DEBTOR]</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="over-cont">
                            <div class="box-2">
                                <div class="col-lg-4 col-md-4 col-sm-12 mb-2">
                                    ...
                                    <a href="uploads/tenders/167903145875E-auction-sale-notice-Tirupati-jute-4th-e-auction.pdf"
                                        target="_blank" class="btn btn-success" title="Documents"><i
                                            class="fa fa-file-pdf-o"></i>
                                        167903145875E-auction-sale-notice-Tirupati-jute-4th-e-auction.pdf</a>
                                </div>
                            </div>
                        </div>
                    </div>
