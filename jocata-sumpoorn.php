...
<div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
    ...
    if ($count_show_innerpages_datas > 0) :
        while ($row = sqlFETCHARRAY_LABEL($show_innerpages_datas)) :
            ...
            $innerpage_title_decode = html_entity_decode($innerpage_title);
...
<section class="about-us-banner" data-aos="fade-down" style="background: url('assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
    ...
    <section class="overview-section Impact_Initiatives" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div class="col-lg-6 p-0">
                        <div class="container">
                            <div class="row">
                                ...
                                <?php
                                // Assuming $id contains the value for innerpage_ID

                                // Perform the SQL query
                                $sql = "SELECT `innerpage_attachmentID`, `innerpage_ID`, `innerpage_thumbnail_image`, `innerpage_pdf_attachment` FROM `js_innerpage_attachments` WHERE `innerpage_ID` = '$innerpage_ID' AND `deleted` ='0'";
                                $result = sqlQUERY_LABEL($sql) or die("#1-UNABLE_TO_GETTING_ATTACHED_PO_DOCUMENT:" . sqlERROR_LABEL());
                                ...
                                if (sqlNUMOFROW_LABEL($result) > 0) {
                                    ...
                                    while ($row = sqlFETCHARRAY_LABEL($result)) {
                                        ...
                                        $thumbnail_image = $row['innerpage_thumbnail_image'];
                                        $pdf_attachment = $row['innerpage_pdf_attachment'];
                                ?>
                                        <div class="col-lg-6">
                                            <div class="customImageBlock h-250">
                                                <a href="<?= SEOURL; ?>assets/front/innerpages/<?= $pdf_attachment; ?>" target="_blank">
                                                    <img src="<?= SEOURL; ?>assets/front/innerpages/<?= $thumbnail_image; ?>" alt="<?= $thumbnail_image; ?>" title="<?= $thumbnail_image; ?>">
                                                </a>
                                            </div>
                                        </div>
                                <?php
