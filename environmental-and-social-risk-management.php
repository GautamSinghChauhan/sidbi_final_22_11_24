...
<head>
    ...
    <title>Environmental and social risk management - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
            ...
            <div class="container">
                <div class="inner">
                    <h1><?php  if($get_configured_lang == 'HI'): 
                                                 echo  'पर्यावरण और सामाजिक जोखिम प्रबंधन';
                                                else:
                                                 echo  'Environmental and social risk management';
                                                endif; ?></h1>
                </div>
            </div>
        </section>
        ...
        <div class="cms Environmentalandsocialriskmanagement">
            <div class="container">
                <div class="row">
                <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `environmental_ID`, `environmental_title`, `environmental_title_hindi`, `environmental_content`, `environmental_content_hindi`, `status` FROM `environmental` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $environmental_content = html_entity_decode($row["environmental_content"]);
                                        $environmental_content_hindi = html_entity_decode($row["environmental_content_hindi"]);
                                    ?>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $environmental_content_hindi;
                                                else:
                                                 echo  $environmental_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780688.3936" value="+CJrnZpRTLbcjyZyjYMCapR9ORzrhLGWHZ1pUtA9gzsui9q4un1SQ2+wRMhwKQO6SzP98I8Ip0fGEukIHhoCXg==" /></div>
                            <div class="row">
