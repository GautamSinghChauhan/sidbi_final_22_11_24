...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/20 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Priority Assistance to MSMEs based on Hybrid or Alternate-security Model (PRATHAM) - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Priority Assistance to MSMEs based on Hybrid or Alternate-security Model (PRATHAM)</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">Priority Assistance to MSMEs based on Hybrid or Alternate-security Model (PRATHAM)</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" dir="ltr" id="mCSB_64_container"><span class="block_span">Upto 100% financing</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" dir="ltr" id="mCSB_64_container"><span class="block_span">One-page application format</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" dir="ltr" id="mCSB_64_container"><span class="block_span">Quick sanction and disbursement</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>MSMEs having atleast 3 years of operation with net profit in previous three years.</li>
                                        <li>Units having cash profit for past three years would also be eligible.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        ...
                                        <li>Ancillary equipment’s/MFAs</li>
                                        <li>Installation/transportation cost may be included.</li>
                                        <li>Second hand/refurnished machines are also permitted subject to standard guidelines.</li>
                                        <li>Machinery which is not covered under SPEED/SPEED Plus.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Upto 100% of the total project cost subject to maximum of ₹ 300 lakh (based on 30% - 40% FD). SIDBI reserves the right to sanction lower amount depending upon assessment of repayment capacity.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Generally, upto 5 years including moratorium of 6 -12 months.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
