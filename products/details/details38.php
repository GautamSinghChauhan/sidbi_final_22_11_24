...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/38 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:21 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>QC product title new - Small Industries Development Bank of India</title>
    ...
    <header>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">QC product title new</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image21.jpg") no-repeat center center / cover;'>
