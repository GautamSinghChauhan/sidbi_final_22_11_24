...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/8 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:49 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>MICRO LENDING DEVELOPMENT - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>MICRO LENDING DEVELOPMENT</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="../micro_finance.php">Micro Lending</a></li>
                        <li><a class="active" href="javascript:void(0);">MICRO LENDING DEVELOPMENT</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../uploads/products/project-image1.png") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                ...
                                <p><b><strong>Mission:</strong></b> To create a national network of strong, viable and
                                    sustainable Microfinance Institutions (MFIs) for providing microfinance services to
                                    the economically disadvantaged people, especially
                                    women. <br><b><strong>Approach:</strong></b>Complete Range of Financial and
                                    Non-Financial Services- <b><strong>Financial Support to MFIs-</strong></b></p>
                                <ul>
                                    <li>Loan</li>
                                    <li>Capacity Building Grant</li>
                                    <li>Equity/Quasi Equity</li>
                                </ul>
                                <p><b><strong>Non-financial Services </strong></b></p>
                                <ul>
                                    <li>Advocating Appropriate Policies and Regulations</li>
                                    <li>Enhancing Corporate Governance of MFIs</li>
                                    <li>Promoting Responsible Lending Practices</li>
                                    <li>Creation of Lender’s Forum</li>
                                    <li>Code of Conduct Assessment (COCA)</li>
                                </ul>
                                <p> </p>
                            </div>
                        </div>
        ...
        <div class="apply-now-loan-btn">
            <div class="container">
                <div class="button-1 green-btn">
                    <a target="_blank" href="../../borrowers-corner.html">Apply Now<i class="fa fa-angle-right"></i></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Milestone & Impacts</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Developed the capacity of 100+ MFIs</li>
                                        <li>Cumulative Sanctions: ₹22871 cr</li>
                                        <li>Cumulative Disbursements: ₹23461 cr</li>
                                        <li>Impacted more than 40.80 million beneficiaries</li>
                                        <li>SC/ST/ backward classes accounting for approx. 73% of the total
                                            beneficiaries.</li>
                                        <li>Women proportion was 96-98% among the beneficiaries.</li>
                                        <li>Brought out changes in the livelihood pattern by giving impetus to
                                            enterprise activity</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>National Microfinance Support Program (NMFSP)</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Launched in April 2000 under collaboration with Department for International
                                            Development (DFID), UK to bring in best microfinance practices in India.
                                            Collaboration was made with International Fund for Agricultural Development
                                            (IFAD), Rome in April-2002 for on lending support to MFIs.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Assistance to Small Finance Banks</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Out of10 entities having received the SFB license from RBI, eight were
                                            partner MFIs of SIDBI</li>
                                        <li>Need based interventions to facilitate smooth transition from MFI to SFBs.
                                        </li>
                                        <li>Equity investment and resource support with provisions for conversion</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li><a href="<?= SEOURL; ?>../assets/front/pdf/Micro%20Credit%20Operation.docx">For details,
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Documents/ Publications</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li><a href="https://SIDBI.in/en/coca-reports">COCA reports</a></li>
                                        <li><a href="https://SIDBI.in/en/sectoral-studies">Sectoral Studies</a></li>
                                        <li><a href="https://SIDBI.in/impact-assessment-studies">Impact Assessment
                                                Studies</a></li>
                                        <li>SIDBI’s Coffee Table Book You Tube Link:<a href="https://www.youtube.com/watch?v=UJZ-ongFhKQ&amp;t=32s">https://www.youtube.com/watch?v=UJZ-ongFhKQ&amp;t=32s</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <footer>
            <div class="container">
                <div class="footerInner">
                    <div class="ImgWrap"><img src="<?= SEOURL; ?>../assets/front/images/logo.png" class="img-fluid"></div>
                    <div class="row">
                            ...
                            <ul class="list-unstyled contactDetails">
                                <li class="d-flex align-items-baseline">
                                    ...
                                    <div class="footer-details-main">
                                        <span>15, Ashok Marg, Lucknow - 226001, <br> Uttar Pradesh</span>
                                    </div>
                                </li>
                                <li class="d-flex align-items-baseline">
                                    <div class="footer-icon-main">
                        ...
                        <div class="col-lg-4 col-md-3 col-sm-12">
                            <ul class="list-unstyled footerNav">
                                ...
                                <li><a href="../../reservation-roster">Reservation Roster</a></li>
                                <li><a href="../../contact_us.php">Customer Care</a></li>
                    ...
                    <div class="row align-items-center pb-0 border-0 toll-free-social">
                        <div class="col-md-7">
                            <h2><span>TOLL FREE NUMBER</span> :<a href="tel:1800226753"> 1800226753</a></h2>
                        </div>
                        <div class="col-md-5 text-end">
                            <div class="d-flex align-items-center justify-content-end">
                                <p class="text-white mb-0 d-lg-block">Social Connections</p>
                                <ul class="list-unstyled mb-0 footerSocial">
                                    <li><a href="https://twitter.com/SIDBIofficial?ref_src=twsrc%5Etfw" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                    <li><a href="https://www.facebook.com/SIDBIOfficial/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                    <li><a href="https://www.youtube.com/channel/UCFp0C2eaU3QQSGbrMK-AU8w" target="_blank"><i class="fa fa-youtube"></i></a></li>
                                    <li><a href="https://www.instagram.com/SIDBIofficial/" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                    <li><a href="https://www.linkedin.com/company/SIDBI-small-industries-development-bank-of-india-" target="_blank"><i class="fa fa-linkedin"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-xl-8">
                    <ul class="list-unstyled mb-0">
                        ...
                        <li><a href="../../hyperlink-policy">Hyperlinking Policy</a></li>
                        <li><a href="../../accessibility">Accessibility</a></li>
                        <li><a href="../../disclaimer">Disclaimer</a></li>
                        <li><a href="../../sitemap">Sitemap</a></li>
                    </ul>
                    <p class="text-white mb-0">Copyright © 2023 Small Industries Development Bank of India(SIDBI). All
                        rights reserved</p>
                </div>
                <div class="col-md-4 text-end d-xl-block">
                    <p class="mb-0 text-white">
                        <span class="fw-bold">Visitors</span>:
                        <!-- Default Statcounter code for SIDBI http://pp.SIDBInew.local -->
                        <script type="text/javascript">
                            var sc_project = 12856375;
                            var sc_invisible = 0;
                            var sc_security = "cdce168e";
                            var sc_text = 2;
                            var scJsHost = "https:///";
                        ...
                        <noscript>
                            <div class="statcounter">
                                <a title="Web Analytics" href="javascript:void(0);">
                                    <img class="statcounter" src="https://c.statcounter.com/12856375/0/cdce168e/0/" alt="Web Analytics" referrerPolicy="no-referrer-when-downgrade">
                                </a>
                            </div>
                        </noscript>
                    </p>
                    <p class="mb-0 text-white"><span class="fw-bold">Last updated on</span>: 15 December 2022
                </div>
            </div>
        </div>
    </section>
