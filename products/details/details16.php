...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/16 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI Term-loan Assistance for Rooftop Solar PV Plants (STAR) - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>SIDBI Term-loan Assistance for Rooftop Solar PV Plants (STAR)</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">SIDBI Term-loan Assistance for Rooftop Solar PV Plants (STAR)</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>USPs of the product</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_34_container" dir="ltr"><span class="block_span">Helping MSMEs to reduce their Power bill</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_34_container" dir="ltr"><span class="block_span">Across the segment coverage with 25 KW to 1 MW plants (indicative)</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_34_container" dir="ltr"><span class="block_span">Loan Amount: ₹10 lakh to Rs. 350 Lakh</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_34_container" dir="ltr"><span class="block_span">Quick sanction and fast disbursement</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_34_container" dir="ltr"><span class="block_span">Ground mount solar plants are also allowed subject to unhindered availability of sunlight during tenure of the loan.</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>100% finance</li>
                                        <li>Zero promoter’s contribution</li>
                                        <li>FD of 15% to 25% of Loan (interest bearing)</li>
                                        <li>Attractive Interest rates</li>
                                        <li>Credit Guarantee cover available</li>
                                        <li>Simple Loan documentation</li>
                                        <li>Direct payment to Supplier</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Solar Panels / Equipment’s (Including all accessories) from established suppliers, manufacturers, aggregators, etc.</li>
                            ...
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        ...
                                        <li>Standard KYC checks and due diligence</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Vintage: New Customer – 3 years, Existing Customer – 2 years</li>
                                        <li>2 years cash profits</li>
                                        <li>Satisfactory repayment track record</li>
                                        <li>For New Customer: Minimum IACR of 0.5% to 0.50% (if no CGTMSE cover)</li>
                                        <li>Proposed Solar rooftop capacity not to exceed connected load</li>
                                        <li>Only On-site projects</li>
                                        <li>Stand alone and Grid connected, both covered</li>
                                        <li>Maximum loan up to 25% of Net Sales</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Interest Rate- MCLR based interest rate as per internal rating</li>
                                    </ul>
                                    <p>&nbsp;</p>
                                </div>
                            </div>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Repayment up to 5 years including moratorium of 6 to 12 months</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="eligibility-inner">
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="elig-img">
                                <img src="../../products/project-image11.jpg" alt="Eligibility">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
                            <div class="prayaasContant">
                                <div class="prayaasul">
                                    <div class="title-content bold-title with-underline green">
                                        <h2>Eligibility</h2>
                                    </div>
