...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/13 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:19 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI Assistance to Export oriented MSMEs under Ubharte Sitaare Programme - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>SIDBI Assistance to Export oriented MSMEs under Ubharte Sitaare Programme</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">SIDBI Assistance to Export oriented MSMEs under Ubharte Sitaare Programme</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image8.jpg") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                <ul>
                                    <li>Term loans to Export oriented MSMEs forexpansion, modernisation, diversification, technology / capacity upgradation, product R&D, etc, by investment in Land and building, machinery and equipment, etc.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Future export champions with high potential</li>
                                        <li>Units having unique technology, products or processes</li>
                                        <li>High export potential sectors, i.e. Automobiles, Aerospace &amp; Defence, Chemicals, Food Processing, IT &amp; ITeS, Pharmaceuticals, Precision engineering, Textiles and allied sectors, etc.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Need based financial assistance, subject to maximum of 80% of the project cost.</li>
                                        <li>Joint financing with EXIM Bank available.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        ...
                                        <li>20% promoters’ contribution (30% for greenfield units)</li>
                                        <li>Facility of TL/FCTL available</li>
                                        <li>Technical Assistance for mentorship support, equity support, etc.</li>
                                        <li>Upto 25 bps performance / milestone linked interest incentive.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Interest Rate - Based on MCLR of the Bank / Repo rate, with applicable spreads (as per internal rating)</li>
                                        <li>Repayment – Generally upto 6 years (Extendable upto 10 years)</li>
                                        <li>Moratorium - Upto 2 years</li>
                                    </ul>
                                    <p>&nbsp;</p>
                                </div>
                            </div>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>New units - Promoters having sufficient experience in the proposed line of business and major projected revenue from exports. For units co-funded by technocrats from premier institutions (like IIT, IIM, IISc, NIT etc.), sufficient experience in the proposed line of business shall not beinsisted upon.</li>
                                        <li>Existing units - Fundamentally strong export oriented small and mid-sized companies with satisfactory financials.</li>
