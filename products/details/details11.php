...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/11 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:19 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI’s Term Loan To Enhance Production Of MSMES (STEP) Scheme Guidelines - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>SIDBI’s Term Loan To Enhance Production Of MSMES (STEP) Scheme Guidelines</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">SIDBI’s Term Loan To Enhance Production Of MSMES (STEP) Scheme Guidelines</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image7.jpg") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                <ul>
                                    <li>To provide medium/short term financial assistance to eligible MSMEs for augmenting NWC and / or to execute urgent confirmed orders.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>To provide medium/short term financial assistance to eligible MSMEs for augmenting NWC and / or to execute urgent confirmed order.</li>
                                        <li>Incremental working capital requirement may also be funded after satisfying about non enhancement of regular WC limit from existing lenders.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Both in rupee and foreign currency.</li>
                                        <li>Generally, upto 3 years (including moratorium upto 6 months).</li>
                                        <li>Availability of CGTMSE cover</li>
                                        <li>Simplified documentation</li>
                                        <li>Quick sanction and disbursement</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Existing MSMEs as per MSMED Act</li>
                                        <li>Minimum 3 years operations of the unit required. (2 years for Existing customer of SIDBI)</li>
                                        <li>WCTL shall be provided to only those enterprises not availing WCL / OD facility from any Banks / FIs.</li>
                                        <li>Operating profit during past 2 years ( 1 year for Existing Customers).</li>
                                        <li>Standard Scheme Norms apply (CIBIL / CMR, due diligence checks etc.)</li>
                                        <li>should not be in to any bank/FI.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Upto Rs 300 lakh for existing customers</li>
                                        <li>Upto Rs 200 lakh for New Customers</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li><b><strong>Interest Rate-</strong></b> MCLR based ROI as per internal rating.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="eligibility-inner">
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="elig-img">
                                <img src="../../products/project-image22.jpg" alt="Eligibility">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
