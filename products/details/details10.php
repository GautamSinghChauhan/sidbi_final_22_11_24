...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/10 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:49 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>BEYOND MICROFINANCE - Small Industries Development Bank of India</title>
    ...
    <header>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="../micro-finance">Micro Lending</a></li>
                        <li><a class="active" href="javascript:void(0);">BEYOND MICROFINANCE</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../project-image3.png") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                <h4>PRAYAAS-An endeavor to support small entrepreneurs at the bottom of the pyramid</h4>
                                <ul>
                                    <li>To facilitate access of credit to the clients graduating from microfinance to micro enterprise for higher ticket size loans at an affordable rate.</li>
                                    <li>Launched PRAYAAS programme in partnership with MFIs/NBFC/Others (PI) to extend loans upto ₹5 lakh to micro entrepreneurs for any livelihood activity.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>National Microfinance Congress</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>SIDBI is organizing National Microfinance Congress annually focussing on the growth and development of the Microfinance ecosystem in the country.</li>
                                        <li>Objective of the Congress is to analyze and bring to fore the emerging challenges in the mF sector and making policy advocacy recommendations to address those challenges.</li>
                                        <li>The Congress is being attended by various stakeholders of the ecosystem</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>India Microfinance Equity Fund</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Created in Union Budget 2011-12, with corpus of ₹100 crore Fund with SIDBI, which subsequently enhanced to ₹300 crore</li>
                                        <li>Primary objective to provide Equity/Quasi equity to smaller MFIs to help them maintain growth and achieve scale and efficiency in operation with focus on under-served states</li>
                                        <li>As on March 31, 2019 committed 200.25 crore to 66 MFIs.</li>
                                        <li>The portfolio and operations under IMEF, now being managed by MUDRA</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Incubation Centre</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Support to IIM, Lucknow for setting up of “SIDBI Centre for Innovation in Financial Inclusion (SCI-FI)”</li>
                                        <li>To develop new age financial products and innovative business models and spread FinTech led innovative financing models for rapid expansion of financial inclusion in India.</li>
                                        <li>To support new start-ups, thereby helping the sector in setting standards and best practices for a more responsible growth.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Digital Financial Literacy Program</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Objective: To develop participants as ‘Digital Financial Literate’ and equip them with various skills to use digital financial services and familiarizes with various government initiatives in digital finance space.</li>
                                    </ul>
                                    <p>1st phase:</p>
                                    <ul>
                                        <li>Programmes Conducted: 112</li>
                                        <li>Geographies: 07 States. 107 Micro-business Clusters</li>
                                        <li>Beneficiaries: 6500 artisans, out of which 40% were female. Around 40% women artisans are now using digital applications for financial transactions.</li>
                                    </ul>
                                    <p>2nd phase:</p>
                                    <ul>
                                        <li>Programs conducted: 25</li>
                                        <li>Geographies: Uttar Pradesh, Bihar and Odisha</li>
                                        <li>Beneficiaries: Around 1000 micro businesses, with focus on women.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
