...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/15 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:19 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Assistance to Re-energize capital Investments by SMEs (ARISE) - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Assistance to Re-energize capital Investments by SMEs (ARISE)</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">Assistance to Re-energize capital Investments by SMEs (ARISE)</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image10.jpg") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                <ul>
                                    <li>Financial assistance shall be provided to brownfield / existing entities for undertaking expansion / modernization / capital expenditure in the same line of business.</li>
                                </ul>
                                <p> </p>
                                <div class="mCSB_scrollTools mCSB_27_scrollbar mCS-light mCSB_scrollTools_vertical" style="display:none;" id="mCSB_27_scrollbar_vertical">
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_28_container" dir="ltr"><span class="block_span">Attractive RoI</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_28_container" dir="ltr"><span class="block_span">100% financing for loans upto `Rs. 5 crore, based on FD upto 25% (interest bearing)</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_28_container" dir="ltr"><span class="block_span">Quicker sanction</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_28_container" dir="ltr"><span class="block_span">Facility of TL/FCTL available</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Minimum two years of operation and audited accounts [for at least two full years]</li>
                                        <li>Cash profits in last audited financial results</li>
                                        <li>Standard Norms apply (CIBIL / CMR, due diligence checks etc.)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>MSMEs engaged in high growth and priority sectors (including sunrise sectors)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Loan Amount and Validity of Scheme</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>TL upto `700 Lakh, subject to maximum of 80% of the project cost</li>
                                        <li>Till utilisation of the corpus as allocated/decided from time to time.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Interest Rate and Repayment</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Repo Rate + 1.70 % to 3.00 % (floating) for first year with reset applicable thereafter (as per internal rating)</li>
                                        <li>Repayment – Generally upto 7 years Moratorium- Upto 2 years</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="eligibility-inner">
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="elig-img">
                                <img src="../../products/project-image8.jpg" alt="Eligibility">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
