...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/35 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:21 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>QC PRODUCT NAME - Small Industries Development Bank of India</title>
    ...
    <header>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">QC PRODUCT NAME</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image20.jpg") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                <p style="background-color:#efefef;line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                        <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Presently available for MSME, who have outstanding Term loans from SIDBI or propose to avail both TL & WC from SIDBI.</span></font>
                                    </span></p>
                                <p style="background-color:#efefef;line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                        <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Option to choose banking platform from 2-3 banks</span></font>
                                    </span></p>
                                <p style="background-color:#efefef;line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                        <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Seamless approvals as per customer instructions for setting DP etc.</span></font>
                                    </span></p>
                                <p style="background-color:#efefef;line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                        <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Single window for term loan customer to avail working capital facilities.</span></font>
                                    </span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <p style="line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                            <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Should be an eligible MSME unit.</span></font>
                                        </span></p>
                                    <p style="line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                            <font style="font-size:10pt;" size="2" face="Arial, serif"><span>SIDBI assistance shall be considered to any of the following category of customers.</span></font>
                                        </span></p>
                                    <p style="line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                            <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Existing customers who are solely banking with the Bank.</span></font>
                                        </span></p>
                                    <p style="line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                            <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Existing customers of the Bank (who are also banking with other banks).</span></font>
                                        </span></p>
                                    <p style="line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                            <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Existing well performing entities who are new to the Bank and do not enjoy working capital facility with any other bank; where term loan is considered by the Bank.</span></font>
                                        </span></p>
                                    <p style="line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                            <font style="font-size:10pt;" size="2" face="Arial, serif"><span>New entities where term loan is considered by the Bank.</span></font>
                                        </span></p>
                                    <p style="line-height:100%;margin-bottom:0.05cm;margin-top:0.18cm;"><span style="color:#181c27;">
                                            <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Takeover of working capital accounts, as a part of term loan takeover, may be considered subject to compliance of takeover guidelines.</span></font>
                                        </span></p>
                                    <p style="line-height:100%;margin-bottom:0.05cm;"><span style="color:#181c27;">
                                            <font style="font-size:10pt;" size="2" face="Arial, serif"><span>Satisfying minimum financial parameters under the scheme.</span></font>
                                        </span></p>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <p>Parameters Eligibility Norm Total outside liabilities/ tangible Networth (TOL/TNW) Not to exceed 4:1 Current Ratio 1.25 Interest Coverage Minimum 1.5 times Overall Asset Coverage 1.3 for existing units and 1.4 for new projects Internal Rating As per existing Bank’s Norms</p>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <p>Should be an eligible MSME unit. SIDBI assistance shall be considered to any of the following category of customers. Existing customers who are solely banking with the Bank. Existing customers of the Bank (who are also banking with other banks). Existing well performing entities who are new to the Bank and do not enjoy working capital facility with any other bank; where term loan is considered by the Bank. New entities where term loan is considered by the Bank. Takeover of working capital accounts, as a part of term loan takeover, may be considered subject to compliance of takeover guidelines. Satisfying minimum financial parameters under the scheme.</p>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
