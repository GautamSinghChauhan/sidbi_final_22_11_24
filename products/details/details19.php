...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/19 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI – Loan for Purchase of Equipment for Enterprise’s Development (SPEED) - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>SIDBI – Loan for Purchase of Equipment for Enterprise’s Development (SPEED)</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">SIDBI – Loan for Purchase of Equipment for Enterprise’s Development (SPEED)</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_57_container" dir="ltr"><span class="block_span">Upto 100% financing</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_57_container" dir="ltr"><span class="block_span">One-page application format</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_57_container" dir="ltr"><span class="block_span">Quick sanction and disbursement</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>MSME units with at least 3 years operations with stable sales and cash profits in immediate past 2 years.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>For New To Bank (NTB)- Machinery purchased from the OEMs with whom SIDBI has an MoU.&nbsp;<br>For Existing Customer- Any OEM</li>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Upto 100% of the machinery cost subject to maximum of ₹1 crore for New to Bank (NTB) customers and upto ₹2 crore for existing customers of SIDBI. SIDBI reserves the right to sanction lower amount depending upon assessment of repayment capacity.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Tenure and moratorium 2 to 5 years including moratorium upto 6 months. </h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>2 to 5 years including moratorium upto 6 months.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
