...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/17 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Top Up Loan for Immediate Purposes (TULIP) - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Top Up Loan for Immediate Purposes (TULIP)</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">Top Up Loan for Immediate Purposes (TULIP)</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_42_container" dir="ltr"><span class="block_span">Up-to 100% finance based on 10% FD &amp; extension of charge</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_42_container" dir="ltr"><span class="block_span">Quicker sanction within 7 days</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_42_container" dir="ltr"><span class="block_span">No additional collateral security (except SIDBI FD)</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>At least 1-year association with SIDBI with satisfactory track record</li>
                                        <li>Expansion in same line of business at same location</li>
                                        <li>Cash profit in last FY</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Purchase of machinery / equipment</li>
                                        <li>Need based civil construction/renovation</li>
                                        <li>Acquisition of DG set/other MFAs (including testing equipment, dies &amp; moulds etc.)</li>
                                        <li>Margin money for working capital (MMWC)</li>
                                        <li>To execute sudden/specific/bulk orders which are self-liquidating nature and are against a min. BBB rated counter party or a state / central government department counter party with a track record in making timely payments</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>30% of existing exposure or 20% of net sales subject to Max ₹2 Crore</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Max. 5 years (including moratorium of up to 6 months)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <p><a href="<?= SEOURL; ?>../assets/TULIP_Application%20form.docx">Application form is enclosed</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
