...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/9 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:49 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>RESPONSIBLE FINANCE INITIATIVES - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">RESPONSIBLE FINANCE INITIATIVES</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../uploads/products/project-image2.png") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                ...
                                <ul>
                                    <li>Capacity Building of MFIs  <br>Adequate and customized package of Capacity Building grant to MFIs on the basis of Annual Capacity Building Need Assessment Exercise</li>
                                    <li>Transformation Loan to Scale up and Transform   <br>Support to NGOs/ MFIs to transform from ‘non-profit’ to ‘for-profit’ i.e. Corporate Structure viz. Companies/ NBFCs. Introduced in 2004, proved one of the successful innovations by MLDD.</li>
                                    <li>Capacity Assessment Rating(CAR)   <br>CAR pioneered by SIDBI in microfinance sector got wide recognition & acceptance in microfinance sector CAR now become a pre-requisite for getting assistance from Banks/FIs</li>
                                    <li>Creation of Portfolio Risk Fund  <br>In collaboration with GoI, Portfolio Risk Fund launched to meet the security deposit requirement of the MFIs.</li>
                                    <li>Covered underserved pockets/ districts/ states (with emphasis on OBC, SC, ST, minority &women beneficiaries).</li>
                                    <li>Creation of Risk Fund  <br>Fund created out of DFID grant support to expand micro lending operations to underserved regions of the country To address the concentration risk and the issue of regional</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Lender’s forum</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Comprising key MFI Funders with a view to promoting cooperation and responsible lending practices among MFI lenders for leveraging support to MFIs across all the stakeholders.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Code of Conduct Assessment (COCA)</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>COCA, a third party independent assessment of the status of compliance of an MFI with the Common Code of Conduct.</li>
                                        <li>COCA measuresMFI’s adherence to ethical and sound lending practices Developed, piloted and rolled out Harmonised COCA Tool (HCT). HCT of 36 MFIs have been hosted on SIDBI’s website.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>India Microfinance Platform (IMFP)</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>A MIX market database – meant to provide &amp; disseminate valuable information on Indian MFIs.</li>
                                        <li>MFIs submit financial and operational data, at periodic intervals-enabling transparency</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-3 col-sm-12">
                            <ul class="list-unstyled footerNav">
                                ...
                                <li><a href="https://retbs.SIDBI.in/RetireePortal" target="_blank">Retiree Portal</a></li>
                            </ul>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(".registrationandDownloaddoc").click(function() {
            ...
            $('#frmuserdownloads').append("<input type='hidden' name='documentfile' id='documentfile_name' value='" + $(this).attr("data-documentfile") + "' />");
            $('#frmuserdownloads').append("<input type='hidden' name='documentmodulename' id='documentfile_modulename' value='" + $(this).attr("data-modulename") + "' />");
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xl-8">
                    ...
                    <p class="text-white mb-0">Copyright © 2023 Small Industries Development Bank of India(SIDBI). All rights reserved</p>
                </div>
