...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/14 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:19 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI Thematic Assistance for Purchase of capital Assets in New Enterprises (STHAPAN) - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>SIDBI Thematic Assistance for Purchase of capital Assets in New Enterprises (STHAPAN)</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">SIDBI Thematic Assistance for Purchase of capital Assets in New Enterprises (STHAPAN)</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image9.jpg") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                ...
                                <ul>
                                    <li>Financial assistance to Greenfield Units for setting up new units which includes:</li>
                                    <li>purchase of land,</li>
                                    <li>construction of factory building,</li>
                                    <li>purchase of equipment, plant & MFA etc.</li>
                                </ul>
                                <p> </p>
                            </div>
                        </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" dir="ltr" id="mCSB_22_container"><span class="block_span">Attractive RoI</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" dir="ltr" id="mCSB_22_container"><span class="block_span">Quicker sanction</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>New Entities or Greenfield units are eligible</li>
                                        <li>Promoters should have prior experience of 5 years in business for loans above Rs. 5 crore. For loans upto Rs. 5 crore under the scheme, the promoters of the new entity should have prior business experience of 3 years in manufacturing activity</li>
                                        <li>Promoters Contribution – Minimum 25% Standard Norms apply (CIBIL / CMR, due diligence checks etc.)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>MSMEs setting up units in identified sectors under Production Linked Incentive Scheme (as per the list identified by GoI), high growth / sunrise sectors and other important sectors</li>
                                    </ul>
                                    <p>&nbsp;</p>
                                </div>
                            </div>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>TL upto `2000 Lakh, subject to maximum of 75% of the project cost</li>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Repo Rate + 2.20% to 3.50% (floating) for first year with reset applicable thereafter (as per internal rating)</li>
                                        <li>Repayment – Generally upto 7 years</li>
                ...
                <div class="eligibility-inner">
                    <div class="row">
                        <div class="col-md-12 col-lg-6">
                            <div class="elig-img">
                                <img src="../../products/project-image9.jpg" alt="Eligibility">
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6">
