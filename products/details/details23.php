...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/23 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>SIDBI Make in India Soft Loan Fund for Micro Small and Medium Enterprises (SMILE) - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>SIDBI Make in India Soft Loan Fund for Micro Small and Medium Enterprises (SMILE)</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">SIDBI Make in India Soft Loan Fund for Micro Small and Medium Enterprises (SMILE)</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image18.jpg") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                <div class="center-block-sec center-block-sec-2 center-block-sec-3 content mCustomScrollbar _mCS_80 mCS_no_scrollbar" style="height:280px;">
                                    <div class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" id="mCSB_80" tabindex="0">
                                        <div class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_80_container" dir="ltr">
                                            <p> </p>
                                            <ul>
                                                <li>Competitive interest rates.</li>
                                                <li>Funding of part Promoter contribution by way of soft loans.</li>
                                                <li>Longer repayment period.</li>
                                                <li>Quick dispensation</li>
                                            </ul>
                                            <p> </p>
                                        </div>
                                        <div class="mCSB_scrollTools mCSB_80_scrollbar mCS-light mCSB_scrollTools_vertical" style="display:none;" id="mCSB_80_scrollbar_vertical">
                ...
                <div class="row">
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_81_container" dir="ltr"><span class="block_span">Emphasis will be on covering new enterprises in the manufacturing as well as services sector.</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_81_container" dir="ltr"><span class="block_span">The emphasis will however, be on financing smaller enterprises within MSME.</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_81_container" dir="ltr"><span class="block_span">Existing enterprises undertaking expansion, to take advantage of new emerging opportunities, as also undertaking modernization, technology upgradation or other projects for growing their business will also be covered.</span></li>
                                        <li class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_81_container" dir="ltr"><span class="block_span">Minimum Loan Size - ₹ 10 lakh for Equipment Finance &amp; Others : ₹ 25 lakh.</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Tenure and moratorium </h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li>Longer repayment period upto 10 years including moratorium of upto 36 months.</li>
                                        <li>Minimum Promoter Contribution of 15% subject to Maximum DER of 3:1</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <p>Term Loan</p>
                                    <ul>
                                        <li>First charge over all assets created under the project.</li>
                                        <li>Personal guarantee of promoter(s).</li>
                                        <li>Cases involving term loan up to ₹ 2 crore may be covered under Credit Guarantee Scheme of CGTMSE.</li>
                                    </ul>
                                    <p>ACR and FACR norms would be applicable in terms of extant Loan Policy.&nbsp;<br>Soft Loan</p>
                                    <ul>
                                        <li>Residual charge over the entire assets</li>
                                        <li>Personal Guarantee of the Promoter(s).</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li><a href="<?= SEOURL; ?>../assets/front/pdf/Annexure_Common%20Loan%20Application%20form%20with%20formats%20I%20II%20and%20III-English.docx">Annexure_Common Loan Application form with formats I, II and III</a></li>
                                    </ul>
                                    <p>&nbsp;</p>
                                </div>
                            </div>
...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/23 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:21 GMT -->
