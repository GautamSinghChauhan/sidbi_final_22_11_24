...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/22 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Loans Under Partnership with OEM - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Loans Under Partnership with OEM</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">Loans Under Partnership with OEM</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image17.jpg") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                <div class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_73_container" dir="ltr">
                                    <p> </p>
                                    <ul>
                                        <li>One stop solution for MSMEs purchasing machines from OEMs.</li>
                                        <li>Financial tie ups arranged at the time of placing of order with OEMs.</li>
                                        <li>Simple Credit dispensation.</li>
                                        <li>Quick disbursal under CGTMSE cover is proposed to be taken by MSME.</li>
                                    </ul>
                                    <p> </p>
                                </div>
                            </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>MSME entities should be in existence for at least 3 years having satisfactory financial position.&nbsp;</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Investment in Plant &amp; Machinery purchased from respective OEMs.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Generally, upto ₹ 100.00 Lakh. Higher loan amount can also be considered subject to Bank’s guidelines.&nbsp;</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Normally upto 60 months including eligible moratorium.&nbsp;</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <p><a href="<?= SEOURL; ?>../assets/front/pdf/Annexure_Common%20Loan%20Application%20form%20with%20formats_I_II_III-English.docx">COMMON LOAN APPLICATION FORM FOR ASSISTANCE UPTO 300 LAKH</a></p>
                                    <p>&nbsp;</p>
                                </div>
                            </div>
                        </div>
