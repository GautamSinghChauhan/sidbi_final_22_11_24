...
<!-- Mirrored from SIDBInew.php-staging.com/products/details/21 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Nov 2023 07:28:20 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>Working Capital (Cash Credit) - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <header>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Working Capital (Cash Credit)</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="javascript:void(0);">Working Capital (Cash Credit)</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image16.jpg") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                <div class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="left:0;position:relative;top:0;" id="mCSB_70_container" dir="ltr">
                                    <p> </p>
                                    <ul>
                                        <li>Presently available for MSME, who have outstanding Term loans from SIDBI or propose to avail both TL & WC from SIDBI.</li>
                                        <li>Option to choose banking platform from 2-3 banks</li>
                                        <li>Seamless approvals as per customer instructions for setting DP etc.</li>
                                        <li>Single window for term loan customer to avail working capital facilities.</li>
                                    </ul>
                                    <p> </p>
                                </div>
                            </div>
                    ...
                    <div class="associate">
                        <div class="professors">
                            <div class="key-features-inner">
                                <div class="title-content bold-title with-underline green">
                                    <h2>Eligibility parameters</h2>
                                </div>
                                <div class="features-ul">
                                    <ul>
                                        <li class="mCSB_container" style="left:0px;position:relative;top:0px;" id="mCSB_71_container" dir="ltr"><span class="block_span">Should be an eligible MSME unit.</span></li>
                                        <li class="mCSB_container" style="left:0px;position:relative;top:0px;" id="mCSB_71_container" dir="ltr"><span class="block_span">SIDBI assistance shall be considered to any of the following category of customers.</span></li>
                                        <li class="mCSB_container" style="left:0px;position:relative;top:0px;" id="mCSB_71_container" dir="ltr"><span class="block_span">Existing customers who are solely banking with the Bank.</span></li>
                                        <li class="mCSB_container" style="left:0px;position:relative;top:0px;" id="mCSB_71_container" dir="ltr"><span class="block_span">Existing customers of the Bank (who are also banking with other banks).</span></li>
                                        <li class="mCSB_container" style="left:0px;position:relative;top:0px;" id="mCSB_71_container" dir="ltr"><span class="block_span">Existing well performing entities who are new to the Bank and do not enjoy working capital facility with any other bank; where term loan is considered by the Bank.</span></li>
                                        <li class="mCSB_container" style="left:0px;position:relative;top:0px;" id="mCSB_71_container" dir="ltr"><span class="block_span">New entities where term loan is considered by the Bank.</span></li>
                                        <li class="mCSB_container" style="left:0px;position:relative;top:0px;" id="mCSB_71_container" dir="ltr"><span class="block_span">Takeover of working capital accounts, as a part of term loan takeover, may be considered subject to compliance of takeover guidelines.</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <p>Satisfying minimum financial parameters under the scheme.</p>
                                    <figure class="table">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td>Parameters</td>
                                                    <td>Eligibility Norm</td>
                                                </tr>
                                                <tr>
                                                    <td>Total outside liabilities/ tangible Networth (TOL/TNW)</td>
                                                    <td>Not to exceed 4:1</td>
                                                </tr>
                                                <tr>
                                                    <td>Current Ratio</td>
                                                    <td>1.25</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Minimum 1.5 times</td>
                                                </tr>
                                                <tr>
                                                    <td>Overall Asset Coverage</td>
                                                    <td>1.3 for existing units and 1.4 for new projects</td>
                                                </tr>
                                                <tr>
                                                    <td>Internal Rating</td>
                                                    <td>As per existing Bank’s Norms</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </figure>
