    ...
    <header>
        ...
        <section class="key-points-sec">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="points-text mb-4" style='background: url("../../products/project-image1.png") no-repeat center center / cover;'>
                            ...
                            <div class="key-ul customScrollNew2">
                                ...
                                <p><b><strong>Mission:</strong></b> To create a national network of strong, viable and sustainable Microfinance Institutions (MFIs) for providing microfinance services to the economically disadvantaged people, especially women. <br><b><strong>Approach:</strong></b>Complete Range of Financial and Non-Financial Services- <b><strong>Financial Support to MFIs-</strong></b></p>
                                <ul>
                                    <li>Loan</li>
                    ...
                    <div class="associate">
                            ...
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        ...
                                        <li>SC/ST/ backward classes accounting for approx. 73% of the total beneficiaries.</li>
                                        <li>Women proportion was 96-98% among the beneficiaries.</li>
                                        <li>Brought out changes in the livelihood pattern by giving impetus to enterprise activity</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Launched in April 2000 under collaboration with Department for International Development (DFID), UK to bring in best microfinance practices in India. Collaboration was made with International Fund for Agricultural Development (IFAD), Rome in April-2002 for on lending support to MFIs.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li>Out of10 entities having received the SFB license from RBI, eight were partner MFIs of SIDBI</li>
                                        <li>Need based interventions to facilitate smooth transition from MFI to SFBs.</li>
                        ...
                        <div class="professors">
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        <li><a href="<?= SEOURL; ?>../assets/Micro%20Credit%20Operation.docx">For details, please click here</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="key-features-inner">
                                ...
                                <div class="features-ul">
                                    <ul>
                                        ...
                                        <li><a href="https://SIDBI.in/impact-assessment-studies">Impact Assessment Studies</a></li>
                                        <li>SIDBI’s Coffee Table Book You Tube Link:<a href="https://www.youtube.com/watch?v=UJZ-ongFhKQ&amp;t=32s">https://www.youtube.com/watch?v=UJZ-ongFhKQ&amp;t=32s</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
