...
<head>
    ...
    <title>Organization Chart - Small Industries Development Bank of India</title>
    ...
    <style>
        /* .Subsidiaries{
            border-bottom:3px solid #3fa253;
...
?>
        ...
        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `organizationchart_ID`, `organizationchart_title`, `organizationchart_title_hindi`, `organizationchart_content`, `organizationchart_content_hindi`, `status` FROM `organizationchart` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $organizationchart_content = html_entity_decode($row["organizationchart_content"]);
                                        $organizationchart_content_hindi = html_entity_decode($row["organizationchart_content_hindi"]);
                                    ?>
                    
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo $organizationchart_content_hindi;
                                                else:
                                                 echo $organizationchart_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698734954.4985" value="yM9r6q9x91f3SUzOzptzsaN270i9NJwElijzP+yY0v74yyR/exn3x1Coxcan4oftVxzIEuTcQzSHr6dVn5pNOQ==" />
                            </div>
                            <div class="row">
