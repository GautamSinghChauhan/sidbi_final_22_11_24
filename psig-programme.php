...
<head>
    ...
    <title>PSIG Programme - Small Industries Development Bank of India</title>
...
?>
        ...
        <div class="cms PSIGProgramme">
            <section class="SIDBIWrap">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="title-content bold-title with-underline green">
                                ...
                                <p><?php  if($get_configured_lang == 'HI'): 
                                    ...
                                    बैंक के P&D वर्टिकल के अंतर्गत लॉन्च किया गया है।
                                                 ...
                                                 echo 'SIDBI has been implementing the “Poorest States Inclusive Growth (PSIG) Program”
                                                 funded by UK Government through the Department for International Development (DFID),
                                                 UK since April 2012. The program aimed at enhancing income and employment
                                                 opportunities of the poor, especially women, in four poorest States of Bihar, MP,
                                                 Odisha and UP by enabling the target group to participate and benefit from wider
                                                 economic opportunities and growth. The program has come to a successful end in March
                                                 2020. To take the PSIG legacy forward, Swavalamban Resource Facility (SRF) has since
                                                 been launched within the P&D Vertical of the Bank.';
                                                endif; ?></p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="SIDBIGrid">
                                <div class="SIDBIgridInner" data-aos="zoom-in">
                                    <div class="SIDBIBox-anchor-div"><a href="about-psig"> </a></div>
                                    <div class="SIDBIBox">
                                        <p><img src="<?= SEOURL; ?>assets/front/images/icon-about-psig.png"></p>
                                        <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                ...
                                <div class="SIDBIgridInner" data-aos="zoom-in">
                                    <div class="SIDBIBox-anchor-div"><a href="key-outputs-activities"> </a></div>
                                    <div class="SIDBIBox">
                                        <p><img src="<?= SEOURL; ?>assets/front/images/icon-key-outputs-activities.png"></p>
                                        <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                                 मुख्य आउटपुट/गतिविधियाँ
                                                 ';
                                                else:
                                                 echo 'Key Outputs/Activities';
                                                endif; ?></p>
                                    </div>
                                </div>
                                <div class="SIDBIgridInner" data-aos="zoom-in">
                                    <div class="SIDBIBox-anchor-div"><a href="policy-advocacy-initiatives"> </a>
                                    </div>
                                    <div class="SIDBIBox">
                                        <p><img src="<?= SEOURL; ?>assets/front/images/icon-policy-adovcacy.png"></p>
                                        <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                                 नीति वकालत पहल
                                                 ';
                                                else:
                                                 echo 'Policy Advocacy Initiatives';
                                                endif; ?></p>
                                    </div>
                                </div>
                                <div class="SIDBIgridInner" data-aos="zoom-in">
                                    <div class="SIDBIBox-anchor-div"><a href="financial-inclusion-and-institution-building-initiatives"> </a>
                                    </div>
                                    <div class="SIDBIBox">
                                        <p><img src="<?= SEOURL; ?>assets/front/images/icon-finance-lncusion-n-initiative.png"></p>
                                        <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                                 वित्तीय समावेशन और संस्थान निर्माण पहल
                                                 ';
                                                else:
                                                 echo 'Financial Inclusion and Institution Building Initiatives';
                                                endif; ?></p>
                                    </div>
                                </div>
                                <div class="SIDBIgridInner" data-aos="zoom-in">
                                    <div class="SIDBIBox-anchor-div"><a href="gender-and-financial-literacy-initiatives"> </a></div>
                                    <div class="SIDBIBox">
                                        <p><img src="<?= SEOURL; ?>assets/front/images/icon-gender-n-financial-literacy.png"></p>
                                        <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                                 लिंग और वित्तीय साक्षरता पहल
                                                 ';
                                                else:
                                                 echo 'Gender and Financial Literacy Initiatives';
                                                endif; ?></p>
                                    </div>
                                </div>
                                <div class="SIDBIgridInner" data-aos="zoom-in">
                                    <div class="SIDBIBox-anchor-div"><a href="other-initiatives"> </a></div>
                                    <div class="SIDBIBox">
                                        <p><img src="<?= SEOURL; ?>assets/front/images/icon-other-initiatives.png"></p>
                                        <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                                 अन्य पहल
                                                 ';
                                                else:
                                                 echo 'Other Initiatives';
                                                endif; ?></p>
                                    </div>
                                </div>
                                <div class="SIDBIgridInner" data-aos="zoom-in">
                                    <div class="SIDBIBox-anchor-div"><a href="list-of-partners"> </a></div>
                                    <div class="SIDBIBox">
                                        <p><img src="<?= SEOURL; ?>assets/front/images/icon-list-of-partner.png"></p>
                                        <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                                 साझेदारों की सूची
                                                 ';
                                ...
                                <div class="SIDBIgridInner" data-aos="zoom-in">
                                    <div class="SIDBIBox-anchor-div"><a href="psig-contact-us"> </a></div>
                                    <div class="SIDBIBox">
                                        <p><img src="<?= SEOURL; ?>assets/front/images/icon-contact-us.png"></p>
                                        <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo '
                                                 संपर्क करें
                                                 ';
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698734978.8108" value="AbWlI9Fj6kIZCR32sJb5la6ggBP1qa4139pDdy1E5vYxseq2BQvq0r7olP7Z7w3JWsqnSaxBcQXOXRcdXkZ5MQ==" />
                            </div>
                            <div class="row">
