...
<head>
    ...
    <title>Financial Inclusion and Institution Building Initiatives - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
            ...
            <div class="container">
                <div class="inner">
                    <h1><?php  if($get_configured_lang == 'HI'): 
                                                 echo   'वित्तीय समावेशन और संस्थान निर्माण पहल';
                                                else:
        ...
        <div class="cms FinancialInclusionandInstitutionBuildingInitiatives">
            <div class="container">
                <?php
            $list_transaction = sqlQUERY_LABEL("SELECT `psigfinance_ID`, `psigfinance_title`, `psigfinance_title_hindi`, `psigfinance_content`, `psigfinance_content_hindi`, `status` FROM `psigfinance` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $psigfinance_content = html_entity_decode($row["psigfinance_content"]);
                                        $psigfinance_content_hindi = html_entity_decode($row["psigfinance_content_hindi"]);
                                    ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                            <h2><?php  if($get_configured_lang == 'HI'): 
                                                 echo   $psigfinance_title_hindi;
                                                else:
                                                 echo   $psigfinance_title;
                                                endif; ?></h2>
                            <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo   $psigfinance_content_hindi;
                                                else:
                                                 echo   $psigfinance_content;
                                                endif; ?></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698736162.6628" value="2XdFwG3WlfIIweEwFU4NwoeHaoZWKr6gAqJw8BNhEhLpcwpVub6VYq8gaDh8N/mec+1N3A/CYZATJSSaYGON1Q==" /></div>
                            <div class="row">
