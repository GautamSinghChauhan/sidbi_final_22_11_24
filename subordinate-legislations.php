...
<head>
    ...
    <title>Subordinate Legislations - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Subordinate Legislations</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Subordinate Legislations</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <div class="cms SubordinateLegislations">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont">
                            <h2>Subordinate Legislations</h2>
                            <p>Subordinate Legislations</p>
                            <p><br><br> </p>
                            <figure class="table">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th class="text-center" width="65px">Sr. No.</th>
                                            <th>Gazette Notification Date</th>
                                            <th>Description</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <th>1.</th>
                                            <th>09/12/2019</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/SIDBI-Staff-Regulations-2001-AMENDED-English-Final.pdf" target="_blank" title="View">SIDBI Staff Regulations, 2001 <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>2.</th>
                                            <th>01/06/2011</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/GazetteNotification_2011.PDF" target="_blank" title="View">Small Industries Development Bank of India (Employees’ Provident Fund) [Amendment] Regulations, 2011 <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>3.</th>
                                            <th>16/11/2010</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/Annexure-I---Gazette-Notification---Gratuity-Amendment-Regulations-2010.PDF" target="_blank" title="View">SIDBI (Payment of Gratuity to Employees) [Amendment] Regulations, 2010 <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>4.</th>
                                            <th>20/07/2006</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/sidbi_bond1.pdf" target="_blank" title="View">SIDBI (Issue and Management of Bonds) Regulations, 1990 <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>5.</th>
                                            <th>02/07/2004</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/SIDBI_Act.pdf" target="_blank" title="View">Small Industries Development Bank of India Act, 1989. <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>6.</th>
                                            <th>09/03/2004</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/sidbi_PF.pdf" target="_blank" title="View">SIDBI (Employees' Provident Fund) Regulations, 1990 as amended by SIDBI [Employees' Provident Fund] (Amendment) Regulations, 2004 <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>7.</th>
                                            <th>26/07/2003</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/SIDBI_appeal.pdf" target="_blank" title="View">SIDBI (Appeal to the Central Government) Rules, 2003 <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>8.</th>
                                            <th>14/05/2003</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/sidbi_gratuity.pdf" target="_blank" title="View">SIDBI Gratuity (Amendment) Regulations, 2003 <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>9.</th>
                                            <th>17/07/2002</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/sidbi_pension.pdf" target="_blank" title="View">SIDBI Pension Regulations, 2002 <span></span></a></th>
                                        </tr>
                                        <tr>
                                            <th>10.</th>
                                            <th>13/11/2000</th>
                                            <th><a href="<?= SEOURL; ?>uploads/coca_reports/SIDBI_GR.pdf" target="_blank" title="View">General Regulations, 2000 <span></span></a></th>
                                        </tr>
                                    </tbody>
                                </table>
                            </figure>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698781163.8679" value="KhRndXpX6X7zloalglIoFykGiC9M8YuVq401elpeT5/8vdZQWnv3i0Cp5B9/+CnH9khMwyh9nURwArUglHnO+g==" /></div>
                            <div class="row">
