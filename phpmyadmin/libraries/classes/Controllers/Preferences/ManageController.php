    ...
    public function __invoke(): void
    {
        ...
        if (isset($_POST['submit_import'])) {
            ...
            if (! is_array($configuration)) {
                ...
                if ($result === true) {
                    if ($return_url) {
                        ...
                        $return_url = 'index?route=/preferences/manage';
                    }
            ...
            if ($result === true) {
                ...
                $this->userPreferences->redirect('index?route=/preferences/manage', $params);
        ...
        echo $this->template->render('preferences/manage/main', [
            ...
            'exists_setup_and_not_exists_config' => @file_exists(ROOT_PATH . 'setup/index')
