...
const EditUserGroup = {
    ...
    handleEvent: function (event) {
        ...
        $.get(
            'index?route=/server/user-groups/edit-form',
            {
                'username': username,
...
const AccountLocking = {
    handleEvent: function () {
        ...
        const url = isLocked
            ? 'index?route=/server/privileges/account-unlock'
            : 'index?route=/server/privileges/account-lock';
        const params = {
