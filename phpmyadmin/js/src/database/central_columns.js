...
AJAX.registerOnload('database/central_columns.js', function () {
    ...
    $('#tableslistcontainer').find('button[name="edit_central_columns"]').on('click', function (event) {
        ...
        Functions.ajaxShowMessage();
        AJAX.source = $(this);
        $.post('index?route=/database/central-columns', editColumnData, AJAX.responseHandler);
    });
    $('#multi_edit_central_columns').on('submit', function (event) {
        ...
        Functions.ajaxShowMessage();
        AJAX.source = $(this);
        $.post('index?route=/database/central-columns', multiColumnEditData, AJAX.responseHandler);
    });
    ...
    $('.edit_save_form').on('click', function (event) {
        ...
        $.ajax({
            type: 'POST',
            url: 'index?route=/database/central-columns',
    ...
    $('#table-select').on('change', function () {
        ...
        var href = 'index?route=/database/central-columns/populate';
        var params = {
            'ajax_request' : true,
