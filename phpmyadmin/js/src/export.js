...
Export.createTemplate = function (name) {
    ...
    $.post('index?route=/export/template/create', params, function (response) {
...
Export.loadTemplate = function (id) {
    ...
    Functions.ajaxShowMessage();
    $.post('index?route=/export/template/load', params, function (response) {
        if (response.success === true) {
            var $form = $('form[name="dump"]');
...
Export.updateTemplate = function (id) {
    ...
    Functions.ajaxShowMessage();
    $.post('index?route=/export/template/update', params, function (response) {
        if (response.success === true) {
...
Export.deleteTemplate = function (id) {
    ...
    Functions.ajaxShowMessage();
    $.post('index?route=/export/template/delete', params, function (response) {
        if (response.success === true) {
...
Export.checkTimeOut = function (timeLimit) {
    ...
    timeOut = setTimeout(function () {
        $.get('index?route=/export/check-time-out', { 'ajax_request': true }, function (data) {
...
Export.createAliasModal = function (event) {
    ...
    modal.on('shown.bs.modal', function () {
        ...
        if (db) {
            ...
            $.post('index?route=/databases', params, function (response) {
                if (response.success === true) {
