...
AJAX.registerOnload('server/status/monitor.js', function () {
  ...
  $('a[href="#monitorInstructionsDialog"]').on('click', function (event) {
    ...
    var loadLogVars = function (getvars) {
      ...
      $.post('index?route=/server/status/monitor/log-vars', vars, function (data) {
        var logVars;
  ...
  function refreshChartGrid() {
    /* Send to server */
    runtime.refreshRequest = $.post('index?route=/server/status/monitor/chart', {
      'ajax_request': true,
  ...
  function loadLogStatistics(opts) {
    ...
    var url = 'index?route=/server/status/monitor/slow-log';
    if (opts.src === 'general') {
      url = 'index?route=/server/status/monitor/general-log';
    }
    logRequest = $.post(url, {
      'ajax_request': true,
  ...
  function loadQueryAnalysis(rowData) {
    ...
    $.post('index?route=/server/status/monitor/query', {
      'ajax_request': true,
