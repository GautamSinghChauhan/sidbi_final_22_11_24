...
Navigation.loadChildNodes = function (isNode, $expandElem, callback) {
  ...
  $.post('index?route=/navigation&ajax_request=1', params, function (data) {
...
Navigation.treePagination = function ($this) {
  ...
  var url = 'index?route=/navigation';
...
Navigation.FastFilter.Filter.prototype.request = function () {
  ...
  self.xhr = $.ajax({
    url: 'index?route=/navigation&ajax_request=1&server=' + CommonParams.get('server'),
    type: 'post',
    dataType: 'json',
    data: params,
