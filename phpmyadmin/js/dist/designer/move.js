...
DesignerMove.loadPage = function (page) {
  if (designerTablesEnabled) {
    ...
    $('<a href="index?route=/database/designer&server=' + server + argsep + 'db=' + encodeURIComponent(db) + paramPage + '"></a>').appendTo($('#page_content')).trigger('click');
  } else {
    if (page === null) {
