...
var ErrorReport = {
  ...
  errorDataHandler: function (data, exception) {
    ...
    if (data.report_setting === 'ask') {
      ...
      $.post('index?route=/error-report', postData, function (data) {
  ...
  showReportDialog: function (exception) {
    ...
    $.post('index?route=/error-report', reportData).done(function (data) {
  ...
  showErrorNotification: function () {
    ...
    buttonHtml += '</button>';
    var settingsUrl = 'index?route=/preferences/features&server=' + CommonParams.get('server');
