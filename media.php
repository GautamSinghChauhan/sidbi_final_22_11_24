...
<head>
    ...
    .success-card {
        ...
        border: 2px solid #d2df43 !important;
...
?>
        ...
        <section class="clarifications text-center" id="clarifications">
            ...
            <div class="button-1 green-btn">
                <a href="press-release.php" target="_blank">view all<i class="fa fa-angle-right"></i></a>
            </div>
        </section>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide swiper-slider-social-media">
                                        <div class="twitter-feed">
                                            <a href="https://twitter.com/sidbiofficial?ref_src=twsrc%5Etfw"
                                                target="_blank">
                                                <img class="customWidthSlider"
                                                    src="<?= SEOURL; ?>assets/front/images/twitter-image.jpg"
                                                    alt="Twitter Feeds" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide swiper-slider-social-media">
                                        <div class="linkedin-feed">
                                            <a href="https://www.linkedin.com/company/SIDBI-small-industries-development-bank-of-india"
                                                target="_blank">
                                                <img class="customWidthSlider"
                                                    src="<?= SEOURL; ?>assets/front/images/linkedin-image.jpg"
                                                    alt="Linked In Feeds" />
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="card success-card">
                            <div class="card-head">
                                <a target="_blank" href="<?= $videos_link ?>" class="playvideo">
                                    ...
                                    <p class="videoTextSection text-center mt-2"><?= $videos_title ?>
                                    </p>
                                </a>
                            </div>
                        </div>
                ...
                <div class="item row">
                    ...
                    <?php
                        ...
                        <div class="card h-100">
                                ...
                                <img src="assets/front/home/<?= $galleries_image ?>" class="img-fluid">
                                <p class="success-p p-3"><?= $galleries_content ?>
                                </p>
                            </div>
                        </div>
                        </div>
