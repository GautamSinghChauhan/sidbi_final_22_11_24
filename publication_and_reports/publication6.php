...
<body class="main-wrapper-en">
    ...
    <?php
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Quarterly/Half-yearly Results</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="../publication-and-reports.html">Publications & Reports</a></li>
                        <li><a class="active" href="7.php">Quarterly/Half-yearly Results</a></li>
                    </ul>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>Quarterly/Half-yearly Results</h2>
                        </div>
                        <div class="button-form">
                            ...
                            <div class="search-form">
                                <form method="post" accept-charset="utf-8" id="search_form" name="search_form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    <div style="display:none;"><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780658.7465" value="CGE9rmGjBtU9ST4eIfwN6Jgl4IS296Q4grLVuxOLXLveyIyLQY8YII52XKTcVgw4R2skaNJ7sulZPVXh3azd3g==" /></div> <input type="hidden" name="task" value="search">
                ...
                <div class="row border border-success mb-2">
                    <div class="col-md-12 px-0 text-center" style="background-color: #021731;">
                        <h3>Quarterly/Half-yearly Results</h3>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Publication Reports 26.04</a></td>
                                    <td style="text-align: center;">
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_194_6_index"><i class="fa fa-cloud-download"></i></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780658.7504" value="CGE9rmGjBtU9ST4eIfwN6Jgl4IS296Q4grLVuxOLXLveyIyLQY8YII52XKTcVgw4R2skaNJ7sulZPVXh3azd3g==" /></div>
                            <div class="row">
