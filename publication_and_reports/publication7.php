...
<head>
    ...
    <title>Details of Publication Reports - Small Industries Development Bank of India</title>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="<?= SEOURL; ?>publication-and-reports.html">Publications & Reports</a></li>
                        <li><a class="active" href="7.php">Corporate Governance</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <section class="careers publication-and-reports">
            <div class="container">
                <div class="inner">
                    <div class="title-content-button">
                        ...
                        <div class="button-form">
                            <div class="button-1 green-btn text-center mb-2">
                                <a href="archived/7.php">View Archived<i class="fa fa-angle-right"></i></a>
                            </div>
                            <div class="search-form">
                                <form method="post" accept-charset="utf-8" id="search_form" name="search_form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    <div style="display:none;"><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780666.8589" value="6HabiQOy0Xk4q0rJ3iMqYxICVwZfe0LIHZCswTcJQzI+3yqsI57PjIuUKHMjiSuzzUyT6jv3VBnGHyyb+S7CVw==" /></div> <input type="hidden" name="task" value="search">
                ...
                <div class="row border border-success mb-2">
                    <div class="col-md-12 px-0 text-center" style="background-color: #021731;">
                    ...
                    <div class="col-md-12 px-0">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th width="75px" scope="col" style="text-align: center;">Sr No</th>
                                    <th scope="col">Report Name</th>
                                    <th width="100px" scope="col" style="text-align: center;">Download</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <th style="text-align: center;" scope="row">1</th>
                                    <td>Policy on materiality of related party transactions and on dealing with related party transactions</a></td>
                                </tr>
                                <tr>
                                    <th style="text-align: center;" scope="row">2</th>
                                    <td>Policy for determining Material Subsidiaries</a></td>
                                </tr>
                                <tr>
                                    <th style="text-align: center;" scope="row">3</th>
                                    <td>Vigil Mechanism and Whistle Blower Policy</a></td>
                                </tr>
                                <tr>
                                    <th style="text-align: center;" scope="row">4</th>
                                    <td>Code of Conduct for Directors and Senior Management</a></td>
                                </tr>
                                <tr>
                                    <th style="text-align: center;" scope="row">5</th>
                                    <td>Marginal Cost Of Funds Based Lending Rate (MCLR)</a></td>
                                    <td style="text-align: center;">
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_176_7_index"><i class="fa fa-cloud-download"></i></a>
                                        <!--<a href="/uploads/publication_reports/" target="_blank" title=""><i class="fa fa-cloud-download"></i></a>-->
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>KYC policy</a></td>
                                    <td style="text-align: center;">
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_89_7_index"><i class="fa fa-cloud-download"></i></a>
                                        <!--<a href="/uploads/publication_reports/" target="_blank" title=""><i class="fa fa-cloud-download"></i></a>-->
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center;" scope="row">7</th>
                                    <td>FAQs on LIBOR Transition</a></td>
                                    <td style="text-align: center;">
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_185_7_index"><i class="fa fa-cloud-download"></i></a>
                                        <!--<a href="/uploads/publication_reports/" target="_blank" title=""><i class="fa fa-cloud-download"></i></a>-->
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center;" scope="row">8</th>
                                    <td>Fair Practices Code</a></td>
                                    <td style="text-align: center;">
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_136_7_index"><i class="fa fa-cloud-download"></i></a>
                                        <!--<a href="/uploads/publication_reports/" target="_blank" title=""><i class="fa fa-cloud-download"></i></a>-->
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center;" scope="row">9</th>
                                    <td>Code of SIDBI’s Commitment to MSMEs</a></td>
                                    <td style="text-align: center;">
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_93_7_index"><i class="fa fa-cloud-download"></i></a>
                                        <!--<a href="/uploads/publication_reports/" target="_blank" title=""><i class="fa fa-cloud-download"></i></a>-->
                                    </td>
                                </tr>
                                <tr>
                                    <th style="text-align: center;" scope="row">10</th>
                                    <td>Customer Grievance Redressal Policy</a></td>
                                    <td style="text-align: center;">
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_91_7_index"><i class="fa fa-cloud-download"></i></a>
                                        <!--<a href="/uploads/publication_reports/" target="_blank" title=""><i class="fa fa-cloud-download"></i></a>-->
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <div class="pagination">
                            <div class="input-group align-items-center justify-content-center">
                                ...
                                <div class="input-group-append ml-1">
                                    <button title="Goto Next Page" class="btn" onclick="gotopage(2);" type="button"><i class="fa fa-angle-right" aria-hidden="true"></i></button>
                                </div>
                                <div class="input-group-append ml-1">
                                    <button title="Goto Last Page" class="btn" onclick="gotopage(2);" type="button"><i class="fa fa-angle-double-right" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780666.8634" value="6HabiQOy0Xk4q0rJ3iMqYxICVwZfe0LIHZCswTcJQzI+3yqsI57PjIuUKHMjiSuzzUyT6jv3VBnGHyyb+S7CVw==" /></div>
                            <div class="row">
