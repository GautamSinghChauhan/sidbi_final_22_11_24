            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="pubblication2.php">MSME Knowledge Kit</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>MSME Knowledge Kit</h2>
                        </div>
                        <div class="button-form">
                            <div class="button-1 green-btn text-center mb-2">
                                <a href="archived/2.php">View Archived<i class="fa fa-angle-right"></i></a>
                            </div>
                            <div class="search-form">
                                <form method="post" accept-charset="utf-8" id="search_form" name="search_form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    <div style="display:none;"><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780620.9433" value="TEG2XLgNWw3AjHItvYxy5bZQzTbdBeeERvyl/oMFHmOa6Ad5mCFF+HOzEJdAJnM1aR4J2rmJ8VWdcyWkTSKfBg==" /></div> <input type="hidden" name="task" value="search">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>SIDBI – Walk in kit</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_6_2_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780620.9485" value="TEG2XLgNWw3AjHItvYxy5bZQzTbdBeeERvyl/oMFHmOa6Ad5mCFF+HOzEJdAJnM1aR4J2rmJ8VWdcyWkTSKfBg==" /></div>
                            <div class="row">
