...
?>
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Quarterly/Half-yearly Results Archived</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="<?= SEOURL; ?>publication6.php">Quarterly/Half-yearly Results</a></li>
                        <li><a class="active" href="javascript:void(0)">Quarterly/Half-yearly Results Archived</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="title-content-button">
                        ...
                        <div class="button-form">
                            <div class="button-1 green-btn text-center">
                                <a href="../6.html">View Quarterly/Half-yearly Results<i class="fa fa-angle-right"></i></a>
                            </div>
                            <div class="search-form">
                                <form method="post" accept-charset="utf-8" id="search_form" name="search_form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    <div style="display:none;"><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698797239.2992" value="fLo/28QAvD5VO1fl4+LHO18kCZSNpDIdNl4sbMIyE22X5eRUrhiGG/R8UeWUTzRRftP+2hOidY9QqmXebE3GZw==" /></div> <input type="hidden" name="task" value="search">
