            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="publication4.php">MSME Studies & Reports</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>MSME Studies & Reports</h2>
                        </div>
                        <div class="button-form">
                            <div class="button-1 green-btn text-center mb-2">
                                <a href="archived/4.php">View Archived<i class="fa fa-angle-right"></i></a>
                            </div>
                            <div class="search-form">
                                <form method="post" accept-charset="utf-8" id="search_form" name="search_form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    <div style="display:none;"><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780629.8506" value="o/d6JRrGbwI4pKNG5p7iNfJBbD9g7N2VXmg8WbhckYR1XssAOupx94ubwfwbNOPlLQ+o0wRgy0SF57wDdnsQ4Q==" /></div> <input type="hidden" name="task" value="search">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Aerospace and Defence Sector in India-August 2021</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_177_4_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">2</th>
                                    <td>Medical Device Sector in Uttarakhand Study Report</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_168_4_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">3</th>
                                    <td>Private Investing in India – Venture Capital Focus</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_161_4_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">4</th>
                                    <td>Hyderabad Pharamaceutical Cluster, Ahmedabad Dyes & Chemical Cluster</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_77_4_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_69_4_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780629.8551" value="o/d6JRrGbwI4pKNG5p7iNfJBbD9g7N2VXmg8WbhckYR1XssAOupx94ubwfwbNOPlLQ+o0wRgy0SF57wDdnsQ4Q==" /></div>
                            <div class="row">
