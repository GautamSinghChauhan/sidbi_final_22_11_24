            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a href="<?= SEOURL; ?>publication-and-reports">Publications & Reports</a></li>
                        <li><a class="active" href="publication9.php">Sankalp</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="title-content-button">
                        ...
                        <div class="button-form">
                            <div class="button-1 green-btn text-center mb-2">
                                <a href="archived/9.php">View Archived<i class="fa fa-angle-right"></i></a>
                            </div>
                            <div class="search-form">
                                <form method="post" accept-charset="utf-8" id="search_form" name="search_form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    <div style="display:none;"><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780677.2234" value="gwQfuRy2eh4RMDofmCx1kAVgTRVo5zuKwXnCz+iUVTtVra6cPJpk66IPWKVlhnRA2i6J+QxrLVsa9kKVJrPUXg==" /></div> <input type="hidden" name="task" value="search">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Sankalp [April-September 2022]</a></td>
                                    <td class="text-center">
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">2</th>
                                    <td>Sankalp (100-101) October 2021 to March 2022</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_183_9_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">3</th>
                                    <td>July to September, 2021 </a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_180_9_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">4</th>
                                    <td>January to June, 2021</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_175_9_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">5</th>
                                    <td>July to December 2020 </a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_169_9_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">6</th>
                                    <td>April to June, 2020</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_170_9_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <th class="text-center" scope="row">7</th>
                                    <td>Jan to March 2020</a></td>
                                    <td class="text-center">
                                        <!--<a href="/uploads/publication_reports/" target="_blank"
                               title=""><i class="fa fa-cloud-download"></i></a>-->
                                        <a class="registrationandDownloaddoc" data-bs-toggle="modal" data-bs-target="#exampleModal" aria-hidden="true" data-documentid="form_160_9_index"><i class="fa fa-cloud-download"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780677.2281" value="gwQfuRy2eh4RMDofmCx1kAVgTRVo5zuKwXnCz+iUVTtVra6cPJpk66IPWKVlhnRA2i6J+QxrLVsa9kKVJrPUXg==" /></div>
                            <div class="row">
