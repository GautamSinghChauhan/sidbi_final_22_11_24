            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="publication8.php">DAKSHATA</a></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="title-content-button">
                        ...
                        <div class="button-form">
                            <div class="button-1 green-btn text-center mb-2">
                                <a href="archived/8.php">View Archived<i class="fa fa-angle-right"></i></a>
                            </div>
                            <div class="search-form">
                                <form method="post" accept-charset="utf-8" id="search_form" name="search_form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    <div style="display:none;"><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780672.0403" value="p4nzRGWaO3552YD29NKK73EnRr1guJvgPQz0BZqG6lFxIEJhRbYli8rm4kwJeIs/rmmCUQQ0jTHmg3RfVKFrNA==" /></div> <input type="hidden" name="task" value="search">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780672.0445" value="p4nzRGWaO3552YD29NKK73EnRr1guJvgPQz0BZqG6lFxIEJhRbYli8rm4kwJeIs/rmmCUQQ0jTHmg3RfVKFrNA==" /></div>
                            <div class="row">
