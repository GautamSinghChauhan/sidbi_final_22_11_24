...
<body class="main-wrapper-en">
    ...
    <?php
        ...
        ?>
        <section class="about-us-banner" data-aos="fade-down" style="background: url('../assets/front/images/Inner Banenr.jpg') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Annual Series Report</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="publication1.php">Annual Series Report</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="inner">
                    <div class="title-content-button">
                        <div class="title-content bold-title with-underline green">
                            <h2>Annual Series Report</h2>
                        </div>
                        <div class="button-form">
                            <div class="button-1 green-btn text-center mb-2">
                                <a href="archived/1.php">View Archived<i class="fa fa-angle-right"></i></a>
                            </div>
                            <div class="search-form">
                                <form method="post" accept-charset="utf-8" id="search_form" name="search_form" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                                    <div style="display:none;"><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780616.4555" value="U9gdQ0LfkzVMFMMtIAfoiI31xSu5eiqh9wkKhZtngeyFcaxmYvONwP8roZfdrelYUrsBx932PHAshorfVUAAiQ==" /></div> <input type="hidden" name="task" value="search">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>SIDBI Working Report FY 2022</a></td>
                                    <td class="text-center">
                                        <a href="https://development.sidbi.in/en/publication-and-reports/download/184/1/index" target="_blank" title="SIDBI Working Report FY 2022">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698780616.4597" value="U9gdQ0LfkzVMFMMtIAfoiI31xSu5eiqh9wkKhZtngeyFcaxmYvONwP8roZfdrelYUrsBx932PHAshorfVUAAiQ==" /></div>
                            <div class="row">
                                ...
                                <div class="col-md-12" id="userdownloads_captcha_field">
                                    <div class="form-group reSetPass">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="captcha">
                                                    <div class="captchaImg"><img id="captcha" src="http://sidbinew.php-staging.com/admin/ajax/generateCaptcha" /></div>
