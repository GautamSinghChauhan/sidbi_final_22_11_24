...
<head>
    ...
    <title>List of Partners - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <div class="cms ListofPartners">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `listofpartners_ID`, `listofpartners_title`, `listofpartners_title_hindi`, `listofpartners_content`, `listofpartners_content_hindi`, `status` FROM `listofpartners` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $listofpartners_content = html_entity_decode($row["listofpartners_content"]);
                                        $listofpartners_content_hindi = html_entity_decode($row["listofpartners_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $listofpartners_title_hindi;
                                                else:
                                                 echo  $listofpartners_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $listofpartners_content_hindi;
                                                else:
                                                 echo  $listofpartners_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698736174.5656" value="FByU7V4o3cHLpnFbpUSXTUlnpQb7Fs//Gi1ufgrltxskGNt4ikDdUWxH+FPMPWMRvQ2CXKL+EM8LqjoUeeco3A==" /></div>
                            <div class="row">
