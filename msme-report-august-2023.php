...
<head>
    ...
    <title>MSME Pulse August 2023</title>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">MSME Pulse August 2023</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="cms ReadMSMEPULSEFEB2021inthelanguageofyourchoice">
            <div class="container language-main-inner-page">
                <div class="over-cont psme-sec">
                    <h2>MSME REPORT AUGUST 2023</h2>
                    <div class="row">
                        <div class="col-md-3 col-sm-12"> <img src="<?= SEOURL; ?>assets/front/images/MSME_Report_August_2023.png"
                                alt="August 2023" title="August 2023" height="200" width="150"></div>
                        <div class="col-md-9 col-sm-12">
                            <div class="rt-viewse view-all-button-s "><a class="hvr-rectangle-out"
                                    href="uploads/article/articlefiles/msme-pulse-august-2023_compressed.pdf" title="View"
