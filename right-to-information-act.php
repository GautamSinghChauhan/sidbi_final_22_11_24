...
<head>
    ...
    <title>Right to Information Act - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <div class="cms RighttoInformationAct">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `rightinformation_ID`, `rightinformation_title`, `rightinformation_title_hindi`, `rightinformation_content`, `rightinformation_content_hindi`, `status` FROM `rightinformation` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $rightinformation_content = html_entity_decode($row["rightinformation_content"]);
                                        $rightinformation_content_hindi = html_entity_decode($row["rightinformation_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $rightinformation_title_hindi;
                                                else:
                                                 echo  $rightinformation_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $rightinformation_content_hindi;
                                                else:
                                                 echo  $rightinformation_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698781152.5165" value="J2cqE7KpaqBb1rCNn95hgt+/xhNKVt2Qt/77gIrISUvxzps2koV0Vejp0jdidGBSAPEC/y7ay0FscXvaRO/ILg==" /></div>
                            <div class="row">
