...
<section class="about-us-banner" data-aos="fade-down" style="background: url('assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
    ...
    <script>
        function switchLanguage(selectedValue) {
            ...
            // Set English and Hindi TITLE
            var englishTITLE = "<?php echo addslashes($innerpage_title); ?>";
            var hindiTITLE = "<?php echo addslashes($innerpage_title_hindi); ?>";

            //HOME
            var englishHOME = "Home";
            var hindiHOME = "होम पेज";

            // Set English and Hindi CONTENT
            var englishCONTENT = "<?php echo addslashes($innerpage_content); ?>";
            var hindiCONTENT = "<?php echo addslashes($innerpage_content_hindi); ?>";
