...
<head>
    ...
    <title>Financial Inclusion of ultra poor women in MP state - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Financial Inclusion of ultra poor women in MP state</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Financial Inclusion of ultra poor women in MP state</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <div class="cms FinancialInclusionofultrapoorwomeninMPstate">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `financeinclusion_ID`, `financeinclusion_title`, `financeinclusion_title_hindi`, `financeinclusion_content`, `financeinclusion_content_hindi`, `status` FROM `financeinclusion` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $financeinclusion_content = html_entity_decode($row["financeinclusion_content"]);
                                        $financeinclusion_content_hindi = html_entity_decode($row["financeinclusion_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $financeinclusion_title_hindi;
                                                else:
                                                 echo  $financeinclusion_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $financeinclusion_content_hindi;
                                                else:
                                                 echo  $financeinclusion_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698748410.7522" value="UCLItwexM3pAYIkM3UXIMl94029a3hoq+CudbP9SFK2q1E12Z/HyXOeRA64uANSMQ3vlq2jWSH9e3vgmx49d3g==" /></div>
                            <div class="row">
