...
<head>
    ...
    <title>Key Outputs/Activities - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#"> <p style="margin-bottom: 0px;"><?php  if($get_configured_lang == 'HI'): 
                                                 echo 'मुख्य आउटपुट/गतिविधियाँ';
                                                else:
                                                 echo 'Key Outputs/Activities';
                                                endif; ?></p></a></li>
        ...
        <div class="cms KeyOutputs/Activities">
            <div class="container">
            <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `psigkey_ID`, `psigkey_title`, `psigkey_title_hindi`, `psigkey_content`, `psigkey_content_hindi`, `status` FROM `psigkey` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $psigkey_content = html_entity_decode($row["psigkey_content"]);
                                        $psigkey_content_hindi = html_entity_decode($row["psigkey_content_hindi"]);
                                    ?>
  
      
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont lisme-sec svt">
                            <h2><span style="background-color:rgb(255,255,255);color:rgb(32,33,36);"><span>
                                <?php  if($get_configured_lang == 'HI'): 
                                                 echo $psigkey_title_hindi;
                                                else:
                                                 echo $psigkey_title;
                                                endif; ?></span></span></h2>
                            <p><span> <p><?php  if($get_configured_lang == 'HI'): 
                                                 echo $psigkey_content_hindi;
                                                else:
                                                 echo $psigkey_content;
                                                endif; ?></p></p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698736147.4211" value="3JKV9VjMp03gOMm4mATnO2k8b8YKcbO74aGu+afFXXbsltpgjKSn3UfZQLDxfRNnnVZInFOZbIvwJvqT1MfCsQ==" /></div>
                            <div class="row">
