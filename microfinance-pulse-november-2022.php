...
<head>
    ...
    <title>Microfinance Pulse November - 2022</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <section class="about-us-banner" data-aos="fade-down"
            ...
            <div class="container">
                <div class="inner">
                    <h1>Microfinance Pulse November - 2022</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="careers">Microfinance Pulse November - 2022</a></li>
                    </ul>
                </div>
            </div>
        </section>

        <section class="cms microfinance-pulse-november-2022">
            <div class="container language-main-inner-page">
                <div class="over-cont psme-sec">
                    <h2>Read Microfinance Pulse November 2022 in the language of your choice</h2>
                    <div class="row">
                        <div class="col-md-3 col-sm-12"><img
                                src="<?= SEOURL; ?>assets/front/images/MFI-Pulse-14th-Edition.jpg" alt="NOVEMBER 2022"
                                width="150" height="200" title="NOVEMBER 2022"></div>
                        <div class="col-md-9 col-sm-12">
                            <div class="rt-viewse view-all-button-s "><a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition.pdf" target="_blank"
                                    title="View">English</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition_Hindi.pdf" target="_blank"
                                    title="View">Hindi</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition_Manipuri.pdf" target="_blank"
                                    title="View">Manipuri</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition_Marathi.pdf" target="_blank"
                                    title="View">Marathi</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition-Tamil.pdf" target="_blank"
                                    title="View">Tamil</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition-Malayalam.pdf" target="_blank"
                                    title="View">Malayalam</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition-Gujarati.pdf" target="_blank"
                                    title="View">Gujarati</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/BENGALI-MFI-Pulse-14th-Edition-Bengali.pdf" target="_blank"
                                    title="View">Bengali</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition-Telugu.pdf" target="_blank"
                                    title="View">Telugu</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition_Punjabi.pdf" target="_blank"
                                    title="View">Punjabi</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition_Bodo.pdf" target="_blank"
                                    title="View">Bodo</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition_Odia.pdf" target="_blank"
                                    title="View">Odia</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/MFI-Pulse-14th-Edition-Assamese.pdf" target="_blank"
                                    title="View">Assamese</a> <a class="hvr-rectangle-out"
                                    href="<?= SEOURL; ?>uploads/article/articlefiles/Translated-MFI-Pulse-14th-Edition-Kannada.pdf" target="_blank"
                                    title="View">Kannada</a></div>
                        </div>
                    </div>
