...
<head>
    ...
    <title>Partnership with government institutions - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner"
            ...
            <div class="container">
                <div class="inner">
                    <h1>Partnership with government institutions</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Partnership with government institutions</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <div class="cms Partnershipwithgovernmentinstitutions">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `partnership_ID`, `partnership_title`, `partnership_title_hindi`, `partnership_content`, `partnership_content_hindi`, `status` FROM `partnership` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $partnership_content = html_entity_decode($row["partnership_content"]);
                                        $partnership_content_hindi = html_entity_decode($row["partnership_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $partnership_title_hindi;
                                                else:
                                                 echo  $partnership_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $partnership_content_hindi;
                                                else:
                                                 echo  $partnership_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                        </div>
                    </div>
