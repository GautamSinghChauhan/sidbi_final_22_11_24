...
$orinal_tender_title = ($_GET['url']);
$get_tender_id = getTENDER_DETAILS('', $orinal_tender_title, 'get_tender_id');
...
<body class="main-wrapper-en">
    ...
    <script>
        $(document).ready(function() {
            show_TENDER_DETAIL_DOCUMNET('<?= $get_configured_lang; ?>', '<?= $get_tender_id; ?>');
        });

        function show_TENDER_DETAIL_DOCUMNET(LANGUAGE, ID) {
            $.ajax({
                type: 'post',
                url: '<?= BASEPATH; ?>engine/ajax/__ajax_tender_details_document.php?type=show_document',
                data: {
                    ID: ID,
                    LANGUAGE: LANGUAGE
                },
                success: function(response) {
                    $('#showTenderDocument').html(response);
                }
            });
        }
    </script>
