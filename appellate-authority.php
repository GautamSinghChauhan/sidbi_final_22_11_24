...
<head>
    ...
    <title>Appellate Authority - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <div class="cms AppellateAuthority">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont">
                            <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `appellate_ID`, `appellate_title`, `appellate_title_hindi`, `appellate_content`, `appellate_content_hindi`, `status` FROM `appellate` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $appellate_content = html_entity_decode($row["appellate_content"]);
                                        $appellate_content_hindi = html_entity_decode($row["appellate_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $appellate_title_hindi;
                                                else:
                                                 echo  $appellate_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $appellate_content_hindi;
                                                else:
                                                 echo  $appellate_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698781157.6264" value="gTYM0QPP5CnOFDCp5dDwBHdjpzglJ/LIWe+fDYhEPq1Xn730I+P63H0rUhMYevHUqC1j1EGr5BmCYB9XRmO/yA==" /></div>
                            <div class="row">
