...
<body>
  ...
  <script>
  if ($("#fintech_description,#fintech_description_hindi").length > 0) {
      tinymce.init({
        selector: "textarea#fintech_description, textarea#fintech_description_hindi",
        theme: "modern",
        menubar: false,
        min_height: 300,
    ...
    $(function() {
      'use strict';
      <?php if ($route == '') : ?>
        $('#fintech_LIST').DataTable({
          // DataTables options here
          'ajax': 'engine/json/JSONfintech.php',
          "columns": [{
              "data": "count" //0
            },
            {
              "data": "fintech_description" //1
            },
            {
              "data": "fintech_description_hindi" //2
            },
            // {
          ...
          "columnDefs": [{
            ...
            },
            {
              ...
              "render": function(data, type, full, meta) {
                return '<a title="Click to edit" href="msmepluse.php?route=edit&id=' + data + '" class="btn btn-light btn-icon"><i class="fa fa-edit"></i></a> <a href="javascript:void(0);" onClick ="deleteITEM(' + data + ');" title="Click to delete" class="btn btn-dark btn-icon"><i class="fa fa-trash"></i></a>';
              }
            }
          ],
