...
<head>
    ...
    <title>UP-SCALING OF FLWE PILOT IN 4 STATES OF PSIG - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>UP-SCALING OF FLWE PILOT IN 4 STATES OF PSIG</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">UP-SCALING OF FLWE PILOT IN 4 STATES OF PSIG</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <div class="cms UP-SCALINGOFFLWEPILOTIN4STATESOFPSIG">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `upscaling_ID`, `upscaling_title`, `upscaling_title_hindi`, `upscaling_content`, `upscaling_content_hindi`, `status` FROM `upscaling` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $upscaling_content = html_entity_decode($row["upscaling_content"]);
                                        $upscaling_content_hindi = html_entity_decode($row["upscaling_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $upscaling_title_hindi;
                                                else:
                                                 echo  $upscaling_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $upscaling_content_hindi;
                                                else:
                                                 echo  $upscaling_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698748401.5111" value="EcIwX38dVMTAaAEd0h99KEJ1rw6pLgWhkU3rrhT3vy3rNLWeH12V4meZi78hWmGWXnaZypsmV/Q3uI7kLCr2Xg==" /></div>
                            <div class="row">
