...
<head>
    ...
    <title>Chief Grievance Officer / Grievance Redressal Officer for PwD - Small Industries Development Bank of India
    </title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
            ...
            <div class="container">
                <div class="inner">
                    <h1><?php if ($get_configured_lang == 'HI') :
                            echo  'पीडब्ल्यूडी के लिए मुख्य शिकायत अधिकारी/शिकायत निवारण अधिकारी';
                        else :
                            echo  'Chief Grievance Officer / Grievance Redressal Officer for PwD';
                        endif; ?></h1>
                </div>
            </div>
        </section>
        ...
        <?php
        $list_transaction = sqlQUERY_LABEL("SELECT `cheifgrievances_ID`, `cheifgrievances_title`, `cheifgrievances_title_hindi`, `cheifgrievances_content`, `cheifgrievances_content_hindi`, `status` FROM `cheifgrievances` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
        ...
        ?>
            ...
            <div><?php if ($get_configured_lang == 'HI') :
                        echo  $cheifgrievances_content_hindi;
                    else :
                        echo  $cheifgrievances_content;
                    endif; ?></div>
        <?php endwhile; ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698734961.0587" value="CUIReeutxrDD93/qg5IzcalmhH/GEWRcw8fK24y68dU5Rl7sP8XGIGQW9uLq68ctXQyjJZ/5u2zSQJ6x/7huEg==" />
                            </div>
                            <div class="row">
