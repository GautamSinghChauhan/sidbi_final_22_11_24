...
<head>
    ...
    <title>Microfinance Pulse - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
            ...
            <div class="container">
                <div class="inner">
                    <h1><?php  if($get_configured_lang == 'HI'): 
                                                 echo  'माइक्रोफाइनेंस पल्स';
                                                else:
                                                 echo  'Microfinance Pulse';
                                                endif; ?></h1>
                </div>
            </div>
        </section>
        ...
        <?php
       $select_msme_pluse = sqlQUERY_LABEL("SELECT `micro_finance_id`, `micro_finance_descrption`, `micro_finance_hindi_description` FROM `js_microfinance` where `deleted`='0' ");
       while($row =sqlFETCHARRAY_LABEL($select_msme_pluse)):
        $micro_finance_id =$row['micro_finance_id'];
        $micro_finance_descrption =$row['micro_finance_descrption'];
        $micro_finance_hindi_description =$row['micro_finance_hindi_description'];
        $micro_finance_descrption = html_entity_decode(html_entity_decode($row['micro_finance_descrption']));
        $micro_finance_hindi_description = html_entity_decode(html_entity_decode($row['micro_finance_hindi_description']));
     
       endwhile;
?>              


        <div class="cms MicrofinancePulse">
            <div class="container">
            <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $micro_finance_hindi_description;
                                                else:
                                                 echo  $micro_finance_descrption;
                                                endif; ?></div>
              
                <div class="row">
                    <div class="customImageBlock h-250"><a href="<?= SEOURL; ?>microfinane-pulse-18th" target="_blank"><img src="<?= SEOURL; ?>assets/front/images/MFI-Pulse-18th-Edition-Final-Image.png" alt="Microfinance Pulse" title="18th Edition"></a></div>
                    <div class="customImageBlock h-250"><a target="_blank" href="<?= SEOURL; ?>microfinance-pulse-september-2023"><img src="<?= SEOURL; ?>assets/front/images/MFI-Pulse-17th-Edition-Final-Image.png" alt="Microfinance Pulse" title="September 2023"></a></div>
                    <div class="customImageBlock h-250"><a href="<?= SEOURL; ?>microfinance-pulse-june-2023" target="_blank"><img src="<?= SEOURL; ?>assets/front/images/MFI-Pulse-16th-Edition-Final-Image.png" alt="Microfinance Pulse" title="June 23"></a></div>
                    <div class="customImageBlock h-250"><a target="_blank" href="<?= SEOURL; ?>microfinance-pulse-all-edition"><img src="<?= SEOURL; ?>assets/front/images/microfinance_thumb.jpg" alt="Microfinance Pulse" title="November 2021"></a></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698734997.5408" value="eiGl5JiM2W9PZVcJfaiqHGs512jNjCPUnRX3IaYzr9xKJepxTOTZ/+iE3gEU0V5An1PwMpRk/OSMkqNL1TEwGw==" /></div>
                            <div class="row">
