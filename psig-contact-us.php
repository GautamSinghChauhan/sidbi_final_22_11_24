...
<head>
    ...
    <title>PSIG Contact Us - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
            ...
            <div class="container">
                <div class="inner">
                    <h1><?php  if($get_configured_lang == 'HI'): 
                                                 echo 'पीएसआईजी हमसे संपर्क करें';
                                                else:
                                                 echo 'PSIG Contact Us';
                                                endif; ?></h1>
                </div>
            </div>
        </section>
        ...
        <div class="cms PSIGContactUs">
            <div class="container">
            <?php 
            $list_transaction = sqlQUERY_LABEL("SELECT `psigcontact_ID`, `psigcontact_title`, `psigcontact_title_hindi`, `psigcontact_content`, `psigcontact_content_hindi`, `status` FROM `psigcontact` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $psigcontact_content = html_entity_decode($row["psigcontact_content"]);
                                        $psigcontact_content_hindi = html_entity_decode($row["psigcontact_content_hindi"]);
                                    ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                            <h2><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $psigcontact_title_hindi;
                                                else:
                                                 echo  $psigcontact_title;
                                                endif; ?></h2>
                            <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $psigcontact_content_hindi;
                                                else:
                                                 echo  $psigcontact_content;
                                                endif; ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698736176.8246" value="3jbLrBiWAgy5V+feenpvHpwTvec6Qpv9JvGqWxhchf3uMoQ5zP4CnB62btYTA5tCaHmavWOqRM03dv4xa14aOg==" /></div>
                            <div class="row">
