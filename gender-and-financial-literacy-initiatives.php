...
<head>
    ...
    <title>Gender and Financial Literacy Initiatives - Small Industries Development Bank of India</title>
...
?> <section class="about-us-banner"
            ...
            <div class="container">
                <div class="inner">
                    <h1>Gender and Financial Literacy Initiatives</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Gender and Financial Literacy Initiatives</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <div class="cms GenderandFinancialLiteracyInitiatives">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                            <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `genderfinance_ID`, `genderfinance_title`, `genderfinance_title_hindi`, `genderfinance_content`, `genderfinance_content_hindi`, `status` FROM `genderfinance` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $genderfinance_content = html_entity_decode($row["genderfinance_content"]);
                                        $genderfinance_content_hindi = html_entity_decode($row["genderfinance_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $genderfinance_title_hindi;
                                                else:
                                                 echo  $genderfinance_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $genderfinance_content_hindi;
                                                else:
                                                 echo  $genderfinance_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                        </div>
                    </div>
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads"
                            ...
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input
                                    type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698736169.1704"
                                    value="LxNO0d66sP+bDMakoTHPe5uwERAsNLanzxoa1uku64MfFwFECtKwbzztT6zISDsnb9o2SnXcaZfenU68mix0RA==" />
                            </div>
                            <div class="row">
