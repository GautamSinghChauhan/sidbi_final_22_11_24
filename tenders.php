...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png')  no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1 data-translate="tenders">Tenders</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="<?= SEOURL; ?>tenders" data-translate="tenders">Tenders</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <section class="press-releases">
            <div class="container">
                <div class="inner">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="title-content bold-title with-underline green">
                            <h2 class="mb-0" data-translate="tenders">Tenders</h2>
                        </div>
                        <div class="button-form">
                            <div class="">

                                <a href="tenders/tenderarchived" class="btn btn-outline-success" role="button"><span data-translate="viewarchived">View Archived</span> <i class="fa fa-angle-right ms-2"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" id="tenderLIST">
                            <thead>
                                <tr>
    ...
    <script>
        var dataTable = $('#tenderLIST').DataTable({
            //responsive: true,
            'ajax': '<?= BASEPATH; ?>engine/json/JSONtender.php?show=frontend',
            "lengthChange": true,
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row) {
                    return '<a href="' + row.tender_url + '" target="_blank">' + data + ' </a>';
                }
            }],
            language: {
