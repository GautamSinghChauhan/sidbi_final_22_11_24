...
<head>
    ...
    <title>The Consultancy committee of key stake holders for advice on suo-motu disclosure - Small Industries Development Bank of India</title>
...
?>
        ...
        <div class="cms TheConsultancycommitteeofkeystakeholdersforadviceonsuo-motudisclosure">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                            ...
                            <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `consultancy_ID`, `consultancy_title`, `consultancy_title_hindi`, `consultancy_content`, `consultancy_content_hindi`, `status` FROM `consultancy` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $consultancy_content = html_entity_decode($row["consultancy_content"]);
                                        $consultancy_content_hindi = html_entity_decode($row["consultancy_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $consultancy_title_hindi;
                                                else:
                                                 echo  $consultancy_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $consultancy_content_hindi;
                                                else:
                                                 echo  $consultancy_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                            </ul>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698781185.0217" value="ykIqpJ9Ao1uxs1Cyeb5ujDDowXihLQtBMAEHKiIHoYoc65uBv2y9rgKMMgiEFG9c76YFlMWhHZDrjodw7CAg7w==" /></div>
                            <div class="row">
