...
<head>
    ...
    <title>Sitemap - Small Industries Development Bank of India</title>
                ...
                <div class="site-map-section">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <ul>
                                    <li class="listb-s"><a href="complaints">Feedback</a></li>
                                    <li class="listb-s"><a href="contact-us">Contact Us</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <ul>
                                    <li class="listb-s"><a href="careers">Careers</a></li>
                                    <li class="listb-s"><a href="online-enquiry">Enquiry</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <ul>
                                    <!-- <li class="listb-s"><a href="https://intranet.SIDBI.in/">Employee Corner</a></li> -->
                                    <li class="listb-s"><a href="borrowers-corner">Borrower's Corner</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <h3>Home</h3>
                                <ul>
                                    <li class="listb-s"><a href="index">Introduction</a></li>
                                    <li class="listb-s"><a href="indirect-finance">Indirect Loans</a></li>
                                    <li class="listb-s"><a href="msme-cluster-development-initiatives">MSME Cluster

                                            Development Initiatives</a></li>
                                    <li class="listb-s"><a href="https://www.SIDBIvcf.in/en" target="_blank">Fund of
                                            Funds</a></li>
                                    <li class="listb-s"><a href="msme-in-focus">MSME In Focus</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <h3>About SIDBI</h3>
                                <ul>
                                    <li class="listb-s"><a href="about">An Overview</a></li>
                                    <li class="listb-s"><a href="about#mission-vision">Mission And Vision</a></li>
                                    <li class="listb-s"><a href="about#board-directors">Board of Directors</a></li>
                                    <li class="listb-s"><a href="about#role-SIDBI">Evolution of SIDBI</a></li>
                                    <li class="listb-s"><a href="about#historical-journey">Historical Journey</a>
                                    </li>
                                    <li class="listb-s"><a href="about#financials-shareholding">Financials</a></li>
                                    <li class="listb-s"><a href="about#financials-shareholding">Shareholding</a>
                                    </li>
                                    <li class="listb-s"><a href="organization-chart">Organisation Chart</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                ...
                                <ul>
                                    <li class="listb-s"><a href="chief-grievance-officer">Chief Grievance Officer /
                                            Grievance Redressal Officer for PWD</a></li>
                                    <li class="listb-s"><a href="complaints">Online Complaints /
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <h3>Investors Relation</h3>
                                <ul>
                                    <li class="listb-s"><a href="investors-relation">Fixed Deposit
                                            Scheme</a></li>
                                    <li class="listb-s"><a href="investors-relation">Deep Discount Bond
                                            Redemption</a></li>
                                    <li class="listb-s"><a href="debenture-trustee">Details Of Debenture
                                            Trustees</a></li>
                                    <li class="listb-s"><a href="disclosures">Disclosures/Announcements - NCDs / CP
                                            (Listed)</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <h3>Media</h3>
                                <ul>
                                    <li class="listb-s"><a href="media#pressreleses">Press Release</a></li>
                                    <li class="listb-s"><a href="media#latest-news">SIDBI News</a></li>
                                    <li class="listb-s"><a href="media#social-media">Social Media</a></li>
                                    <li class="listb-s"><a href="media#photos-videos">Videos / Photos</a></li>
                                    <li class="listb-s"><a href="media#press-coverage">Press Coverage</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <h3>Join Us As CCCs</h3>
                                <ul>
                                    <li class="listb-s"><a href="join-us-as-cccs">Join Us As CCCs</a></li>
                                </ul>
                                <h3>Circulars</h3>
                                <ul>
                                    <li class="listb-s"><a href="circulars.php">Circulars</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <h3>Footer Links</h3>
                                <ul>
                                    <li class="listb-s"><a href="publication-and-reports">Publication & Reports</a>
                                    </li>
                                    <li class="listb-s"><a href="multilateral-agencies">Multilateral Agencies</a>
                                    </li>
                                    <li class="listb-s"><a href="reservation-roster">Reservation Roster</a></li>
                                    <li class="listb-s"><a href="contact-us">Customer Care</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                ...
                                <ul>
                                    <li class="listb-s"><a href="complaints">Feedback</a></li>
                                    <li class="listb-s"><a href="https://retbs.SIDBI.in/RetireePortal/" target="_blank">Retiree Portal</a></li>

                                    <li class="listb-s"><a href="tenders">Tenders</a></li>
                                    <li class="listb-s"><a href="rti-cell">RTI Cell</a></li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="box-s-5">
                                <h3> </h3>
                                <ul>
                                    <li class="listb-s"><a href="terms-conditions">Terms & Condition</a></li>
                                    <li class="listb-s"><a href="privacy-policy">Privacy Policy</a></li>
                                    <li class="listb-s"><a href="copyright-policy">Copyright Policy</a></li>
                                    <li class="listb-s"><a href="hyperlink-policy">Hyperlink Policy</a></li>
                                    <li class="listb-s"><a href="accessibility">Accessibility</a></li>
                                    <li class="listb-s"><a href="disclaimer">Disclaimer</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698735029.457" value="6buVMmuSCPywKm9wVxKmP/1UI861vRSPch0tYb2Cdj3Zv9qnv/oIbBfL5ng+a1JjCT4ElOxVy79jmnkLzoDp+g==" />
                            </div>
                            <div class="row">
