...
<head>
    ...
    <title>6TH E-AUCTION SALE NOTICE UNDER IBC 2016 – TIRUPUR PLAZA HOTEL PVT. LTD. [IN LIQUIDATION] - Small Industries
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="over-cont wow fadeInDown">
                            <h2>Hiring of Housekeeping, Service Agency at SIDBI Hyderabad</h2>
                ...
                <div class="inner">
                    <div class="">
                        <div class="title-content bold-title with-underline green">
                            <h2>6th E-Auction Sale Notice under IBC 2016 – Tirupur Plaza Hotel Pvt. Ltd. [In
                                Liquidation]</h2>
                            <p>
                                6th E-Auction Sale Notice under IBC 2016 &ndash; Tirupur Plaza Hotel Pvt. Ltd. [In
                                Liquidation]</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="over-cont complaint-inner">
                            ...
                            <div class="box-2 features-ul">
                                <ul>
                                    <h3>Documents</h3>
                                    <li>
                                        <a title="View" target="_blank" href="<?= SEOURL; ?>uploads/tenders/E-Auction-Notice.pdf"><i
                                                class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                            E-Auction-Notice.pdf</a>
                                    </li>
                                    <li>
                                        <a title="View" target="_blank"
                                            href="<?= SEOURL; ?>uploads/tenders/2023-12-19-164525-ocrh5-Tirupur-plaza-Hotel--E-Auction-Process-Document.pdf"><i
                                                class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                            2023-12-19-164525-ocrh5-Tirupur-plaza-Hotel--E-Auction-Process-Document.pdf</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
