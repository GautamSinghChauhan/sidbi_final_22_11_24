                        ...
                        <ul class="mainmenu">
                            <li>
                                <a href="../../index" class="nav-a-megamenu
                                        nav-active" data-translate="home">
                                    Home
                                </a>
                            </li>
                            <li>
                                <a href="../../about" class="nav-a-megamenu" data-translate="about">
                                    About us
                                </a>
                            </li>
                            <li class="MSME-loan d-none d-xl-block">
                                <!-- <a href="../../home-product" class="nav-a-megamenu">Loans for MSMEs</a> -->
                                <a href="../../#" class="nav-a-megamenu" data-translate="loan">Loans</a>
                                <ul class="MSME-loan-content px-0">
                                    <li><a href="../../home-product" data-translate="msme">MSME Loans</a></li>
                                    <li><a href="../../institutional-finance" data-translate="institute">Institutional Finance</a></li>
                                    <li><a href="../../prayaas" data-translate="prayaas">PRAYAAS</a></li>
                                    <li><a href="../../treds" data-translate="treds">TReDS</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li class="Ecosystem-element d-none d-xl-block">
                                <a href="../../#" class="nav-a-megamenu" data-translate="ecosystem">Ecosystem</a>
                                <ul class="Ecosystem-element-content px-0">
                                    <li><a href="../../ecosystem" data-translate="subs" target="_blank">Subsidiary Network</a></li>
                                    <li><a href="../../https://www.SIDBIvcf.in/en" data-translate="fund" target="_blank">Fund of Funds</a></li>
                                </ul>
                            </li>
                            <!-- <li>
                            ...
                            <li>
                                <a href="../../online-enquiry" class="nav-a-megamenu" data-translate="enquiry">
                                    Enquire Now
                                </a>
                            </li>
                        </ul>
        ...
        <div class="d-block
            ...
            <div class="d-xl-flex col-xl-2 col-12
                ...
                <ul class="megamenu-custom-ul">
                    ...
                    <li>
                        <a href="../../https://sidbi4u.sidbi.in/login.action">
                            <span>
                                Customer Portal
                            </span>
                        </a>
            ...
            <div class="d-xl-flex col-xl-2 col-12
                ...
                <ul class="megamenu-custom-ul">
                    <li>
                        <a href="../../institutional-finance#section2">
                            <span>
                                Refinance to Banks
                            </span>
                        </a>
                    ...
                    <li>
                        <a href="../../institutional-finance#section3">
                            <span>
                                Lending to NBFCs
                            </span>
                        </a>
                    ...
                    <li>
                        <a href="../../institutional-finance#section4">
                            <span>
                                Lending to MFIs
                            </span>
                        </a>
            ...
            <div class="d-xl-flex col-xl-2 col-12
                ...
                <ul class="megamenu-custom-ul">
                    <li>
                        <a href="../../government-programmes#overview-sectionPM_Vishwakarma_Scheme">
                            <span>
                    ...
                    <li>
                        <a href="../../government-programmes#overview-sectionPM_SVANidhi_Scheme">
                            <span>
                                PM SVANidhi Scheme
                            </span>
                        </a>
                    ...
                    <li>
                        <a href="../../government-programmes#overview-section PLI_Schemes">
                            <span>
                                PLI Schemes
                            </span>
                        </a>
                    ...
                    <li>
                        <a href="../../government-programmes#overview-section">
                            <span>
                                Other Schemes
                            </span>
                        </a>
            ...
            <div class="d-xl-flex col-xl-2 col-12
                ...
                <ul class="megamenu-custom-ul">
                    ...
                    <li>
                        <a href="../../finance-income-trade-rank-fit-rank">
                            <span>
                                FIT Rank
                            </span>
                        </a>
        ...
        <div class="d-block
            ...
            <div class="d-xl-flex col-xl-2 col-12
                ...
                <ul class="megamenu-custom-ul">
                    ...
                    <li>
                        <a href="../../green-pathways-e-series">
                            <span>
