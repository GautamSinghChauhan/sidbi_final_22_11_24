...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('assets/front/images/Inner%20Banenr.jpg') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1 data-translate="pressreleases">Press Releases</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="<?= SEOURL; ?>pressreleases" data-translate="pressreleases">Press Releases</a></li>
                    </ul>
                </div>
            </div>
        </section>
                ...
                <div class="inner">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="title-content bold-title with-underline green">
                            <h2 class="mb-0" data-translate="pressreleases">Press Releases</h2>
                        </div>
                        ...
                        <table class="table table-bordered" id="pressreleaseLIST">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="50px" scope="col" data-translate="date">Date</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
	...
	<script>
        ...
        function switchLanguage(language) {
			...
			(async () => {
				await pressreleaseDataTable(language);
			})();
        }
