...
function refreshCaptcha()
{
    ...
    $_SESSION['pub_report_server_captcha'] = $newCaptcha;
    return $newCaptcha;
}
...
if (isset($_GET['refresh']) && $_GET['refresh'] === 'true') :
    ...
    echo json_encode(['pub_report_server_captcha' => $newCaptcha, 'imageUrl' => 'path/to/ajax_generateCaptcha.php']);
else :
    ...
    $_SESSION['pub_report_server_captcha'] = $captcha;
