...
function refreshCaptcha()
{
    ...
    $_SESSION['enquiry_captcha'] = $newCaptcha;
    return $newCaptcha;
}
...
if (isset($_GET['refresh']) && $_GET['refresh'] === 'true') :
    ...
    echo json_encode(['enquiry_captcha' => $newCaptcha, 'imageUrl' => 'path/to/ajax_generateCaptcha.php']);
else :
    ...
    $_SESSION['enquiry_captcha'] = $captcha;
