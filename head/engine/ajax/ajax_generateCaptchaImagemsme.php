...
function refreshCaptcha()
{
    ...
    $_SESSION['msme_server_captcha'] = $newCaptcha;
    return $newCaptcha;
}
...
if (isset($_GET['refresh']) && $_GET['refresh'] === 'true') :
    ...
    echo json_encode(['msme_server_captcha' => $newCaptcha, 'imageUrl' => 'path/to/ajax_generateCaptcha.php']);
else :
    ...
    $_SESSION['msme_server_captcha'] = $captcha;
