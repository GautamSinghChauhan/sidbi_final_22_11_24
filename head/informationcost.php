...
<body>
  ...
  <script>
     if ($("#informationcost_content,#informationcost_content_hindi").length > 0) {
        tinymce.init({
            selector: "textarea#informationcost_content, textarea#informationcost_content_hindi",
            theme: "modern",
            menubar: false,
            min_height: 300,
    ...
    $(function() {
      'use strict'
        ...
        $("#informationcostimage").change(function() {
          uploadImage(this);
        });
    ...
    function deleteITEM(deleting_id) {
      ...
      $('.receiving-delete-data').load('view/x__informationcost.php?type=delete&delete_id=' + SELECTED_ID + '', function() {
    ...
    function togglestatusITEM(informationcost_ID, status) {
      var SELECTED_ID = informationcost_ID;
      var SELECTED_STATUS = status;
      //alert(SELECTED_ID);
      $('#pleasewait-loader').show();
      $('.receiving-delete-data').load('view/x__informationcost.php?type=changestatus&informationcost_ID=' + SELECTED_ID + '&oldstatus=' + SELECTED_STATUS + '', function() {
        $('#pleasewait-loader').hide();
        location.reload();
      });
    }
    ...
    $(document).ready(function() {
      $('#informationcostname').parsley();
      var old_informationcost_name = document.getElementById("encrypt_informationcost_name").value;
      window.ParsleyValidator.addValidator('checkinformationcostname', {
        validateString: function(value) {
          return $.ajax({
            url: 'engine/ajax/ajax_informationcost_name.php',
            method: "POST",
            data: {
              informationcost_name: value,
              old_informationcost_name: old_informationcost_name
            },
            dataType: "json",
    ...
    $(document).ready(function() {
      $('#informationcostcode').parsley();
      var old_informationcost_name = document.getElementById("encrypt_informationcostcode").value;
      window.ParsleyValidator.addValidator('checkinformationcostcode', {
        validateString: function(value) {
          return $.ajax({
            url: 'engine/ajax/ajax_informationcost_code.php',
            method: "POST",
            data: {
              informationcost_code: value,
              old_informationcost_code: old_informationcost_name
            },
            dataType: "json",
            success: function(data) {
    ...
    if ($code == '0') {
      $displayMSG_globalclass->displayMSG($code, "Error", 'Unable to Add informationcost.', 'error');
    }
