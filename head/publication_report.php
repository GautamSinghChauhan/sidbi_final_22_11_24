...
<body class="page-profile">
	...
	$(function() {
      ...
      <?php if ($route == '') {  ?>
        ...
        $('#publicationLIST').DataTable({
          //responsive: true,
          'ajax': 'engine/json/JSONpublicationreport.php?show=<?php echo $show; ?>',
          "columns": [{
              "data": "count" //0
            },
            {
              "data": "publication_title" //1
            },
            {
              "data": "publication_hindi_title" //2
            },
            ...
            // },
             {
              ...
              "render": function(data, type, full, meta) {
                return '<a title="Click to edit" href="publication_report.php?route=edit&id=' + data + '" class="btn btn-light btn-icon"><i class="fa fa-edit"></i></a> <a href="javascript:void(0);" onClick ="deleteITEM(' + data + ');" title="Click to delete" class="btn btn-dark btn-icon"><i class="fa fa-trash"></i></a><a title="Click to edit" href="publication_report.php?route=preview&id=' + data + '" class="btn btn-light btn-icon"><i class="fa fa-edit"></i></a>';
                //return '';
              }
            }
          ],
	...
	<?php if ($route == 'add' || $route == 'edit'):  ?>
		...
		function displayUploadedFiles(selectedDocumentType, selectedFiles) {
			...
			for (let i = 0; i < selectedFiles.length; i++) {
				...
				const selectedDocumentTypeID = $('#tender_document_type_id').val();
