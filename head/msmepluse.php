...
<body>
  ...
  <script>
    if ($("#msme_description,#msme_description_hindi").length > 0) {
      tinymce.init({
        selector: "textarea#msme_description, textarea#msme_description_hindi",
        theme: "modern",
        menubar: false,
        min_height: 300,
    ...
    $(function() {
      'use strict';
      <?php if ($route == '') : ?>
        $('#msmepulse_LIST').DataTable({
          // DataTables options here
          'ajax': 'engine/json/JSONmsmeplusereport.php',
          "columns": [{
              "data": "count" //0
            },
            {
            ...
            {
              "data": "msme_hindi_title" //2
            },
            {
              "data": "msme_pluse_description" //3
            },
            {
