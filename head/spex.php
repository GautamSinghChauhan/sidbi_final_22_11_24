...
<body>
  ...
  <script>
  if ($("#spex_description,#spex_hindi_description").length > 0) {
      tinymce.init({
        selector: "textarea#spex_description, textarea#spex_hindi_description",
        theme: "modern",
        menubar: false,
        min_height: 300,
    ...
    $(function() {
      ...
      <?php if ($route == '') : ?>
        $('#spex_LIST').DataTable({
          ...
          'ajax': 'engine/json/JSONspex.php',
          "columns": [{
              "data": "count" //0
            },
            {
              "data": "spex_description" //1
            },
            {
              "data": "spex_hindi_description" //2
            },
            // {
            //   "data": "spex_hindi_description" //3
            // },
            // {
          ...
          "columnDefs": [{
            ...
            // },
            {
              ...
              "render": function(data, type, full, meta) {
                return '<a title="Click to edit" href="spex.php?route=edit&id=' + data + '" class="btn btn-light btn-icon"><i class="fa fa-edit"></i></a>';
              }
            }
          ],
