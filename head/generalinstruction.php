...
<body>
  ...
  <script>
     if ($("#generalinstruction_content,#generalinstruction_content_hindi").length > 0) {
        tinymce.init({
            selector: "textarea#generalinstruction_content, textarea#generalinstruction_content_hindi",
            theme: "modern",
            menubar: false,
            min_height: 300,
