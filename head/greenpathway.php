...
<body>
  ...
  <script>
  if ($("#greenpathway_description,#greenpathway_hindi_description").length > 0) {
      tinymce.init({
        selector: "textarea#greenpathway_description, textarea#greenpathway_hindi_description",
        theme: "modern",
        menubar: false,
        min_height: 300,
    ...
    $(function() {
      'use strict';
      <?php if ($route == '') : ?>
        $('#greenpathway_LIST').DataTable({
          // DataTables options here
          'ajax': 'engine/json/JSONgreenpathway.php',
          "columns": [{
              "data": "count" //0
            },
            {
              "data": "greenpathway_description" //1
            },
            {
              "data": "greenpathway_hindi_description" //2
            },
            // {
            //   "data": "status" //3
            // },
          ...
          "columnDefs": [{
            ...
            // },
            {
              ...
              "render": function(data, type, full, meta) {
                return '<a title="Click to edit" href="greenpathway.php?route=edit&id=' + data + '" class="btn btn-light btn-icon"><i class="fa fa-edit"></i></a>';
              }
            }
          ],
