...
if ($save == "save" || $save_close == "save_close") :
	...
	// $greenpathway_description = $validation_globalclass->sanitize(ucwords($_REQUEST['greenpathway_description']));
	// $greenpathway_hindi_description = $validation_globalclass->sanitize(ucwords($_REQUEST['greenpathway_hindi_description']));
	$greenpathway_description = ($_REQUEST['greenpathway_description']);
	$greenpathway_hindi_description = ($_REQUEST['greenpathway_hindi_description']);
	...
	$greenpathway_description = htmlentities($greenpathway_description);
	$greenpathway_hindi_description = htmlentities($greenpathway_hindi_description);
	$greenpathway_description = htmlentities($greenpathway_description);
	$greenpathway_hindi_description = htmlentities($greenpathway_hindi_description);
	...
	// 			$NEWfileName = 'sidbisubsidiary' . '_' . '.' . $new_file_name_stu;
	// 			// echo $NEWfileName;
	// 			// exit();
	...
	//Insert Query
	$arrFields = array( '`greenpathway_description`', '`greenpathway_hindi_description`', '`createdby`', '`status`');

	$arrValues = array( "$greenpathway_description", "$greenpathway_hindi_description",  "$logged_user_id", "$status");

	if (sqlACTIONS("INSERT", "js_greenpathway", $arrFields, $arrValues, '')) :
		...
		if ($save == "save") : ?>
			<script type="text/javascript">
				window.location = 'greenpathway.php?route=add&code=1'
			</script>
		<?php else : ?>
			<script type="text/javascript">
				window.location = 'greenpathway.php?code=1'
			</script>
<?php
		endif;
		exit();
					...
					<form method="post" enctype="multipart/form-data" data-parsley-validate>
						...
						<div id="basic">
							...
							<!-- <div class="form-group row align-items-end">
								<div class="col-md-2">
									<label for="subsidiary_title" class="form-label">Green Pathway Title<span class="tx-danger"></span></label>
								</div>

								<div class="col-md-5">
									<label for="subsidiary_title" class="form-label">In English<span class="tx-danger"></span></label>
									<input type="text" class="form-control" name="greenpathway_description" id="greenpathway_description"  autocomplete="off" />
								</div>
								<div class="col-md-5">
									<label for="subsidiary_title_hindi" class="form-label">In Hindi<span class="tx-danger"></span></label>
									<input type="text" class="form-control" name="greenpathway_hindi_description" id="greenpathway_hindi_description"  autocomplete="off" />
								</div>
							</div> -->
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <label for="greenpathway_description" class="form-label">In English<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="greenpathway_description" id="greenpathway_description" placeholder=""></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="greenpathway_hindi_description" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="greenpathway_hindi_description" id="greenpathway_hindi_description" placeholder=""></textarea>
                                </div>
                            </div>
							<!-- <div class="form-group row align-items-end">
								<div class="col-md-2">
						...
						<!-- <div class="form-group row">
							<div class="col-md-2">
								<label for="subsidiary_image" class="control-label">Msme Image and link<span class="tx-danger"> *</span></label>
							</div>
							<div class="col-md-5">
							<label for="subsidiary_image" class="form-label">Image<span class="tx-danger">*</span></label>
								<input class="form-control form-control-sm" name="msme_image" id="msme_image" type="file" value="<?php echo $subsidiary_image ?>" autocomplete="off">
