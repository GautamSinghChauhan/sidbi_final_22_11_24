...
if ($save == "save" || $save_close == "save_close") :
	...
	// $spex_description = $validation_globalclass->sanitize(ucwords($_REQUEST['spex_description']));
	// $spex_hindi_description = $validation_globalclass->sanitize(ucwords($_REQUEST['spex_hindi_description']));
	$spex_description = ($_REQUEST['spex_description']);
	$spex_hindi_description = ($_REQUEST['spex_hindi_description']);
	...
	$spex_description = htmlentities($spex_description);
	$spex_hindi_description = htmlentities($spex_hindi_description);
	...
	//Insert Query
	$arrFields = array('`spex_description`', '`spex_hindi_description`', '`createdby`', '`status`');

	$arrValues = array("$spex_description", "$spex_hindi_description", "$logged_user_id", "$status");

	if (sqlACTIONS("INSERT", "js_spex", $arrFields, $arrValues, '')) :
		...
		if ($save == "save") : ?>
			<script type="text/javascript">
				window.location = 'spex.php?route=add&code=1'
			</script>
		<?php else : ?>
			<script type="text/javascript">
				window.location = 'spex.php?code=1'
			</script>
<?php
		endif;
		exit();
					...
					<form method="post" enctype="multipart/form-data" data-parsley-validate>
						...
						<div id="basic">
							...
							<!-- <div class="form-group row align-items-end">
								<div class="col-md-2">
									<label for="subsidiary_title" class="form-label">Spex Title<span class="tx-danger"></span></label>
								</div>

								<div class="col-md-5">
									<label for="subsidiary_title" class="form-label">In English<span class="tx-danger"></span></label>
									<input type="text" class="form-control" name="spex_description" id="spex_description"  autocomplete="off" />
								</div>
								<div class="col-md-5">
									<label for="subsidiary_title_hindi" class="form-label">In Hindi<span class="tx-danger"></span></label>
									<input type="text" class="form-control" name="spex_hindi_description" id="spex_hindi_description"  autocomplete="off" />
								</div>
							</div> -->

							<div class="form-group row">
                                <div class="col-md-2">
                                    <label for="subsidiary_description" class="form-label">Spex Description<span class="tx-danger"></span></label>
                                </div>
                                <div class="col-md-5">
                                    <label for="spex_description" class="form-label">In English<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="spex_description" id="spex_description" placeholder=""></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="spex_hindi_description" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="spex_hindi_description" id="spex_hindi_description" placeholder=""></textarea>
                                </div>
                            </div>
							<!-- <div class="form-group row align-items-end">
								<div class="col-md-2">
