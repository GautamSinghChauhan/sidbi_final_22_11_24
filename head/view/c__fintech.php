...
if ($save == "save" || $save_close == "save_close") :
	...
	// $fintech_description = $validation_globalclass->sanitize(ucwords($_REQUEST['fintech_description']));
	// $fintech_description_hindi = $validation_globalclass->sanitize(ucwords($_REQUEST['fintech_description_hindi']));
	$fintech_description = ($_REQUEST['fintech_description']);
	$fintech_description_hindi = ($_REQUEST['fintech_description_hindi']);
	...
	$fintech_description = htmlentities($fintech_description);
	$fintech_description_hindi = htmlentities($fintech_description_hindi);
	...
	//Insert Query
	$arrFields = array('`fintech_description`', '`fintech_description_hindi`', '`createdby`', '`status`');

	$arrValues = array("$fintech_description", "$fintech_description_hindi", "$logged_user_id", "$status");

	if (sqlACTIONS("INSERT", "js_fintech", $arrFields, $arrValues, '')) :
		...
		if ($save == "save") : ?>
			<script type="text/javascript">
				window.location = 'fintech.php?route=add&code=1'
			</script>
		<?php else : ?>
			<script type="text/javascript">
				window.location = 'fintech.php?code=1'
			</script>
<?php
		endif;
		exit();
					...
					<form method="post" enctype="multipart/form-data" data-parsley-validate>
						...
						<div id="basic">
							...
							<!-- <div class="form-group row align-items-end">
								<div class="col-md-2">
									<label for="subsidiary_title" class="form-label">fintech Title<span class="tx-danger"></span></label>
								</div>

								<div class="col-md-5">
									<label for="subsidiary_title" class="form-label">In English<span class="tx-danger"></span></label>
									<input type="text" class="form-control" name="fintech_description" id="fintech_description"  autocomplete="off" />
								</div>
								<div class="col-md-5">
									<label for="subsidiary_title_hindi" class="form-label">In Hindi<span class="tx-danger"></span></label>
									<input type="text" class="form-control" name="fintech_description_hindi" id="fintech_description_hindi"  autocomplete="off" />
								</div>
							</div> -->

							<div class="form-group row">
                                <div class="col-md-2">
                                    <label for="fintech_description" class="form-label">Fintech Description<span class="tx-danger"></span></label>
                                </div>
                                <div class="col-md-5">
                                    <label for="fintech_description" class="form-label">In English<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="fintech_description" id="fintech_description" placeholder=""></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="fintech_description_hindi" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="fintech_description_hindi" id="fintech_description_hindi" placeholder=""></textarea>
                                </div>
                            </div>
							<!-- <div class="form-group row align-items-end">
								<div class="col-md-2">
