...
if ($save == "save" || $save_close == "save_close") :
	...
	if (sqlACTIONS("INSERT", "machineryproduct", $arrFields, $arrValues, '')) :
...
?>
			<script type="text/javascript">
				window.location = 'machineryproduct.php?route=add&code=1'
			</script>
		<?php
		//header("Location:machineryproduct.php?route=add&code=1");
		else :
		?>
			<script type="text/javascript">
					...
					<form method="post" enctype="multipart/form-data" data-parsley-validate>
						...
						<div id="basic">
							...
							<div class="form-group row">
								<label for="machineryproductstatus" class="col-sm-2 col-form-label"><?= $__active ?></label>
								<div class="col-sm-7">
									<div class="custom-control custom-switch">
										<input type="checkbox" class="custom-control-input" name="machineryproductstatus" id="machineryproductstatus" checked="">
							...
							<!-- <div class="form-group row align-items-end">
								...
								<div class="col-md-5">
									...
									<input type="text" class="form-control" name="machineryproduct_title" id="machineryproduct_title" autocomplete="off" />
								</div>
								<div class="col-md-5">
									<label for="machineryproduct_title_hindi" class="form-label">In Hindi<span class="tx-danger"></label>
									<input type="text" class="form-control" name="machineryproduct_title_hindi" id="machineryproduct_title_hindi" autocomplete="off" />
								</div>
							</div> -->
							<div class="form-group row align-items-end">
								<div class="col-md-2">
									<label for="machineryproduct_tab" class="form-label">Tab<span class="tx-danger">*</span></label>
								</div>

								<div class="col-md-5">
									<label for="machineryproduct_tab" class="form-label">In English<span class="tx-danger">*</span></label>
									<input type="text" class="form-control" name="machineryproduct_tab" id="machineryproduct_tab" required autocomplete="off" />
								</div>
								<div class="col-md-5">
									<label for="machineryproduct_tab_hindi" class="form-label">In Hindi<span class="tx-danger">*</span></label>
									<input type="text" class="form-control" name="machineryproduct_tab_hindi" id="machineryproduct_tab_hindi" required autocomplete="off" />
								</div>
							</div>
							<div class="form-group row">
                                <div class="col-md-2">
                                    <label for="machineryproduct_key" class="form-label">Key Feature<span class="tx-danger"></span></label>
                                </div>
                                <div class="col-md-5">
                                    <label for="overview_title" class="form-label">In English<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="machineryproduct_key" id="machineryproduct_key" placeholder=""></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="overview_title" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="machineryproduct_key_hindi" id="machineryproduct_key_hindi" placeholder=""></textarea>
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-5">
                                    <label for="overview_title" class="form-label">In English<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="machineryproduct_eligibility" id="machineryproduct_eligibility" placeholder=""></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="overview_title" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="machineryproduct_eligibility_hindi" id="machineryproduct_eligibility_hindi" placeholder=""></textarea>
                                </div>
                            </div>
						</div>
