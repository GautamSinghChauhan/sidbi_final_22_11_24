...
?>
		<script type="text/javascript">
			/* window.location = 'rolepermission.php?route=edit&id=<?php echo $id ?>&formtype=dashboard_config' */
			window.location = 'rolepermission.php?code=2';
		</script>
	<?php
...
if ($save == "update" && $hidden_role_id != '') {
	...
	?>
		<script type="text/javascript">
			window.location = 'rolepermission.php?id=<?php echo $hidden_role_id; ?>'
		</script>
	<?php
...
if ($save == "update_notification" && $hidden_role_id != '') {
	...
	?>
		<script type="text/javascript">
			window.location = 'rolepermission.php?code=1'
		</script>
<?php
...
<?php if ($formtype == '') { ?>
	<div class="content">
											...
											?>
												<tr>
													...
													<td>
														<div class="custom-control custom-checkbox">
															<input type="checkbox" <?php if (in_array($page_ID, $page_allowed)) {
																						echo "checked";
																					} ?> name="course[]" class="custom-control-input" id="course-<?php echo $page_ID; ?>" value="<?php echo $page_ID; ?>">
												...
												?>
													<tr>
														...
														<td>
															<div class="custom-control custom-checkbox">
																<input type="checkbox" <?php if (in_array($pageID, $page_allowed)) {
																							echo "checked";
																						} ?> name="course[]" class="custom-control-input" id="course-<?php echo $pageID; ?>" value="<?php echo $pageID; ?>">
		...
		if ($formtype == 'dashboard_config') { ?>
															...
															<tr>
																...
																<td>
																	<div class="custom-control custom-switch mg-t-10">
																		<input type="checkbox" class="custom-control-input" name="dashboard_content[]" id="dashboard_content_<?php echo $dashboard_content_ID; ?>" <?php if (in_array($dashboard_content_ID, $dashboard_content_allowed)) {
																																																						echo "checked";
																																																					} ?> value="<?php echo $dashboard_content_ID; ?>">
			...
			<?php }
		if ($formtype == 'notification_config') { ?>
				<div class="content">
					<div class="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
						<div class="row">
							<div class="col-lg-10">
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td>
																	<div class="custom-control custom-switch mg-t-10">
																		<input type="checkbox" class="custom-control-input" name="notification_content[]" id="notification_content_<?php echo $notification_content_ID; ?>" <?php if (in_array($notification_content_ID, $notification_content_allowed)) {
																																																								echo "checked";
																																																							} ?> value="<?php echo $notification_content_ID; ?>">
