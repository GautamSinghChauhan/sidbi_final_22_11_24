				...
				<div class="row">
					...
					?>
						...
						<td> <div class="custom-control custom-checkbox">
								<input type="checkbox" name="course[]" class="custom-control-input" id="course-<?php echo $page_ID;?>" value="<?php echo $page_ID;?>">
					...
					$result_sub= sqlQUERY_LABEL($query_sub);
							...
							<td> <div class="custom-control custom-checkbox">
								<input type="checkbox" name="course[]" class="custom-control-input" id="course-<?php echo $pageID;?>" value="<?php echo $pageID;?>">
