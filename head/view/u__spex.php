...
if (isset($update) && $update == "update" && $hidden_spex_id != '') {
    ...
    $sqlWhere = " `spex_id` = '$hidden_spex_id' ";

    if (sqlACTIONS("UPDATE", "js_spex", $arrFields, $arrValues, $sqlWhere)) {
...
if ($route == 'edit') :
    ...
    $list_datas = sqlQUERY_LABEL("SELECT `spex_id`, `spex_description`, `spex_hindi_description`, `status` FROM `js_spex` WHERE `deleted` = '0'  AND `spex_id` = '$id'") or die("Unable to get records: " . sqlERROR_LABEL());
    ...
    if ($check_record_availabity > 0) :
        while ($row = sqlFETCHARRAY_LABEL($list_datas)) :
            ...
            $spex_hindi_description = html_entity_decode($row['spex_hindi_description']);
                ...
                <form method="post" enctype="multipart/form-data" data-parsley-validate>
                    ...
                    <div id="basic">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="hidden" name="hidden_spex_id" value="<?= $id; ?>" />
                            <div class="col-sm-7">
...
<!-- 
                        ...
                        <div class="form-group row">
                                <div class="col-md-2">
                                    <label for="spex_description" class="form-label">Description<span class="tx-danger"></span></label>
                                </div>
                                <div class="col-md-5">
                                    <label for="spex_description" class="form-label">In English<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="spex_description" id="spex_description" placeholder=""><?= $spex_description; ?></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="spex_hindi_description" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="spex_hindi_description" id="spex_hindi_description" placeholder=""><?= $spex_hindi_description; ?></textarea>
                                </div>
                            </div>
                        <!-- <div class="form-group row align-items-end">
                            <div class="col-md-2">
