      ...
      <div class="col-12">
        <div class="row-xs mg-b-25">
          ...
          <div data-label="Example" class="df-example demo-table table-responsive">
            <table id="galleriesLIST" class="table table-bordered w-100">
              <thead>
                <tr>
                  <th class="wd-5p"><?= $__contentsno ?></th>
                  <!-- <th class="wd-10p">Content English</th>
                  <th class="wd-15p">Content Hindi</th> -->
                  <th class="wd-15p">Gallery Image</th>
