...
if (isset($update) && $update == "update" && $hidden_fintech_id != '') {
    ...
    $sqlWhere = " `fintech_id` = '$hidden_fintech_id' ";

    if (sqlACTIONS("UPDATE", "js_fintech", $arrFields, $arrValues, $sqlWhere)) {
...
if ($route == 'edit') :
    ...
    $list_datas = sqlQUERY_LABEL("SELECT `fintech_id`, `fintech_description`, `fintech_description_hindi`, `status` FROM `js_fintech` WHERE `deleted` = '0'  AND `fintech_id` = '$id'") or die("Unable to get records: " . sqlERROR_LABEL());
    ...
    if ($check_record_availabity > 0) :
        while ($row = sqlFETCHARRAY_LABEL($list_datas)) :
            ...
            $fintech_description_hindi = html_entity_decode($row['fintech_description_hindi']);
                ...
                <form method="post" enctype="multipart/form-data" data-parsley-validate>
                    ...
                    <div id="basic">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="hidden" name="hidden_fintech_id" value="<?= $id; ?>" />
                            <div class="col-sm-7">
...
<!-- 
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <textarea type="text" class="form-control" name="fintech_description" id="fintech_description" placeholder=""><?= $fintech_description; ?></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="fintech_description_hindi" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="fintech_description_hindi" id="fintech_description_hindi" placeholder=""><?= $fintech_description_hindi; ?></textarea>
                                </div>
                            </div>
                        <!-- <div class="form-group row align-items-end">
                            <div class="col-md-2">
