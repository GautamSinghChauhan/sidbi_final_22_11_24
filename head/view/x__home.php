...
// 	$home_id = sqlQUERY_LABEL("SELECT `home_id` FROM `home` WHERE `home_id` = '$delete_id'") or die(sqlERROR_LABEL());

// 	$count_rows = sqlNUMOFROW_LABEL($home_id);

// 	if ($count_rows == '1') {
// 		echo "<div class='col-lg-12'>This action cannot be revoked...!!!<br /><br />";
// 		echo "<hr><a href='home.php?action=delete&id=" . $delete_id . "' class='btn btn-success btn-sm'>Delete</a>";
...
if ($type == 'changestatus') :
	...
	$sqlWhere = " `home_id` = '$home_id' ";

	return sqlACTIONS("UPDATE", "home", $arrFields, $arrValues, $sqlWhere);
endif;
