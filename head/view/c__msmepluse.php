...
if ($save == "save" || $save_close == "save_close") :
	...
	$msme_title = $validation_globalclass->sanitize(ucwords($_REQUEST['msme_title']));
	$msme_title_hindi = $validation_globalclass->sanitize(ucwords($_REQUEST['msme_title_hindi']));
	$msme_description = ($_REQUEST['msme_description']);
	$msme_description_hindi = ($_REQUEST['msme_description_hindi']);
	...
	$msme_title = htmlentities($msme_title);
	$msme_title_hindi = htmlentities($msme_title_hindi);
	$msme_description = htmlentities($msme_description);
	$msme_description_hindi = htmlentities($msme_description_hindi);
	...
	//Insert Query
	$arrFields = array('`msme_title`', '`msme_hindi_title`', '`msme_pluse_description`', '`msme_pluse_hindi_description`', '`createdby`', '`status`');

	$arrValues = array("$msme_title", "$msme_title_hindi", "$msme_description", "$msme_description_hindi",  "$logged_user_id", "$status");

	if (sqlACTIONS("INSERT", "js_msmepulse", $arrFields, $arrValues, '')) :
		...
		if ($save == "save") : ?>
			<script type="text/javascript">
				window.location = 'msmepluse.php?route=add&code=1'
			</script>
		<?php else : ?>
			<script type="text/javascript">
				window.location = 'msmepluse.php?code=1'
			</script>
<?php
		endif;
		exit();
					...
					<form method="post" enctype="multipart/form-data" data-parsley-validate>
						...
						<div id="basic">
							...
							<div class="form-group row align-items-end">
								<div class="col-md-2">
									<label for="subsidiary_title" class="form-label">Msme  Title<span class="tx-danger"></span></label>
								</div>

								<div class="col-md-5">
									<label for="subsidiary_title" class="form-label">In English<span class="tx-danger"></span></label>
									<input type="text" class="form-control" name="msme_title" id="msme_title"  autocomplete="off" />
								</div>
								<div class="col-md-5">
									<label for="subsidiary_title_hindi" class="form-label">In Hindi<span class="tx-danger"></span></label>
									<input type="text" class="form-control" name="msme_title_hindi" id="msme_title_hindi"  autocomplete="off" />
								</div>
							</div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <textarea type="text" class="form-control" name="msme_description" id="msme_description" placeholder=""></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="overview_title" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="msme_description_hindi" id="msme_description_hindi" placeholder=""></textarea>
                                </div>
                            </div>
							<!-- <div class="form-group row align-items-end">
								<div class="col-md-2">
