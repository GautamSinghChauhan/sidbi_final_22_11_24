...
if ($save == "save" || $save_close == "save_close") :
	...
	$pressrelease_date = $validation_globalclass->sanitize(ucwords($_REQUEST['pressrelease_date']));
	...
	if (sqlACTIONS("INSERT", "pressreleases", $arrFields, $arrValues, '')) :
		$pressrelease_ID = sqlINSERTID_LABEL();

		//Insert Query
		$arrFields_translations = array('`pressrelease_id`', '`language_id`', '`title`', '`createdby`', '`status`');

		$arrValues_translations = array("$pressrelease_ID", "2", "$pressrelease_title_hindi", "$logged_user_id", "$status");

		if (sqlACTIONS("INSERT", "pressrelease_translations", $arrFields_translations, $arrValues_translations, '')) :
		endif;
		...
		if ($save == "save") : ?>
			<script type="text/javascript">
				window.location = 'pressrelease.php?route=add&code=1'
			</script>
		<?php else : ?>
			<script type="text/javascript">
				window.location = 'pressrelease.php?code=1'
			</script>
<?php
		endif;
		exit();
						...
						<div id="basic">
							...
							<div class="form-group row align-items-end">
								...
								<div class="col-md-5">
									...
									<input type="text" class="form-control" name="pressrelease_title" id="pressrelease_title" required autocomplete="off" />
								</div>
								<div class="col-md-5">
							...
							<div class="form-group row">
								...
								<div class="col-md-5">
									<input type="text" class="form-control" placeholder="DD/MM/YYYY" name="pressrelease_date" id="pressrelease_date" value="<?php echo $pressrelease_date; ?>" required autocomplete="off" />
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-md-5">
									<input type="text" class="form-control" placeholder="pressrelease URL" name="pressrelease_url" id="pressrelease_url" value="" required autocomplete="off" />
								</div>
							</div>
