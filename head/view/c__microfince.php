...
if ($save == "save" || $save_close == "save_close") :
	...
	$micro_fince_description = ($_REQUEST['micro_fince_description']);
	$micro_fince_description_hindi = ($_REQUEST['micro_fince_description_hindi']);
	...
	if (sqlACTIONS("INSERT", "js_microfinance", $arrFields, $arrValues, '')) :
		...
		if ($save == "save") : ?>
			<script type="text/javascript">
				window.location = 'microfince.php?route=add&code=1'
			</script>
		<?php else : ?>
			<script type="text/javascript">
						...
						<div id="basic">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <textarea type="text" class="form-control" name="micro_fince_description" id="micro_fince_description" placeholder=""></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="overview_title" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="micro_fince_description_hindi" id="micro_fince_description_hindi" placeholder=""></textarea>
                                </div>
                            </div>
							<!-- <div class="form-group row align-items-end">
								<div class="col-md-2">
