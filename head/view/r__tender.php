      ...
      <div class="col-12">
        <div class="row-xs mg-b-25">
          ...
          <div data-label="Example" class="df-example demo-table table-responsive">
            <table id="tenderLIST" class="table table-bordered w-100">
              <thead>
                <tr>
                  <th class="wd-5p"><?= $__contentsno ?></th>
                  <th class="wd-15p">Title</th>
                  <th class="wd-10p">Tender Date</th>
                  <th class="wd-10p">Last Date Of Submission</th>
    ...
    <div class="row">
      <div class="col-12">
        <div class="row-xs mg-b-25">
          ...
          <div data-label="Example" class="df-example demo-table table-responsive">
            <table id="archivedtenderLIST" class="table table-bordered w-100">
              <thead>
                <tr>
                  <th class="wd-5p"><?= $__contentsno ?></th>
                  <th class="wd-15p">Title</th>
