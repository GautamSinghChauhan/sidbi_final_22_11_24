        ...
        <div class="col-12">
          <div class="row-xs mg-b-25">
            ...
            <div data-label="Example" class="df-example demo-table table-responsive">
              <table id="impactLIST" class="table table-bordered w-100">
                <thead>
                  <tr>
                    <th class="wd-5p"><?= $__contentsno ?></th>
                    <th class="wd-15p">Title English</th>
                    <th class="wd-10p">Title Hindi</th>
                    <th class="wd-10p">Description English</th>
                    <th class="wd-15p">Description Hindi</th>
                    <th class="wd-15p">Button Label</th>
