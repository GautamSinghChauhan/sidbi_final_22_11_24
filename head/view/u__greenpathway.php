...
if (isset($update) && $update == "update" && $hidden_greenpathway_id != '') {
    ...
    $sqlWhere = " `greenpathway_id` = '$hidden_greenpathway_id' ";

    if (sqlACTIONS("UPDATE", "js_greenpathway", $arrFields, $arrValues, $sqlWhere)) {
...
if ($route == 'edit') :
    ...
    $list_datas = sqlQUERY_LABEL("SELECT `greenpathway_id`, `greenpathway_description`, `greenpathway_hindi_description`, `status` FROM `js_greenpathway` WHERE `deleted` = '0'  AND `greenpathway_id` = '$id'") or die("Unable to get records: " . sqlERROR_LABEL());
    ...
    if ($check_record_availabity > 0) :
        while ($row = sqlFETCHARRAY_LABEL($list_datas)) :
            ...
            $greenpathway_hindi_description = html_entity_decode($row['greenpathway_hindi_description']);
                ...
                <form method="post" enctype="multipart/form-data" data-parsley-validate>
                    ...
                    <div id="basic">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="hidden" name="hidden_greenpathway_id" value="<?= $id; ?>" />
                            <div class="col-sm-7">
...
<!-- 
                        ...
                        <div class="form-group row">
                                <div class="col-md-2">
                                    <label for="greenpathway_description" class="form-label">Description<span class="tx-danger"></span></label>
                                </div>
                                <div class="col-md-5">
                                    <label for="greenpathway_description" class="form-label">In English<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="greenpathway_description" id="greenpathway_description" placeholder=""><?= $greenpathway_description; ?></textarea>
                                </div>
                                <div class="col-md-5">
                                    <label for="greenpathway_hindi_description" class="form-label">In Hindi<span class="tx-danger"></span></label>
                                    <textarea type="text" class="form-control" name="greenpathway_hindi_description" id="greenpathway_hindi_description" placeholder=""><?= $greenpathway_hindi_description; ?></textarea>
                                </div>
                            </div>
                        <!-- <div class="form-group row align-items-end">
                            <div class="col-md-2">
