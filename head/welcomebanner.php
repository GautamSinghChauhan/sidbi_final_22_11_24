...
function togglestatusITEM(welcome_banner_id, status) {
      var SELECTED_ID = welcome_banner_id;
      var SELECTED_STATUS = status;
      //alert(SELECTED_ID);
      $('#pleasewait-loader').show();
      $('.receiving-delete-data').load('view/x__welcomebanner.php?type=changestatus&welcome_banner_id=' + SELECTED_ID + '&oldstatus=' + SELECTED_STATUS + '', function() {
