...
<body>
  ...
  <script>
    if ($("#ecosystem_content,#ecosystem_content_hindi").length > 0) {
      tinymce.init({
        selector: "textarea#ecosystem_content, textarea#ecosystem_content_hindi",
        theme: "modern",
        menubar: false,
        min_height: 300,
    ...
    $(function() {
      'use strict'
      $("#ecosystemimage").change(function() {
        uploadImage(this);
      });
    ...
    if ($code == '0') {
      $displayMSG_globalclass->displayMSG($code, "Error", 'Unable to Add ecosystem.', 'error');
    }
