...
<body>
  ...
  <script>
     if ($("#organizationchart_content,#organizationchart_content_hindi").length > 0) {
        tinymce.init({
            selector: "textarea#organizationchart_content, textarea#organizationchart_content_hindi",
            theme: "modern",
            menubar: false,
            min_height: 300,
    ...
    $(function() {
      'use strict'
        ...
        $("#organizationchartimage").change(function() {
          uploadImage(this);
        });
    ...
    function deleteITEM(deleting_id) {
      ...
      $('.receiving-delete-data').load('view/x__organizationchart.php?type=delete&delete_id=' + SELECTED_ID + '', function() {
    ...
    function togglestatusITEM(organizationchart_ID, status) {
      var SELECTED_ID = organizationchart_ID;
      var SELECTED_STATUS = status;
      //alert(SELECTED_ID);
      $('#pleasewait-loader').show();
      $('.receiving-delete-data').load('view/x__organizationchart.php?type=changestatus&organizationchart_ID=' + SELECTED_ID + '&oldstatus=' + SELECTED_STATUS + '', function() {
        $('#pleasewait-loader').hide();
        location.reload();
      });
    }
    ...
    $(document).ready(function() {
      $('#organizationchartname').parsley();
      var old_organizationchart_name = document.getElementById("encrypt_organizationchart_name").value;
      window.ParsleyValidator.addValidator('checkorganizationchartname', {
        validateString: function(value) {
          return $.ajax({
            url: 'engine/ajax/ajax_organizationchart_name.php',
            method: "POST",
            data: {
              organizationchart_name: value,
              old_organizationchart_name: old_organizationchart_name
            },
            dataType: "json",
    ...
    $(document).ready(function() {
      $('#organizationchartcode').parsley();
      var old_organizationchart_name = document.getElementById("encrypt_organizationchartcode").value;
      window.ParsleyValidator.addValidator('checkorganizationchartcode', {
        validateString: function(value) {
          return $.ajax({
            url: 'engine/ajax/ajax_organizationchart_code.php',
            method: "POST",
            data: {
              organizationchart_code: value,
              old_organizationchart_code: old_organizationchart_name
            },
            dataType: "json",
            success: function(data) {
    ...
    if ($code == '0') {
      $displayMSG_globalclass->displayMSG($code, "Error", 'Unable to Add organizationchart.', 'error');
    }
