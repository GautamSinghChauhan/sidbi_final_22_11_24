...
?>
			<script type="text/javascript">
				window.location = 'index?session=invalid&code=2'
			</script>
		<?php
		}
		...
		?>
			<script type="text/javascript">
				window.location = 'index?session=invalid&code=3'
			</script>
		<?php
		}
		...
		?>
			<script type="text/javascript">
				window.location = 'index?session=invalid&code=4'
			</script>
		<?php
		}
	} else {
		?>
		<script type="text/javascript">
			window.location = 'index?session=invalid&code=5'
		</script>
<?php
	}
}
