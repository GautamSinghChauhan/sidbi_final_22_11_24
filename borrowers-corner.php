...
<head>
    ...
    <title>Borrower's Corner - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <?php require_once('public/header.php'); ?> <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png')  no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1><?php  if($get_configured_lang == 'HI'): 
                                                 echo   'उधारकर्ता का कोना';
                                                else:
                                                 echo   'Borrower Corner';
                                                endif; ?></h1>
                </div>
            </div>
        </section>
        ...
        <div class="cms Borrower'sCorner">
            <div class="container">
                ...
                <div class="brows-cont">
                    <div class="links_dv">
                        <div class="links_dv_inner">
                            <div class="icons"><img src="<?= SEOURL; ?>assets/front/images/ic1.png" alt="img"></div>
                            <div class="bs-cont"><a href="https://onlineloanappl.SIDBI.in/" target="_blank"><?php  if($get_configured_lang == 'HI'): 
                                                 echo   'ऑनलाइन ऋण आवेदन';
                                                else:
                                                 echo   'Online Loan Application';
                                                endif; ?></a></div>
                        </div>
                    </div>
                    <div class="links_dv">
                        <div class="links_dv_inner">
                            <div class="icons"><img src="<?= SEOURL; ?>assets/front/images/ic1.png" alt="img"></div>
                            <div class="bs-cont"><a href="https://SIDBI4u.SIDBI.in/" target="_blank"><?php  if($get_configured_lang == 'HI'): 
                                                 echo   'ऑनलाइन ऋण आवेदन';
                                                else:
                                                 echo   'Online Loan Application';
                                                endif; ?></a></div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698735031.7177" value="qTsNfXZmvcyegXSFPdbEVIiURQcFsEE6m0ZVKWLDdKaZP0Loog69XDlg/Y1UrzAIfP5iXVxYngqKwQFDEcHrYQ==" /></div>
                            <div class="row">
