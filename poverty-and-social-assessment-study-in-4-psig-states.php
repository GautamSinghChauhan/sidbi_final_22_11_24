...
<head>
    ...
    <title>Poverty and social assessment study in 4 PSIG states - Small Industries Development Bank of India</title>
...
?>
        <section class="about-us-banner" style="background: url('assets/front/images/Inner\ Banenr\(1\).png') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1>Poverty and social assessment study in 4 PSIG states</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="#">Poverty and social assessment study in 4 PSIG states</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <div class="cms Povertyandsocialassessmentstudyin4PSIGstates">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="over-cont psme-sec svt">
                        <?php
                                    $list_transaction = sqlQUERY_LABEL("SELECT `povertysocial_ID`, `povertysocial_title`, `povertysocial_title_hindi`, `povertysocial_content`, `povertysocial_content_hindi`, `status` FROM `povertysocial` where deleted = '0' and `status` = '1'") or die("Unable to get records:" . sqlERROR_LABEL());
                                    while ($row = sqlFETCHARRAY_LABEL($list_transaction)) :
                                        ...
                                        $povertysocial_content = html_entity_decode($row["povertysocial_content"]);
                                        $povertysocial_content_hindi = html_entity_decode($row["povertysocial_content_hindi"]);
                                    ?>
                        <h3 ><b><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $povertysocial_title_hindi;
                                                else:
                                                 echo  $povertysocial_title;
                                                endif; ?></b></h3>
                        <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $povertysocial_content_hindi;
                                                else:
                                                 echo  $povertysocial_content;
                                                endif; ?></div>
                    <?php endwhile; ?>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698748414.8956" value="EKoTqOyne3vgKg5B9yndSFDlvZ9G6ibkYYWbizO8G9PqXJZpjOe6XUfbhOMEbMH2TOaLW3TidLHHcP7BC2FSoA==" /></div>
                            <div class="row">
