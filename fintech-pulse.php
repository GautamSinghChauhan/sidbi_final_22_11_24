...
<head>
    ...
    <title>Fintech Pulse - Small Industries Development Bank of India</title>
...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <?php
       $select_msme_pluse = sqlQUERY_LABEL("SELECT `fintech_id`, `fintech_description`, `fintech_description_hindi` FROM `js_fintech` where `deleted`='0' ");
       while($row =sqlFETCHARRAY_LABEL($select_msme_pluse)):
        $fintech_id =$row['fintech_id'];
        $fintech_description =$row['fintech_description'];
        $fintech_description_hindi =$row['fintech_description_hindi'];
...
?>  
        ...
        <div class="cms FintechPulse">  
            <div class="container">
            <div><?php  if($get_configured_lang == 'HI'): 
                                                 echo  $fintech_description_hindi;
                                                else:
                                                 echo  $fintech_description;
                                                endif; ?></div>
                <!-- <p>Fintech Pulse, a quarterly report on Fintech lending in India with the focus on New Age Fintech emerging as Differentiators in timely and adequate delivery of credit to unserved and underserved. The report aims to bring out how the emerging technologies are causing disruption in the financial sector and the impact of these technologies in credit landscape, apart from analytical contents regarding performance etc. on key parameters.</p> -->
                <div class="row">
                    <div class="customImageBlock"><a href="<?= SEOURL; ?>uploads/article/articlefiles/Fintech_Pulse-6th_Edition_compressed.pdf" target="_blank"><img src="<?= SEOURL; ?>assets/front/images/Fintech-Pulse-Report--5th-Edition-1.jpg" alt="Fintech Pulse Vol-V" title="Fintech Pulse Vol-V"></a></div>
                    <div class="customImageBlock"><a href="<?= SEOURL; ?>uploads/article/articlefiles/Fintech%20Pulse%20Report%20-5th%20Edition.pdf" target="_blank"><img src="<?= SEOURL; ?>assets/front/images/Fintech-Pulse-Report--5th-Edition-1.jpg" alt="Fintech Pulse Vol-IV" title="Fintech Pulse Vol-IV"></a></div>
                    <div class="customImageBlock"><a href="<?= SEOURL; ?>uploads/article/articlefiles/Fintech_Pulse_Vol%20IV.pdf" target="_blank"><img src="<?= SEOURL; ?>assets/front/images/Fintech-Volume-3.jpg" alt="Fintech Pulse Vol-III" title="Fintech Pulse Vol-III"></a></div>
                    <div class="customImageBlock"><a href="fintech-pulse-all-editions" target="_blank"><img src="<?= SEOURL; ?>assets/front/images/Fintech-Pulse-Vol-I_0001.png" alt="Fintech Pulse All Edition" title="Fintech Pulse - All Edition"></a></div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" method="post" accept-charset="utf-8" id="frmuserdownloads" name="frmuserdownloads" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                            <div style="display:none;"><input type="hidden" name="_method" value="POST" /><input type="hidden" name="_csrfToken" autocomplete="off" id="_csrfToken_1698734999.8735" value="DDma38AAW5pfoPoFd01vGHRZC+lfQrDRrGSq85tGm7E8PdVKFGhbCvhBcw0eNJtEgDMsswaqb+G94/6Z6EQEdg==" /></div>
                            <div class="row">
