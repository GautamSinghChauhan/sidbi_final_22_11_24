...
<body class="main-wrapper-en">
    ...
    <div id="wrapper" data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0">
        ...
        <section class="about-us-banner" data-aos="fade-down" style="background: url('assets/front/images/Inner%20Banenr.jpg') no-repeat center center / cover;">
            <div class="container">
                <div class="inner">
                    <h1 data-translate="careers">Careers</h1>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="inner">
                    <ul>
                        ...
                        <li><a class="active" href="<?= SEOURL; ?>careers" data-translate="careers">Careers</a></li>
                    </ul>
                </div>
            </div>
        </section>
        <section class="press-releases">
            <div class="container">
                <div class="inner">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="title-content bold-title with-underline green">
                            <h2 class="mb-0" data-translate="careers">Careers</h2>
                        </div>
                        <div class="button-form">
                            <div class="">
                                <a href="careers/careerarchived" class="btn btn-outline-success" role="button"><span data-translate="viewarchived">View Archived</span> <i class="fa fa-angle-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered" id="careerLIST">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="100px" scope="col" data-translate="lastdateofsubmission">End Date</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
    ...
    <script>
        var dataTable = $('#careerLIST').DataTable({
            //responsive: true,
            'ajax': '<?= BASEPATH; ?>engine/json/JSONcareer.php?show=frontend',
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row) {
                    return '<a href="<?= SEOURL; ?>career2.php" target="_blank"><img src="https://development.sidbi.in/files/galleries/gif.gif" style="width:48px"/>' + data + ' </a>';
                }
            }],
            language: {
